...
/**
 * <p>Title: EasySql解析类</p>
 * <p>Description: 用在EasyQueryVer4Window.jsp中，解析js页面传来的jsp名称，sql的id,及参数
 * Edited by mojiao
 * </p>
...
//    String sql=t.convertToValue("select CustomerNo, Name, Sex, Birthday, IDType, IDNo from LDPerson where 1=1 and name? like '?Name?'");
