...
public class CErrors implements Cloneable
{
    ...
    public String getErrContent()
    {
        ...
        for (int i = 0; i < vErrors.size(); i++)
        {
            ...
            if (tError.errorType.equals(CError.TYPE_FORBID))
            {
                forbitContent = forbitContent + "  " + ""+bundle.getString("waitForTran")+"" +
                        tError.errorNo + "）" +
                        tError.errorMessage + "\n";
            }
            else if (tError.errorType.equals(CError.TYPE_NEEDSELECT))
            {
                needSelectContent = needSelectContent + "  " + ""+bundle.getString("waitForTran")+"" +
                        tError.errorNo + "）" +
                        tError.errorMessage + "\n";
            }
            else if (tError.errorType.equals(CError.TYPE_ALLOW))
            {
                allowContent = allowContent + "  " + ""+bundle.getString("waitForTran")+"" + tError.errorNo +
                        "）" +
                        tError.errorMessage + "\n";
            }
            else
            {
                unknowContent = unknowContent + "  " + ""+bundle.getString("waitForTran")+"" +
                        tError.errorMessage + "\n";
            }
        }
        ...
        {
            content = content + ""+bundle.getString("waitForTran")+":\n" + forbitContent;
        }
    ...
    public void checkErrors(CErrors cerrors)
    {
        ...
        else
        {
            ...
            {
                content = ""+bundle.getString("saveSucc")+"" + PubFun.changForHTML(ErrorContent);
                flag = "Success";
            }
            else
            {
                content = ""+bundle.getString("saveFaild")+"" + PubFun.changForHTML(ErrorContent);
                flag = "Fail";
            }
        }
    }
    ...
    public void checkWSErrors(VData v)
    {
        ...
        else
        {
            ...
            {
                content = ""+bundle.getString("saveSucc")+"" + PubFun.changForHTML((String) v.get(1));
                flag = "Success";
            }
            else
            {
                content = ""+bundle.getString("saveFaild")+"" + PubFun.changForHTML((String) v.get(1));
                flag = "Fail";
            }
        }
    }
...
//      }
//      System.out.println(es.mErrors.getErrContent());
//    }
}
