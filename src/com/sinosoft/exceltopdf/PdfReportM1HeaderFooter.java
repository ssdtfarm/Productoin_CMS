...
public class PdfReportM1HeaderFooter extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        try {
            if (bf == null) {
            	// String path = Config.getFullPathRelateClass("../../../../../../ui/common/font/calibri.ttf", PdfReportM1HeaderFooter.class);
            	String path = Config.getFullPathRelateClass("../../../../../common/font/calibri.ttf", PdfReportM1HeaderFooter.class);
        ...
        // 这样处理可以居中
        ColumnText.showTextAligned(cb, Element.ALIGN_CENTER, footer, (document.rightMargin() + document.right() + document.leftMargin() - document.left() - len) / 2.0F, document.bottom() - 20, 0);
