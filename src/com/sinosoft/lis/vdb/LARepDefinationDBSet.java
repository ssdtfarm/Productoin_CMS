...
/*
 * <p>ClassName: LARepDefinationDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LARepDefinationDBSet extends LARepDefinationSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LARepDefinationDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LARepDefinationDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getReportName() == null || this.get(i).getReportName().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getReportName());
			}
