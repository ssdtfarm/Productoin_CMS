...
/*
 * <p>ClassName: LACPDDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LACPDDBSet extends LACPDSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LACPDDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getHKCAAVQCode() == null || this.get(i).getHKCAAVQCode().equals("null")) {
				...
				pstmt.setString(24, this.get(i).getHKCAAVQCode());
			}
