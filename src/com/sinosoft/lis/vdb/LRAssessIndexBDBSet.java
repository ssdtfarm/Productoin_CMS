...
/*
 * <p>ClassName: LRAssessIndexBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LRAssessIndexBDBSet extends LRAssessIndexBSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LRAssessIndexBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LRAssessIndexBDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getIndexCode() == null || this.get(i).getIndexCode().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getIndexCode());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getIndexSerise() == null || this.get(i).getIndexSerise().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getIndexSerise());
			}
			...
			if(this.get(i).getJson() == null || this.get(i).getJson().equals("null")) {
				...
				pstmt.setString(23, this.get(i).getJson());
			}
			if(this.get(i).getSqlTemp() == null || this.get(i).getSqlTemp().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getSqlTemp());
			}
			// set where condition
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
			...
			if(this.get(i).getBaseCode() == null || this.get(i).getBaseCode().equals("null")) {
				...
				pstmt.setString(26, this.get(i).getBaseCode());
			}
			if(this.get(i).getAgentGrade() == null || this.get(i).getAgentGrade().equals("null")) {
				pstmt.setString(27,null);
			} else {
				pstmt.setString(27, this.get(i).getAgentGrade());
			}
			if(this.get(i).getIndexCode() == null || this.get(i).getIndexCode().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getIndexCode());
			}
			if(this.get(i).getIndexType() == null || this.get(i).getIndexType().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getIndexType());
			}
