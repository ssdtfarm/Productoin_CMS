...
/*
 * <p>ClassName: LADimissionBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LADimissionBDBSet extends LADimissionBSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LADimissionBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LADimissionBDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
            ...
            {
			if(this.get(i).getOperaotr1() == null || this.get(i).getOperaotr1().equals("null")) {
				pstmt.setString(1,null);
			} else {
				pstmt.setString(1, this.get(i).getOperaotr1());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getOperaotr1() == null || this.get(i).getOperaotr1().equals("null")) {
				...
				pstmt.setString(14, this.get(i).getOperaotr1());
			}
			if(this.get(i).getMakeDate1() == null || this.get(i).getMakeDate1().equals("null")) {
			...
			if(this.get(i).getOperaotr1() == null || this.get(i).getOperaotr1().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getOperaotr1());
			}
			if(this.get(i).getMakeDate1() == null || this.get(i).getMakeDate1().equals("null")) {
