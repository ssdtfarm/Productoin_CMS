...
/*
 * <p>ClassName: LRAssessIndexCDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LRAssessIndexCDBSet extends LRAssessIndexCSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LRAssessIndexCDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LRAssessIndexCDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getIndexCode() == null || this.get(i).getIndexCode().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getIndexCode());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getIndexName() == null || this.get(i).getIndexName().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getIndexName());
			}
			...
			if(this.get(i).getMainIndexFlag() == null || this.get(i).getMainIndexFlag().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getMainIndexFlag());
			}
			if(this.get(i).getIndexType() == null || this.get(i).getIndexType().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getIndexType());
			}
			if(this.get(i).getIndexSerise() == null || this.get(i).getIndexSerise().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getIndexSerise());
			}
			...
			if(this.get(i).getBakMonth() == null || this.get(i).getBakMonth().equals("null")) {
				...
				pstmt.setString(28, this.get(i).getBakMonth());
			}
			if(this.get(i).getType() == null || this.get(i).getType().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getType());
			}
			if(this.get(i).getBaseCode() == null || this.get(i).getBaseCode().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getBaseCode());
			}
			if(this.get(i).getAgentGrade() == null || this.get(i).getAgentGrade().equals("null")) {
				pstmt.setString(31,null);
			} else {
				pstmt.setString(31, this.get(i).getAgentGrade());
			}
			if(this.get(i).getIndexCode() == null || this.get(i).getIndexCode().equals("null")) {
				pstmt.setString(32,null);
			} else {
				pstmt.setString(32, this.get(i).getIndexCode());
			}
			if(this.get(i).getIndexType() == null || this.get(i).getIndexType().equals("null")) {
				pstmt.setString(33,null);
			} else {
				pstmt.setString(33, this.get(i).getIndexType());
			}
