...
/*
 * <p>ClassName: LRIndexVsCommPDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LRIndexVsCommPDBSet extends LRIndexVsCommPSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LRIndexVsCommPDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LRIndexVsCommPDBSet";
