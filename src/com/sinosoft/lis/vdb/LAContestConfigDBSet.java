...
/*
 * <p>ClassName: LAContestConfigDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAContestConfigDBSet extends LAContestConfigSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LAContestConfigDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LAContestConfigDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getContestCode() == null || this.get(i).getContestCode().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getContestCode());
			}
