	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getDepartMent() == null || this.get(i).getDepartMent().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getDepartMent());
			}
			if(this.get(i).getTeam() == null || this.get(i).getTeam().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getTeam());
			}
			// set where condition
			if(this.get(i).getMenuGrpCode() == null || this.get(i).getMenuGrpCode().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getMenuGrpCode());
			}
