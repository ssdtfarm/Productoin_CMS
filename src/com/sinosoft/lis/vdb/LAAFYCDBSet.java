...
/*
 * <p>ClassName: LAAFYCDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAAFYCDBSet extends LAAFYCSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LAAFYCDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAFYCSN() == null || this.get(i).getAFYCSN().equals("null")) {
				...
				pstmt.setString(48, this.get(i).getAFYCSN());
			}
