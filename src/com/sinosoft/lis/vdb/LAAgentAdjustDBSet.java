...
/*
 * <p>ClassName: LAAgentAdjustDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: LAAgentSUA
 */
public class LAAgentAdjustDBSet extends LAAgentAdjustSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LAAgentAdjustDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LAAgentAdjustDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAdjustSN() == null || this.get(i).getAdjustSN().equals("null")) {
				...
				pstmt.setString(21, this.get(i).getAdjustSN());
			}
