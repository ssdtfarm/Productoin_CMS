...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(6, this.get(i).getInterval());
			pstmt.setDouble(7, this.get(i).getTimes());
			...
			if(this.get(i).getIPAddress() == null || this.get(i).getIPAddress().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getIPAddress());
			}
			if(this.get(i).getPort() == null || this.get(i).getPort().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getPort());
			}
			// set where condition
			if(this.get(i).getTaskPlanCode() == null || this.get(i).getTaskPlanCode().equals("null")) {
				pstmt.setString(17,null);
			} else {
				pstmt.setString(17, this.get(i).getTaskPlanCode());
			}
