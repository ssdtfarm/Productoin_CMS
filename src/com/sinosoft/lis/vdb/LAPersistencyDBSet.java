...
/*
 * <p>ClassName: LAPersistencyDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAPersistencyDBSet extends LAPersistencySet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LAPersistencyDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LAPersistencyDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPersistencySN() == null || this.get(i).getPersistencySN().equals("null")) {
				...
				pstmt.setString(47, this.get(i).getPersistencySN());
			}
