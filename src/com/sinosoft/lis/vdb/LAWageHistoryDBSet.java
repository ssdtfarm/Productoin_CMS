...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAssessApproveDate() == null || this.get(i).getAssessApproveDate().equals("null")) {
				pstmt.setDate(7,null);
			} else {
				pstmt.setDate(7, Date.valueOf(this.get(i).getAssessApproveDate()));
			}
			if(this.get(i).getWageApproveDate() == null || this.get(i).getWageApproveDate().equals("null")) {
				pstmt.setDate(8,null);
			} else {
				pstmt.setDate(8, Date.valueOf(this.get(i).getWageApproveDate()));
			}
			...
			if(this.get(i).getWageNo() == null || this.get(i).getWageNo().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getWageNo());
			}
			if(this.get(i).getManageCom() == null || this.get(i).getManageCom().equals("null")) {
