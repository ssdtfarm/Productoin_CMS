...
/*
 * <p>ClassName: LRIndexInfoBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LRIndexInfoBDBSet extends LRIndexInfoBSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LRIndexInfoBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LRIndexInfoBDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
            ...
            {
			if(this.get(i).getIndexInfoBSN() == null || this.get(i).getIndexInfoBSN().equals("null")) {
				pstmt.setString(1,null);
			} else {
				pstmt.setString(1, this.get(i).getIndexInfoBSN());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAgentGrade() == null || this.get(i).getAgentGrade().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getAgentGrade());
			}
			...
			if(this.get(i).getBranchSeries() == null || this.get(i).getBranchSeries().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getBranchSeries());
			}
			...
			if(this.get(i).getDataType() == null || this.get(i).getDataType().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getDataType());
			}
			if(this.get(i).getD() == null || this.get(i).getD().equals("null")) {
				pstmt.setDate(21,null);
			} else {
				pstmt.setDate(21, Date.valueOf(this.get(i).getD()));
			}
			pstmt.setInt(22, this.get(i).getN0());
			pstmt.setDouble(23, this.get(i).getN2());
			pstmt.setDouble(24, this.get(i).getN4());
			pstmt.setDouble(25, this.get(i).getN6());
			if(this.get(i).getS() == null || this.get(i).getS().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getS());
			}
			...
			if(this.get(i).getWageName() == null || this.get(i).getWageName().equals("null")) {
				...
				pstmt.setString(28, this.get(i).getWageName());
			}
			if(this.get(i).getWageCode() == null || this.get(i).getWageCode().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getWageCode());
			}
			if(this.get(i).getCalType() == null || this.get(i).getCalType().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getCalType());
			}
			// set where condition
			if(this.get(i).getIndexInfoBSN() == null || this.get(i).getIndexInfoBSN().equals("null")) {
				pstmt.setString(31,null);
			} else {
				pstmt.setString(31, this.get(i).getIndexInfoBSN());
			}
			if(this.get(i).getWageNo() == null || this.get(i).getWageNo().equals("null")) {
				pstmt.setString(32,null);
			} else {
				pstmt.setString(32, this.get(i).getWageNo());
			}
			if(this.get(i).getIndexType() == null || this.get(i).getIndexType().equals("null")) {
			...
			if(this.get(i).getBaseCode() == null || this.get(i).getBaseCode().equals("null")) {
				...
				pstmt.setString(36, this.get(i).getBaseCode());
			}
			if(this.get(i).getIndexCode() == null || this.get(i).getIndexCode().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, this.get(i).getIndexCode());
			}
			if(this.get(i).getAgentCode() == null || this.get(i).getAgentCode().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getAgentCode());
			}
