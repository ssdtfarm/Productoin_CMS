...
/*
 * <p>ClassName: LRAssessIndexDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LRAssessIndexDBSet extends LRAssessIndexSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LRAssessIndexDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LRAssessIndexDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getBaseCode() == null || this.get(i).getBaseCode().equals("null")) {
				...
				pstmt.setString(1, StrTool.space(this.get(i).getBaseCode(), 10));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getITableName() == null || this.get(i).getITableName().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getITableName());
			}
			if(this.get(i).getIColName() == null || this.get(i).getIColName().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getIColName());
			}
			...
			if(this.get(i).getJson() == null || this.get(i).getJson().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getJson());
			}
			if(this.get(i).getSqlTemp() == null || this.get(i).getSqlTemp().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getSqlTemp());
			}
			// set where condition
			if(this.get(i).getBaseCode() == null || this.get(i).getBaseCode().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, StrTool.space(this.get(i).getBaseCode(), 10));
			}
			if(this.get(i).getAgentGrade() == null || this.get(i).getAgentGrade().equals("null")) {
			...
			if(this.get(i).getIndexType() == null || this.get(i).getIndexType().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getIndexType());
			}
