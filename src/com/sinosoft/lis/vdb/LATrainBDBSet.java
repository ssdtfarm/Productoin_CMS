...
/*
 * <p>ClassName: LATrainBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LATrainBDBSet extends LATrainBSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LATrainBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LATrainBDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getOpenClassID() == null || this.get(i).getOpenClassID().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getOpenClassID());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getResultLevel() == null || this.get(i).getResultLevel().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getResultLevel());
			}
			pstmt.setDouble(6, this.get(i).getResult());
			if(this.get(i).getTrainPassFlag() == null || this.get(i).getTrainPassFlag().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, this.get(i).getTrainPassFlag());
			}
			...
			if(this.get(i).getOpenClassID() == null || this.get(i).getOpenClassID().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getOpenClassID());
			}
			if(this.get(i).getMakeDate1() == null || this.get(i).getMakeDate1().equals("null")) {
