...
/*
 * <p>ClassName: LecturertToClassBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LecturertToClassBDBSet extends LecturertToClassBSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LecturertToClassBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LecturertToClassBDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getRemarks() == null || this.get(i).getRemarks().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getRemarks());
			}
