...
/*
 * <p>ClassName: MHonorBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class MHonorBDBSet extends MHonorBSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public MHonorBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "MHonorBDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getIDX() == null || this.get(i).getIDX().equals("null")) {
				...
				pstmt.setString(21, this.get(i).getIDX());
			}
