...
//            System.out.println("---queryDetail---");
    ...
    {
        // 菜单表
    	LDMenuSchema kLDMenuSchema = new LDMenuSchema();
...
//        mLDMenuSet = tLDMenuDB.executeQuery("select * from ldmenu order by nodeorder");
        String tSql = "select * from ldmenu order by nodeorder "; 
        List paraList =new ArrayList(); 
        mLDMenuSet = tLDMenuDB.executeQuery(tSql,PubFun.getFormatBV(paraList)); 
