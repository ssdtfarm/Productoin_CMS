...
public class CalculatorNew {
    ...
    //算法对应SQL语句所在表结构
    private LACalModeZSchema mLMCalMode = new LACalModeZSchema();
...
//  		return tLMCalFactorSet;
  	 ...
  	 */
  	private LACalModeZSchema getLMCalMode(String strCalCode){
      LACalModeZDB tLMCalModeDB = new LACalModeZDB();
      LACalModeZSchema tSchema = new LACalModeZSchema();
      LACalModeZSchema kSchema = new LACalModeZSchema();
...
//        tSql=tSql.replace(tStr,getValueByName(tStr));
    ...
    private boolean getSQL() {
        LACalModeZSchema tLMCalModeSchema = this.getLMCalMode(CalCode);
