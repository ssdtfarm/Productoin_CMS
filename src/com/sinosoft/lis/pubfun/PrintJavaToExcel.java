...
public class PrintJavaToExcel {
	...
	*/
	...
	{
		ex.printStackTrace();
		buildError(""+bundle.getString("ErrorMsg")+"", ex.getMessage());
	}
	}
	...
	public void addCell(String[] arg)
	{
		...
		if(mSheetCount == 0)
		{
			throw new NullPointerException(""+bundle.getString("waitForTran")+"");
		}
		
		//增加一组元素
		for(int cs = 0 ; cs < arg.length ; cs++)
		{
			System.out.println(  cs+"======"+mRow);
	...
	public void combinCell(String str)
	{
		...
		WritableFont font1= 
			new WritableFont(WritableFont.TIMES,15,WritableFont.BOLD);
		...
		{
			e.printStackTrace();
			buildError(""+bundle.getString("ErrorMsg")+"Excel", e.getMessage());
		}
	}
	...
	public void endCreate()
	{
		...
		{
			cx.printStackTrace();
			buildError(""+bundle.getString("ErrorMsg")+"", cx.getMessage());
		}
	}
...
//		 str[0] = ""+bundle.getString("waitForTran")+"";
//		 str[1] = ""+bundle.getString("waitForTran")+"er";
//		 str[2] = ""+bundle.getString("waitForTran")+"s";
//		 str[3] = ""+bundle.getString("waitForTran")+"s";
//		 str[4] = ""+bundle.getString("waitForTran")+"w";
//		 
