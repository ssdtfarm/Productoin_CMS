...
//        System.out.println("encryptStr = ".concat(String.valueOf(String.valueOf(
//                encryptStr))));
//        System.out.println("encryptStr1 = ".concat(String.valueOf(String.
//                valueOf(encryptStr1))));
...
//        System.out.println("tplainStr len:".concat(String.valueOf(String.
