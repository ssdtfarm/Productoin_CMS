...
//		System.out.println(resultString);
    ...
    public String encryptStringNew(String plainStr){
    	String hexEncryptString="";
    	int startIndex=0;
    	int endIndex=0;
    	for(int i=0;i<plainStr.length();i=i+8){
    		startIndex=i;
    		endIndex=(i+8>plainStr.length())?(plainStr.length()):(i+8);
    		hexEncryptString += encryptString(plainStr.substring(startIndex,endIndex));
    	}
    	return hexEncryptString;
    }

    public String decryptStringNew(String plainStr){
    	String hexDecryptStr="";
    	int startIndex=0;
    	int endIndex=0;
    	for(int i=0;i<plainStr.length();i=i+16){
    		startIndex=i;
    		endIndex=(i+16>plainStr.length())?(plainStr.length()):(i+16);
    		hexDecryptStr += decryptString(plainStr.substring(startIndex,endIndex));
    	}
    	return hexDecryptStr;
    }
    
//    public static void main(String argv[])
//    {
//        String plainStr = "abcdefghijklmnopqrstuvwxyz";
//        LisIDEA tLisIdea = new LisIDEA();
//        String plaintoencryptStr = tLisIdea.encryptStringNew(plainStr);
//        System.out.println(plaintoencryptStr);
//        String decrypttoplainStr = tLisIdea.decryptStringNew(plaintoencryptStr);
