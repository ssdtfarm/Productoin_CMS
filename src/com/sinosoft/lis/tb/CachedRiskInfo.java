...
/*
 * <p>Title: 险种相关信息缓存类 </p>
 * <p>Description: 缓存程序中经常会用到的险种相关信息 </p>
 * <p>Copyright: Copyright (c) 2002</p>
 *　该文件由于小额信贷提前更新生产，所以新增注释以提交至生产中。
...
public class CachedRiskInfo
{
    ...
    private Hashtable m_hashLMRiskCode = new Hashtable();
    ...
    private Hashtable m_hashLMRiskRole = new Hashtable();
    private Hashtable m_LMPolDutyEdorCalSet = new Hashtable();
    ...
    public void refresh()
    {
        ...
        m_hashLMRiskRole.clear();
        m_hashLMRiskCode.clear();
    }
...
//     * @return LMRiskSchema
//     */
//    public LMRiskSchema findRiskByRiskName(String strRiskName)
//    {
//
//        Hashtable hash = m_hashLMRiskCode;
//
//        Object obj = hash.get(strRiskName);
//
//        if (obj != null)
//        {
//            if (obj instanceof String)
...
//            tLMRiskSet=tLMRiskDB.executeQuery("select * from lmrisk where riskname='" + strRiskName + "'");
//
//            if (tLMRiskSet.size()==0)
//            {
//                mErrors.copyAllErrors(tLMRiskDB.mErrors);
//                hash.put(strRiskName, NOFOUND);
//                return null;
//            }
//
//            hash.put(strRiskName, tLMRiskSet.get(1).getSchema());
//            return tLMRiskDB.getSchema();
//        }
//    }
//
...
//     * 按险种编码查找LMRiskApp
//     * @param strRiskCode String
//     * @author hanxl,2009年8月7日 10时23分08秒
...
//            else
//            {
//                System.out.println("哈哈====="+((LMDutySchema) obj).getDutyCode());
...
//    {
//        LMDutyGetSchema tLMDutyGetSchema = findDutyGetByGetDutyCode(
//                strGetDutyCode);
//
...
//    {
//        LMDutyPaySchema tLMDutyPaySchema = findDutyPayByPayPlanCode(
//                strPayPlanCode);
//
...
//    }
//
//    public LMRiskInsuAccSchema findRiskInsuAccByInsuAccNoClone(String
//            strInsuAccNo)
//    {
//        LMRiskInsuAccSchema tLMRiskInsuAccSchema =
//                findRiskInsuAccByInsuAccNo(strInsuAccNo);
//
...
//    {
//        LMRiskBonusSchema tLMRiskBonusSchema = findRiskBonusByRiskCode(
//                strRiskCode);
//
...
//            {
//            	LMRiskDutySchema s = new LMRiskDutySchema();
//            	s.setSchema(tLMRiskDutySet.get(nIndex + 1));
//                newLMRiskDutySet.add(s);
//            }
...
//                = findDutyGetRelaByDutyCode(strDutyCode);
//
...
//            {
//            	LMDutyGetRelaSchema s = new LMDutyGetRelaSchema();
//            	s.setSchema(tLMDutyGetRelaSet.get(nIndex + 1));
//                newLMDutyGetRelaSet.add(s);
//            }
...
//    {
//        LMDutyGetRelaSet tLMDutyGetRelaSet = findDutyGetRelaByDutyCode(
//                strDutyCode);
//
//        if (tLMDutyGetRelaSet == null)
//        {
...
//        for (int nIndex = 0; nIndex < tLMDutyGetRelaSet.size(); nIndex++)
//        {
//            LMDutyGetRelaSchema tLMDutyGetRelaSchema = tLMDutyGetRelaSet.get(
//                    nIndex + 1);
...
//                = findDutyPayRelaByDutyCode(strDutyCode);
//
...
//            {
//            	LMDutyPayRelaSchema s = new LMDutyPayRelaSchema();
//            	s.setSchema(tLMDutyPayRelaSet.get(nIndex + 1));
//                newLMDutyPayRelaSet.add(s);
//            }
...
//    {
//        LMDutyPayRelaSet tLMDutyPayRelaSet = findDutyPayRelaByDutyCode(
//                strDutyCode);
//
//        if (tLMDutyPayRelaSet == null)
//        {
...
//        for (int nIndex = 0; nIndex < tLMDutyPayRelaSet.size(); nIndex++)
//        {
//            LMDutyPayRelaSchema tLMDutyPayRelaSchema = tLMDutyPayRelaSet.get(
//                    nIndex + 1);
...
//    }
//
//    public LMRiskAccGetSet findRiskAccGetByGetDutyCodeClone(String
//            strGetDutyCode)
//    {
//        LMRiskAccGetSet tLMRiskAccGetSet
//                = findRiskAccGetByGetDutyCode(strGetDutyCode);
//
...
//            {
//            	LMRiskAccGetSchema s = new LMRiskAccGetSchema();
//            	s.setSchema(tLMRiskAccGetSet.get(nIndex + 1));
//                newtLMRiskAccGetSet.add(s);
//            }
...
//                                             String strInsuAccNo)
//    {
//        LMRiskAccGetSet tLMRiskAccGetSet = findRiskAccGetByGetDutyCode(
//                strGetDutyCode);
//
//        if (tLMRiskAccGetSet == null)
//        {
...
//        for (int nIndex = 0; nIndex < tLMRiskAccGetSet.size(); nIndex++)
//        {
//            LMRiskAccGetSchema tLMRiskAccGetSchema = tLMRiskAccGetSet.get(
//                    nIndex + 1);
...
//    }
//
//    public LMRiskAccPaySet findRiskAccPayByPayPlanCodeClone(String
//            strPayPlanCode)
//    {
//        LMRiskAccPaySet tLMRiskAccPaySet
//                = findRiskAccPayByPayPlanCode(strPayPlanCode);
//
...
//            {
//            	LMRiskAccPaySchema s = new LMRiskAccPaySchema();
//            	s.setSchema(tLMRiskAccPaySet.get(nIndex + 1));
//                newtLMRiskAccPaySet.add(s);
//            }
...
//                                             String strInsuAccNo)
//    {
//        LMRiskAccPaySet tLMRiskAccPaySet = findRiskAccPayByPayPlanCode(
//                strPayPlanCode);
//
//        if (tLMRiskAccPaySet == null)
//        {
...
//        for (int nIndex = 0; nIndex < tLMRiskAccPaySet.size(); nIndex++)
//        {
//            LMRiskAccPaySchema tLMRiskAccPaySchema = tLMRiskAccPaySet.get(
//                    nIndex + 1);
...
//    {
//        LMRiskToAccSet tLMRiskToAccSet
//                = findRiskToAccByRiskCode(strRiskCode);
//
...
//            {
//            	LMRiskToAccSchema s = new LMRiskToAccSchema();
//            	s.setSchema(tLMRiskToAccSet.get(nIndex + 1));
//                newLMRiskToAccSet.add(s);
//            }
...
//        for (int nIndex = 0; nIndex < tLMRiskToAccSet.size(); nIndex++)
//        {
//            LMRiskToAccSchema tLMRiskToAccSchema = tLMRiskToAccSet.get(nIndex +
//                    1);
...
//    }
//    
//    //add by zhaopeng 20071101 增加险种性质的条件判断
//    public LMCheckFieldSet findCheckFieldByRiskCode(String strRiskCode,
//            String strFieldName, String strRiskProp)
//    {
//
//        Hashtable hash = m_hashLMCheckField;
//
//        String strPK = strRiskCode.trim() + strFieldName.trim() + strRiskProp.trim();
//        Object obj = hash.get(strPK);
//
//        if (obj != null)
//        {
...
//            tLMCheckFieldDB.setRiskCode(strRiskCode);
//            tLMCheckFieldDB.setFieldName(strFieldName);
//            tLMCheckFieldDB.setRiskProp(strRiskProp);
//
//            LMCheckFieldSet tLMCheckFieldSet = tLMCheckFieldDB.query();
//
//            if (tLMCheckFieldDB.mErrors.needDealError())
...
//            String strFieldName)
//    {
//        LMCheckFieldSet tLMCheckFieldSet
//                = findCheckFieldByRiskCode(strRiskCode, strFieldName);
//
...
//            {
//            	LMCheckFieldSchema s = new LMCheckFieldSchema();
//            	s.setSchema(tLMCheckFieldSet.get(nIndex + 1));
//                newLMCheckFieldSet.add(s);
//            }
//            return newLMCheckFieldSet;
//        }
//    }
//    
//    //add by zhaopeng 20071101 增加公共规则的险种的限制
//    public LMCheckFieldSet findCheckFieldByRiskCodeClone(String strRiskCode,
//            String strFieldName, String strRiskProp)
//    {
//        LMCheckFieldSet tLMCheckFieldSet
//                = findCheckFieldByRiskCode(strRiskCode, strFieldName, strRiskProp);
//
//        if (tLMCheckFieldSet == null)
//        {
//            return tLMCheckFieldSet;
...
//                                             String strSerialNo)
//    {
//        LMCheckFieldSet tLMCheckFieldSet = findCheckFieldByRiskCode(strRiskCode,
//                strFieldName);
//
//        if (tLMCheckFieldSet == null)
//        {
...
//        for (int nIndex = 0; nIndex < tLMCheckFieldSet.size(); nIndex++)
//        {
//            LMCheckFieldSchema tLMCheckFieldSchema = tLMCheckFieldSet.get(
//                    nIndex + 1);
...
//                = findDutyCtrlByDutyCode(strDutyCode);
//
...
//            {
//            	LMDutyCtrlSchema s = new LMDutyCtrlSchema();
//            	s.setSchema(tLMDutyCtrlSet.get(nIndex + 1));
//                newLMDutyCtrlSet.add(s);
//            }
...
//                    strOtherCode)
//                &&
//                StrTool.cTrim(tLMDutyCtrlSchema.getFieldName()).equals(strFieldName))
//            {
...
//     */
//    public LMDutyGetAliveSet findDutyGetAliveByGetDutyCode(String
//            strGetDutyCode)
//    {
//
...
//    }
//
//    public LMDutyGetAliveSet findDutyGetAliveByGetDutyCodeClone(String
//            strGetDutyCode)
//    {
//        LMDutyGetAliveSet tLMDutyGetAliveSet
//                = findDutyGetAliveByGetDutyCode(strGetDutyCode);
//
...
//            {
//            	LMDutyGetAliveSchema s = new LMDutyGetAliveSchema();
//            	s.setSchema(tLMDutyGetAliveSet.get(nIndex + 1));
//                newLMDutyGetAliveSet.add(s);
//            }
...
//    {
//        LMDutyGetAliveSet tLMDutyGetAliveSet = findDutyGetAliveByGetDutyCode(
//                strGetDutyCode);
//
//        if (tLMDutyGetAliveSet == null)
//        {
...
//        for (int nIndex = 0; nIndex < tLMDutyGetAliveSet.size(); nIndex++)
//        {
//            LMDutyGetAliveSchema tLMDutyGetAliveSchema = tLMDutyGetAliveSet.get(
//                    nIndex + 1);
...
//
    ...
    public LMCalFactorSet findCalFactorByCalCodeClone(String strCalCode)
    {
        LMCalFactorSet tLMCalFactorSet
                = findCalFactorByCalCode(strCalCode);
        ...
        else
        {
            ...
            {
            	LMCalFactorSchema s = new LMCalFactorSchema();
            	s.setSchema(tLMCalFactorSet.get(nIndex + 1));
                newLMCalFactorSet.add(s);
            }
...
//        for (int nIndex = 0; nIndex < tLMCalFactorSet.size(); nIndex++)
//        {
//            LMCalFactorSchema tLMCalFactorSchema = tLMCalFactorSet.get(nIndex +
//                    1);
...
//    /**
//     * 查询险种角色表
//     * @param strRiskCode：险种代码
//     * @param strRiskRole：角色类型
//     * @return
//     */
//    public LMRiskRoleSet findLMRiskRoleSetByRiskCode(String strRiskCode,String strRiskRole){
//    	
//    	Hashtable hash=m_hashLMRiskRole;
//        Object obj = hash.get(strRiskCode);
//
//        if (obj != null)
//        {
...
//
//            tLMRiskRoleDB.setRiskCode(strRiskCode);
//            tLMRiskRoleDB.setRiskRole(strRiskRole);
//            LMRiskRoleSet tLMRiskRoleSet = tLMRiskRoleDB.query();
//
//            if (tLMRiskRoleDB.mErrors.needDealError())
//            {
//                mErrors.copyAllErrors(tLMRiskRoleDB.mErrors);
//                hash.put(strRiskCode, NOFOUND);
//                return null;
//            }
//
//            hash.put(strRiskCode, tLMRiskRoleSet);
...
//     * @return
//     */
//    public LMPolDutyEdorCalSet findLLMPolDutyEdorCalSetByRiskCode(String strRiskCode,String EdorType){
//    	
//    	Hashtable hash=m_LMPolDutyEdorCalSet;
//        Object obj = hash.get(strRiskCode+"-" + EdorType);
//
//        if (obj != null)
//        {
//            if (obj instanceof String)
...
//            else
//            {
//                return (LMPolDutyEdorCalSet) obj;
//            }
//        }
//        else
//        {
...
//
//        	tLMPolDutyEdorCalDB.setRiskCode(strRiskCode);
...
//            }
//
//            hash.put(strRiskCode+"-" + EdorType, tLMPolDutyEdorCalSet);
//            return tLMPolDutyEdorCalSet;
//        }
//    }
}
