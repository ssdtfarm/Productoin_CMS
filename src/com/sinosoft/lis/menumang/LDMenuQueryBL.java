...
//            mLDMenuSet = tLDMenuDB.executeQuery(mSBql.toString());
            ...
            String powerSql = "select * from LDMenu where NodeCode in ( select NodeCode from LDMenuGrpToMenu where MenuGrpCode in ( select MenuGrpCode from LDMenuGrp where MenuGrpCode in (select MenuGrpCode from LDUserToMenuGrp where UserCode=?) ) ) order by nodeorder "; 
            List paraList =new ArrayList(); 
            paraList.add(mLDUserSchema.getUserCode()); 
            mLDMenuSet = tLDMenuDB.executeQuery(powerSql,PubFun.getFormatBV(paraList)); 
        }
...
//            mLDMenuSet = tLDMenuDB.executeQuery(mSBql.toString());
            ...
            String powerSql = "select * from LDMenu where NodeCode in ( select NodeCode from LDMenuGrpToMenu where MenuGrpCode in ( select MenuGrpCode from LDMenuGrp where MenuGrpCode=? ) ) order by nodeorder"; 
            List paraList =new ArrayList(); 
            paraList.add(mLDMenuGrpSchema.getMenuGrpCode()); 
            mLDMenuSet = tLDMenuDB.executeQuery(powerSql,PubFun.getFormatBV(paraList)); 
        }
...
//                    "select * from ldmenu order by nodeorder");
            ...
            String powerSql = "select * from ldmenu order by nodeorder"; 
            List paraList =new ArrayList(); 
            mLDMenuSet = tLDMenuDB.executeQuery(powerSql,PubFun.getFormatBV(paraList)); 
        }
...
//            mLDMenuSet = tLDMenuDB.executeQuery(mSBql.toString());
            ...
            String powerSql = "select * from LDMenu where NodeCode not in ( select NodeCode from LDMenuGrpToMenu where MenuGrpCode in ( select MenuGrpCode from LDMenuGrp where MenuGrpCode in (select MenuGrpCode from LDUserToMenuGrp where UserCode=?) ) ) order by nodeorder"; 
            List paraList =new ArrayList(); 
            paraList.add(mLDUserSchema.getUserCode());
            mLDMenuSet = tLDMenuDB.executeQuery(powerSql,PubFun.getFormatBV(paraList)); 
        }
...
//            mLDMenuSet = tLDMenuDB.executeQuery(mSBql.toString());
            ...
            String powerSql = "select * from LDMenu where NodeCode not in ( select NodeCode from LDMenuGrpToMenu where MenuGrpCode in ( select MenuGrpCode from LDMenuGrp where MenuGrpCode=?) ) order by nodeorder"; 
            List paraList =new ArrayList(); 
            paraList.add(mLDMenuGrpSchema.getMenuGrpCode());
            mLDMenuSet = tLDMenuDB.executeQuery(powerSql,PubFun.getFormatBV(paraList)); 
        }
...
//            mLDMenuSet = tLDMenuDB.executeQuery(sqlStr);
            ...
            String powerSql = "select * from LDMenu where NodeCode <> mDLMenuSchema.getNodeCode order by nodeorder"; 
            List paraList =new ArrayList(); 
            mLDMenuSet = tLDMenuDB.executeQuery(powerSql,PubFun.getFormatBV(paraList)); 
        }
        else
