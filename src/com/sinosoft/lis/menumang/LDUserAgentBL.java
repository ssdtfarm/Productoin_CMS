...
//System.out.println("---queryUser---");
    ...
    private boolean queryUser()
    {
        ...
        String powerSql = "select * from lduser where usercode=? and password=? "; 
        List paraList =new ArrayList(); 
        paraList.add(mLDUserSchema.getUserCode()); 
        paraList.add(encryptPwd); 
        mLDUserSet = tLDUserDB.executeQuery(powerSql,PubFun.getFormatBV(paraList)); 
        ...
        // 如果生效开始时间为空，则不做校验
        if( strValidStartDate != null &&
            !strValidStartDate.equals("") ) {
        ...
        // 如果生效结束时间为空，则不做校验
        if( strValidEndDate != null &&
            !strValidEndDate.equals("") ) {
