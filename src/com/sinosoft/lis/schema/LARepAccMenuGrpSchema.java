...
import com.sinosoft.lis.db.LARepAccMenuGrpDB;

/*
 * <p>ClassName: LARepAccMenuGrpSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LARepAccMenuGrpSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LARepAccMenuGrpSchema.class);
	// @Field
	/** Reportcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LARepAccMenuGrpSchema cloned = (LARepAccMenuGrpSchema)super.clone();
	...
	/**
	* 使用另外一个 LARepAccMenuGrpSchema 对象给 Schema 赋值
	* @param: aLARepAccMenuGrpSchema LARepAccMenuGrpSchema
	**/
	public void setSchema(LARepAccMenuGrpSchema aLARepAccMenuGrpSchema)
	{
		this.ReportCode = aLARepAccMenuGrpSchema.getReportCode();
		this.ImpCode = aLARepAccMenuGrpSchema.getImpCode();
		this.ImpName = aLARepAccMenuGrpSchema.getImpName();
		this.ImpType = aLARepAccMenuGrpSchema.getImpType();
		this.ImpInput = aLARepAccMenuGrpSchema.getImpInput();
		this.Flag1 = aLARepAccMenuGrpSchema.getFlag1();
		this.Flag2 = aLARepAccMenuGrpSchema.getFlag2();
		this.Flag3 = aLARepAccMenuGrpSchema.getFlag3();
		this.MakeDate = fDate.getDate( aLARepAccMenuGrpSchema.getMakeDate());
		this.MakeTime = aLARepAccMenuGrpSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLARepAccMenuGrpSchema.getModifyDate());
		this.ModifyTime = aLARepAccMenuGrpSchema.getModifyTime();
		this.Operator = aLARepAccMenuGrpSchema.getOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LARepAccMenuGrp表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LARepAccMenuGrpSchema";
	...
	public LARepAccMenuGrpSchema getSchema()
	{
		LARepAccMenuGrpSchema aLARepAccMenuGrpSchema = new LARepAccMenuGrpSchema();
		aLARepAccMenuGrpSchema.setSchema(this);
		return aLARepAccMenuGrpSchema;
	}

	public LARepAccMenuGrpDB getDB()
	{
		LARepAccMenuGrpDB aDBOper = new LARepAccMenuGrpDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLARepAccMenuGrp>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LARepAccMenuGrpSchema other = (LARepAccMenuGrpSchema)otherObject;
		return
