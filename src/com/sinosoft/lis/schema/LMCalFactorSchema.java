...
public class LMCalFactorSchema implements Schema
{
    ...
    {
        if (CalCode != null && !CalCode.equals("") && SysConst.CHANGECHARSET)
        {
    ...
    {
        if (FactorCode != null && !FactorCode.equals("") &&
    ...
    {
        if (FactorName != null && !FactorName.equals("") &&
            SysConst.CHANGECHARSET)
        {
    ...
    {
        if (FactorType != null && !FactorType.equals("") &&
            SysConst.CHANGECHARSET)
        {
    ...
    {
        if (FactorGrade != null && !FactorGrade.equals("") &&
            SysConst.CHANGECHARSET)
        {
    ...
    {
        if (FactorCalCode != null && !FactorCalCode.equals("") &&
            SysConst.CHANGECHARSET)
        {
    ...
    {
        if (FactorDefault != null && !FactorDefault.equals("") &&
            SysConst.CHANGECHARSET)
        {
    ...
    public String encode()
    {
        ...
        strReturn = StrTool.cTrim(StrTool.unicodeToGBK(CalCode)) +
                    ...
                    + StrTool.cTrim(StrTool.unicodeToGBK(FactorCode)) +
                    SysConst.PACKAGESPILTER
                    + StrTool.cTrim(StrTool.unicodeToGBK(FactorName)) +
                    SysConst.PACKAGESPILTER
                    + StrTool.cTrim(StrTool.unicodeToGBK(FactorType)) +
                    SysConst.PACKAGESPILTER
                    + StrTool.cTrim(StrTool.unicodeToGBK(FactorGrade)) +
                    SysConst.PACKAGESPILTER
                    + StrTool.cTrim(StrTool.unicodeToGBK(FactorCalCode)) +
                    SysConst.PACKAGESPILTER
    ...
    public boolean decode(String strMessage)
    {
        try
        {
            ...
            FactorCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2,
                                        SysConst.PACKAGESPILTER);
            FactorName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3,
                                        SysConst.PACKAGESPILTER);
            FactorType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4,
                                        SysConst.PACKAGESPILTER);
            FactorGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5,
                                         SysConst.PACKAGESPILTER);
            FactorCalCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6,
                                           SysConst.PACKAGESPILTER);
            FactorDefault = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7,
                                           SysConst.PACKAGESPILTER);
        }
