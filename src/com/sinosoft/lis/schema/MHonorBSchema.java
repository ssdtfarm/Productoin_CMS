...
import com.sinosoft.lis.db.MHonorBDB;

/*
 * <p>ClassName: MHonorBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class MHonorBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(MHonorBSchema.class);
	// @Field
	/** Idx */
	private String IDX;
	/** Statyear */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		MHonorBSchema cloned = (MHonorBSchema)super.clone();
	...
	/**
	* 使用另外一个 MHonorBSchema 对象给 Schema 赋值
	* @param: aMHonorBSchema MHonorBSchema
	**/
	public void setSchema(MHonorBSchema aMHonorBSchema)
	{
		this.IDX = aMHonorBSchema.getIDX();
		this.StatYear = aMHonorBSchema.getStatYear();
		this.StatBatch = aMHonorBSchema.getStatBatch();
		this.AgentCode = aMHonorBSchema.getAgentCode();
		this.AgentName = aMHonorBSchema.getAgentName();
		this.AgentGrade = aMHonorBSchema.getAgentGrade();
		this.BranchAttr = aMHonorBSchema.getBranchAttr();
		this.AwardType = aMHonorBSchema.getAwardType();
		this.AwardName = aMHonorBSchema.getAwardName();
		this.StartDate = fDate.getDate( aMHonorBSchema.getStartDate());
		this.EndDate = fDate.getDate( aMHonorBSchema.getEndDate());
		this.Remarks = aMHonorBSchema.getRemarks();
		this.Operator = aMHonorBSchema.getOperator();
		this.MakeDate = fDate.getDate( aMHonorBSchema.getMakeDate());
		this.MakeTime = aMHonorBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aMHonorBSchema.getModifyDate());
		this.ModifyTime = aMHonorBSchema.getModifyTime();
		this.Operator1 = aMHonorBSchema.getOperator1();
		this.MakeDate1 = fDate.getDate( aMHonorBSchema.getMakeDate1());
		this.MakeTime1 = aMHonorBSchema.getMakeTime1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的MHonorB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "MHonorBSchema";
	...
	public MHonorBSchema getSchema()
	{
		MHonorBSchema aMHonorBSchema = new MHonorBSchema();
		aMHonorBSchema.setSchema(this);
		return aMHonorBSchema;
	}

	public MHonorBDB getDB()
	{
		MHonorBDB aDBOper = new MHonorBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpMHonorB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpMHonorB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		MHonorBSchema other = (MHonorBSchema)otherObject;
		return
