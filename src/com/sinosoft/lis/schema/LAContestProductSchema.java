...
import com.sinosoft.lis.db.LAContestProductDB;

/*
 * <p>ClassName: LAContestProductSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAContestProductSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAContestProductSchema.class);
	// @Field
	/** Contestcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAContestProductSchema cloned = (LAContestProductSchema)super.clone();
	...
	/**
	* 使用另外一个 LAContestProductSchema 对象给 Schema 赋值
	* @param: aLAContestProductSchema LAContestProductSchema
	**/
	public void setSchema(LAContestProductSchema aLAContestProductSchema)
	{
		this.ContestCode = aLAContestProductSchema.getContestCode();
		this.ProductCode = aLAContestProductSchema.getProductCode();
		this.Operator = aLAContestProductSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAContestProductSchema.getMakeDate());
		this.MakeTime = aLAContestProductSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAContestProductSchema.getModifyDate());
		this.ModifyTime = aLAContestProductSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAContestProduct表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAContestProductSchema";
	...
	public LAContestProductSchema getSchema()
	{
		LAContestProductSchema aLAContestProductSchema = new LAContestProductSchema();
		aLAContestProductSchema.setSchema(this);
		return aLAContestProductSchema;
	}

	public LAContestProductDB getDB()
	{
		LAContestProductDB aDBOper = new LAContestProductDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAContestProduct>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAContestProductSchema other = (LAContestProductSchema)otherObject;
		return
