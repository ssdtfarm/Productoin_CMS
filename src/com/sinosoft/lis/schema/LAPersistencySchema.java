...
import com.sinosoft.lis.db.LAPersistencyDB;

/*
 * <p>ClassName: LAPersistencySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAPersistencySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAPersistencySchema.class);
	// @Field
	/** Persistencysn */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAPersistencySchema cloned = (LAPersistencySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LAPersistencySchema 对象给 Schema 赋值
	* @param: aLAPersistencySchema LAPersistencySchema
	**/
	public void setSchema(LAPersistencySchema aLAPersistencySchema)
	{
		this.PersistencySN = aLAPersistencySchema.getPersistencySN();
		this.CompanyCode = aLAPersistencySchema.getCompanyCode();
		this.MainPolNo = aLAPersistencySchema.getMainPolNo();
		this.ProductCode = aLAPersistencySchema.getProductCode();
		this.RiskCode = aLAPersistencySchema.getRiskCode();
		this.CvaliDate = fDate.getDate( aLAPersistencySchema.getCvaliDate());
		this.LapseANP = aLAPersistencySchema.getLapseANP();
		this.ExposureANP = aLAPersistencySchema.getExposureANP();
		this.CalculationDate = fDate.getDate( aLAPersistencySchema.getCalculationDate());
		this.BusinessDate = fDate.getDate( aLAPersistencySchema.getBusinessDate());
		this.BatchNo = aLAPersistencySchema.getBatchNo();
		this.BatchDate = fDate.getDate( aLAPersistencySchema.getBatchDate());
		this.CalDate = fDate.getDate( aLAPersistencySchema.getCalDate());
		this.SplitRate1 = aLAPersistencySchema.getSplitRate1();
		this.Agentcode1 = aLAPersistencySchema.getAgentcode1();
		this.UMCode1 = aLAPersistencySchema.getUMCode1();
		this.UnitCode1 = aLAPersistencySchema.getUnitCode1();
		this.DMCode1 = aLAPersistencySchema.getDMCode1();
		this.DivisionCode1 = aLAPersistencySchema.getDivisionCode1();
		this.RMCode1 = aLAPersistencySchema.getRMCode1();
		this.RegionCode1 = aLAPersistencySchema.getRegionCode1();
		this.DRCode1 = aLAPersistencySchema.getDRCode1();
		this.IDRCode1 = aLAPersistencySchema.getIDRCode1();
		this.RCCode1 = aLAPersistencySchema.getRCCode1();
		this.RFCode1 = aLAPersistencySchema.getRFCode1();
		this.AssessMonth1 = aLAPersistencySchema.getAssessMonth1();
		this.WageMonth1 = aLAPersistencySchema.getWageMonth1();
		this.SplitRate2 = aLAPersistencySchema.getSplitRate2();
		this.Agentcode2 = aLAPersistencySchema.getAgentcode2();
		this.UMCode2 = aLAPersistencySchema.getUMCode2();
		this.UnitCode2 = aLAPersistencySchema.getUnitCode2();
		this.DMCode2 = aLAPersistencySchema.getDMCode2();
		this.DivisionCode2 = aLAPersistencySchema.getDivisionCode2();
		this.RMCode2 = aLAPersistencySchema.getRMCode2();
		this.RegionCode2 = aLAPersistencySchema.getRegionCode2();
		this.DRCode2 = aLAPersistencySchema.getDRCode2();
		this.IDRCode2 = aLAPersistencySchema.getIDRCode2();
		this.RCCode2 = aLAPersistencySchema.getRCCode2();
		this.RFCode2 = aLAPersistencySchema.getRFCode2();
		this.AssessMonth2 = aLAPersistencySchema.getAssessMonth2();
		this.WageMonth2 = aLAPersistencySchema.getWageMonth2();
		this.Operator = aLAPersistencySchema.getOperator();
		this.MakeDate = fDate.getDate( aLAPersistencySchema.getMakeDate());
		this.MakeTime = aLAPersistencySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAPersistencySchema.getModifyDate());
		this.ModifyTime = aLAPersistencySchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAPersistency表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAPersistencySchema";
	...
	public LAPersistencySchema getSchema()
	{
		LAPersistencySchema aLAPersistencySchema = new LAPersistencySchema();
		aLAPersistencySchema.setSchema(this);
		return aLAPersistencySchema;
	}

	public LAPersistencyDB getDB()
	{
		LAPersistencyDB aDBOper = new LAPersistencyDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAPersistency描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAPersistency>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAPersistencySchema other = (LAPersistencySchema)otherObject;
		return
