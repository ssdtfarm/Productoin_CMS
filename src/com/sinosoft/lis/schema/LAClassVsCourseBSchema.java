...
import com.sinosoft.lis.db.LAClassVsCourseBDB;

/*
 * <p>ClassName: LAClassVsCourseBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAClassVsCourseBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAClassVsCourseBSchema.class);
	// @Field
	/** Courseid */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAClassVsCourseBSchema cloned = (LAClassVsCourseBSchema)super.clone();
	...
	/**
	* 使用另外一个 LAClassVsCourseBSchema 对象给 Schema 赋值
	* @param: aLAClassVsCourseBSchema LAClassVsCourseBSchema
	**/
	public void setSchema(LAClassVsCourseBSchema aLAClassVsCourseBSchema)
	{
		this.CourseID = aLAClassVsCourseBSchema.getCourseID();
		this.ClassNo = aLAClassVsCourseBSchema.getClassNo();
		this.ChannelCode = aLAClassVsCourseBSchema.getChannelCode();
		this.MakeDate = fDate.getDate( aLAClassVsCourseBSchema.getMakeDate());
		this.MakeTime = aLAClassVsCourseBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAClassVsCourseBSchema.getModifyDate());
		this.ModifyTime = aLAClassVsCourseBSchema.getModifyTime();
		this.Operator = aLAClassVsCourseBSchema.getOperator();
		this.MakeDate1 = fDate.getDate( aLAClassVsCourseBSchema.getMakeDate1());
		this.MakeTime1 = aLAClassVsCourseBSchema.getMakeTime1();
		this.Operator1 = aLAClassVsCourseBSchema.getOperator1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAClassVsCourseB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAClassVsCourseBSchema";
	...
	public LAClassVsCourseBSchema getSchema()
	{
		LAClassVsCourseBSchema aLAClassVsCourseBSchema = new LAClassVsCourseBSchema();
		aLAClassVsCourseBSchema.setSchema(this);
		return aLAClassVsCourseBSchema;
	}

	public LAClassVsCourseBDB getDB()
	{
		LAClassVsCourseBDB aDBOper = new LAClassVsCourseBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAClassVsCourseB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAClassVsCourseB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAClassVsCourseBSchema other = (LAClassVsCourseBSchema)otherObject;
		return
