...
import com.sinosoft.lis.db.LARepImpCodeBDB;

/*
 * <p>ClassName: LARepImpCodeBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LARepImpCodeBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LARepImpCodeBSchema.class);
	// @Field
	/** Impcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LARepImpCodeBSchema cloned = (LARepImpCodeBSchema)super.clone();
	...
	/**
	* 使用另外一个 LARepImpCodeBSchema 对象给 Schema 赋值
	* @param: aLARepImpCodeBSchema LARepImpCodeBSchema
	**/
	public void setSchema(LARepImpCodeBSchema aLARepImpCodeBSchema)
	{
		this.ImpCode = aLARepImpCodeBSchema.getImpCode();
		this.ImpName = aLARepImpCodeBSchema.getImpName();
		this.ImpType = aLARepImpCodeBSchema.getImpType();
		this.ImpInput = aLARepImpCodeBSchema.getImpInput();
		this.ImpCodeType = aLARepImpCodeBSchema.getImpCodeType();
		this.ImpCodeFrom = aLARepImpCodeBSchema.getImpCodeFrom();
		this.Flag1 = aLARepImpCodeBSchema.getFlag1();
		this.Flag2 = aLARepImpCodeBSchema.getFlag2();
		this.Flag3 = aLARepImpCodeBSchema.getFlag3();
		this.MakeDate = fDate.getDate( aLARepImpCodeBSchema.getMakeDate());
		this.MakeTime = aLARepImpCodeBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLARepImpCodeBSchema.getModifyDate());
		this.ModifyTime = aLARepImpCodeBSchema.getModifyTime();
		this.Operator = aLARepImpCodeBSchema.getOperator();
		this.MakeDate1 = fDate.getDate( aLARepImpCodeBSchema.getMakeDate1());
		this.MakeTime1 = aLARepImpCodeBSchema.getMakeTime1();
		this.Operator1 = aLARepImpCodeBSchema.getOperator1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LARepImpCodeB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LARepImpCodeBSchema";
	...
	public LARepImpCodeBSchema getSchema()
	{
		LARepImpCodeBSchema aLARepImpCodeBSchema = new LARepImpCodeBSchema();
		aLARepImpCodeBSchema.setSchema(this);
		return aLARepImpCodeBSchema;
	}

	public LARepImpCodeBDB getDB()
	{
		LARepImpCodeBDB aDBOper = new LARepImpCodeBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLARepImpCodeB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LARepImpCodeBSchema other = (LARepImpCodeBSchema)otherObject;
		return
