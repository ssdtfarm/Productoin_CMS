...
import com.sinosoft.lis.db.LecturertToClassDB;

/*
 * <p>ClassName: LecturertToClassSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LecturertToClassSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LecturertToClassSchema.class);
	// @Field
	/** Agentcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LecturertToClassSchema cloned = (LecturertToClassSchema)super.clone();
	...
	/**
	* 使用另外一个 LecturertToClassSchema 对象给 Schema 赋值
	* @param: aLecturertToClassSchema LecturertToClassSchema
	**/
	public void setSchema(LecturertToClassSchema aLecturertToClassSchema)
	{
		this.AgentCode = aLecturertToClassSchema.getAgentCode();
		this.ClassNo = aLecturertToClassSchema.getClassNo();
		this.Remarks = aLecturertToClassSchema.getRemarks();
		this.MakeDate = fDate.getDate( aLecturertToClassSchema.getMakeDate());
		this.MakeTime = aLecturertToClassSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLecturertToClassSchema.getModifyDate());
		this.ModifyTime = aLecturertToClassSchema.getModifyTime();
		this.Operator = aLecturertToClassSchema.getOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LecturertToClass表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LecturertToClassSchema";
	...
	public LecturertToClassSchema getSchema()
	{
		LecturertToClassSchema aLecturertToClassSchema = new LecturertToClassSchema();
		aLecturertToClassSchema.setSchema(this);
		return aLecturertToClassSchema;
	}

	public LecturertToClassDB getDB()
	{
		LecturertToClassDB aDBOper = new LecturertToClassDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLecturertToClass描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLecturertToClass>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LecturertToClassSchema other = (LecturertToClassSchema)otherObject;
		return
