...
import com.sinosoft.lis.db.LAFinanceDataBDB;

/*
 * <p>ClassName: LAFinanceDataBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAFinanceDataBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAFinanceDataBSchema.class);
	// @Field
	/** Indexcalno */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAFinanceDataBSchema cloned = (LAFinanceDataBSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LAFinanceDataBSchema 对象给 Schema 赋值
	* @param: aLAFinanceDataBSchema LAFinanceDataBSchema
	**/
	public void setSchema(LAFinanceDataBSchema aLAFinanceDataBSchema)
	{
		this.IndexCalNo = aLAFinanceDataBSchema.getIndexCalNo();
		this.TransDate = fDate.getDate( aLAFinanceDataBSchema.getTransDate());
		this.ManageCom = aLAFinanceDataBSchema.getManageCom();
		this.ReportCode = aLAFinanceDataBSchema.getReportCode();
		this.ReportName = aLAFinanceDataBSchema.getReportName();
		this.TitleCode = aLAFinanceDataBSchema.getTitleCode();
		this.TitleName = aLAFinanceDataBSchema.getTitleName();
		this.Amount = aLAFinanceDataBSchema.getAmount();
		this.B1 = aLAFinanceDataBSchema.getB1();
		this.B2 = aLAFinanceDataBSchema.getB2();
		this.B3 = aLAFinanceDataBSchema.getB3();
		this.Operator = aLAFinanceDataBSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAFinanceDataBSchema.getMakeDate());
		this.MakeTime = aLAFinanceDataBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAFinanceDataBSchema.getModifyDate());
		this.ModifyTime = aLAFinanceDataBSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAFinanceDataB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAFinanceDataBSchema";
	...
	public LAFinanceDataBSchema getSchema()
	{
		LAFinanceDataBSchema aLAFinanceDataBSchema = new LAFinanceDataBSchema();
		aLAFinanceDataBSchema.setSchema(this);
		return aLAFinanceDataBSchema;
	}

	public LAFinanceDataBDB getDB()
	{
		LAFinanceDataBDB aDBOper = new LAFinanceDataBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAFinanceDataB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Amount = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).doubleValue();
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAFinanceDataBSchema other = (LAFinanceDataBSchema)otherObject;
		return
