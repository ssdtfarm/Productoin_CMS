...
import com.sinosoft.lis.db.LAContestAgentDB;

/*
 * <p>ClassName: LAContestAgentSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAContestAgentSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAContestAgentSchema.class);
	// @Field
	/** Contestcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAContestAgentSchema cloned = (LAContestAgentSchema)super.clone();
	...
	/**
	* 使用另外一个 LAContestAgentSchema 对象给 Schema 赋值
	* @param: aLAContestAgentSchema LAContestAgentSchema
	**/
	public void setSchema(LAContestAgentSchema aLAContestAgentSchema)
	{
		this.ContestCode = aLAContestAgentSchema.getContestCode();
		this.AgentCode = aLAContestAgentSchema.getAgentCode();
		this.Operator = aLAContestAgentSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAContestAgentSchema.getMakeDate());
		this.MakeTime = aLAContestAgentSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAContestAgentSchema.getModifyDate());
		this.ModifyTime = aLAContestAgentSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAContestAgent表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAContestAgentSchema";
	...
	public LAContestAgentSchema getSchema()
	{
		LAContestAgentSchema aLAContestAgentSchema = new LAContestAgentSchema();
		aLAContestAgentSchema.setSchema(this);
		return aLAContestAgentSchema;
	}

	public LAContestAgentDB getDB()
	{
		LAContestAgentDB aDBOper = new LAContestAgentDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAContestAgent描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAContestAgent>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAContestAgentSchema other = (LAContestAgentSchema)otherObject;
		return
