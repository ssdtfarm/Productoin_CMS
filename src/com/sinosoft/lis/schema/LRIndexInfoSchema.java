...
import com.sinosoft.lis.db.LRIndexInfoDB;

/*
 * <p>ClassName: LRIndexInfoSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LRIndexInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LRIndexInfoSchema.class);
	// @Field
	/** Wageno */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LRIndexInfoSchema cloned = (LRIndexInfoSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LRIndexInfoSchema 对象给 Schema 赋值
	* @param: aLRIndexInfoSchema LRIndexInfoSchema
	**/
	public void setSchema(LRIndexInfoSchema aLRIndexInfoSchema)
	{
		this.WageNo = aLRIndexInfoSchema.getWageNo();
		this.IndexType = aLRIndexInfoSchema.getIndexType();
		this.BranchType = aLRIndexInfoSchema.getBranchType();
		this.BranchType2 = aLRIndexInfoSchema.getBranchType2();
		this.BaseCode = aLRIndexInfoSchema.getBaseCode();
		this.IndexCode = aLRIndexInfoSchema.getIndexCode();
		this.AgentCode = aLRIndexInfoSchema.getAgentCode();
		this.AgentGrade = aLRIndexInfoSchema.getAgentGrade();
		this.ManageCom = aLRIndexInfoSchema.getManageCom();
		this.BranchAttr = aLRIndexInfoSchema.getBranchAttr();
		this.AgentGroup = aLRIndexInfoSchema.getAgentGroup();
		this.BranchSeries = aLRIndexInfoSchema.getBranchSeries();
		this.State = aLRIndexInfoSchema.getState();
		this.Operator = aLRIndexInfoSchema.getOperator();
		this.MakeDate = fDate.getDate( aLRIndexInfoSchema.getMakeDate());
		this.MakeTime = aLRIndexInfoSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLRIndexInfoSchema.getModifyDate());
		this.ModifyTime = aLRIndexInfoSchema.getModifyTime();
		this.DataType = aLRIndexInfoSchema.getDataType();
		this.D = fDate.getDate( aLRIndexInfoSchema.getD());
		this.N0 = aLRIndexInfoSchema.getN0();
		this.N2 = aLRIndexInfoSchema.getN2();
		this.N4 = aLRIndexInfoSchema.getN4();
		this.N6 = aLRIndexInfoSchema.getN6();
		this.S = aLRIndexInfoSchema.getS();
		this.MainIndexFlag = aLRIndexInfoSchema.getMainIndexFlag();
		this.WageName = aLRIndexInfoSchema.getWageName();
		this.WageCode = aLRIndexInfoSchema.getWageCode();
		this.CalType = aLRIndexInfoSchema.getCalType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LRIndexInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LRIndexInfoSchema";
	...
	public LRIndexInfoSchema getSchema()
	{
		LRIndexInfoSchema aLRIndexInfoSchema = new LRIndexInfoSchema();
		aLRIndexInfoSchema.setSchema(this);
		return aLRIndexInfoSchema;
	}

	public LRIndexInfoDB getDB()
	{
		LRIndexInfoDB aDBOper = new LRIndexInfoDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLRIndexInfo描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLRIndexInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LRIndexInfoSchema other = (LRIndexInfoSchema)otherObject;
		return
