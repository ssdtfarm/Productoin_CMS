...
import com.sinosoft.lis.db.LAClassDescBDB;

/*
 * <p>ClassName: LAClassDescBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAClassDescBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAClassDescBSchema.class);
	// @Field
	/** Classno */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAClassDescBSchema cloned = (LAClassDescBSchema)super.clone();
	...
	/**
	* 使用另外一个 LAClassDescBSchema 对象给 Schema 赋值
	* @param: aLAClassDescBSchema LAClassDescBSchema
	**/
	public void setSchema(LAClassDescBSchema aLAClassDescBSchema)
	{
		this.ClassNo = aLAClassDescBSchema.getClassNo();
		this.ChannelCode = aLAClassDescBSchema.getChannelCode();
		this.ClassName = aLAClassDescBSchema.getClassName();
		this.ReceiGrade = aLAClassDescBSchema.getReceiGrade();
		this.ClassSeries = aLAClassDescBSchema.getClassSeries();
		this.StopFlag = aLAClassDescBSchema.getStopFlag();
		this.MakeDate = fDate.getDate( aLAClassDescBSchema.getMakeDate());
		this.MakeTime = aLAClassDescBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAClassDescBSchema.getModifyDate());
		this.ModifyTime = aLAClassDescBSchema.getModifyTime();
		this.Operator = aLAClassDescBSchema.getOperator();
		this.MakeDate1 = fDate.getDate( aLAClassDescBSchema.getMakeDate1());
		this.MakeTime1 = aLAClassDescBSchema.getMakeTime1();
		this.Operator1 = aLAClassDescBSchema.getOperator1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAClassDescB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAClassDescBSchema";
	...
	public LAClassDescBSchema getSchema()
	{
		LAClassDescBSchema aLAClassDescBSchema = new LAClassDescBSchema();
		aLAClassDescBSchema.setSchema(this);
		return aLAClassDescBSchema;
	}

	public LAClassDescBDB getDB()
	{
		LAClassDescBDB aDBOper = new LAClassDescBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAClassDescB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAClassDescB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAClassDescBSchema other = (LAClassDescBSchema)otherObject;
		return
