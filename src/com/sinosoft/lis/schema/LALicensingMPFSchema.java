...
import com.sinosoft.lis.db.LALicensingMPFDB;

/*
 * <p>ClassName: LALicensingMPFSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LALicensingMPFSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LALicensingMPFSchema.class);
	// @Field
	/** Agentcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LALicensingMPFSchema cloned = (LALicensingMPFSchema)super.clone();
	...
	/**
	* 使用另外一个 LALicensingMPFSchema 对象给 Schema 赋值
	* @param: aLALicensingMPFSchema LALicensingMPFSchema
	**/
	public void setSchema(LALicensingMPFSchema aLALicensingMPFSchema)
	{
		this.AgentCode = aLALicensingMPFSchema.getAgentCode();
		this.MPFRegNo = aLALicensingMPFSchema.getMPFRegNo();
		this.MPFRegStatus = aLALicensingMPFSchema.getMPFRegStatus();
		this.MPFRegDate = fDate.getDate( aLALicensingMPFSchema.getMPFRegDate());
		this.MPFDeregDate = fDate.getDate( aLALicensingMPFSchema.getMPFDeregDate());
		this.Remarks = aLALicensingMPFSchema.getRemarks();
		this.Flag1 = aLALicensingMPFSchema.getFlag1();
		this.Flag2 = aLALicensingMPFSchema.getFlag2();
		this.Flag3 = aLALicensingMPFSchema.getFlag3();
		this.HKFIBak1 = aLALicensingMPFSchema.getHKFIBak1();
		this.HKFIBak2 = aLALicensingMPFSchema.getHKFIBak2();
		this.HKFIBak3 = aLALicensingMPFSchema.getHKFIBak3();
		this.Operator = aLALicensingMPFSchema.getOperator();
		this.MakeDate = fDate.getDate( aLALicensingMPFSchema.getMakeDate());
		this.MakeTime = aLALicensingMPFSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLALicensingMPFSchema.getModifyDate());
		this.ModifyTime = aLALicensingMPFSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LALicensingMPF表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LALicensingMPFSchema";
	...
	public LALicensingMPFSchema getSchema()
	{
		LALicensingMPFSchema aLALicensingMPFSchema = new LALicensingMPFSchema();
		aLALicensingMPFSchema.setSchema(this);
		return aLALicensingMPFSchema;
	}

	public LALicensingMPFDB getDB()
	{
		LALicensingMPFDB aDBOper = new LALicensingMPFDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLALicensingMPF>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LALicensingMPFSchema other = (LALicensingMPFSchema)otherObject;
		return
