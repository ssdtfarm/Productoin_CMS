...
import com.sinosoft.lis.db.LAAwardTypeDB;

/*
 * <p>ClassName: LAAwardTypeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAAwardTypeSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAAwardTypeSchema.class);
	// @Field
	/** Idx */
	private String IDX;
	/** Awardtype */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAAwardTypeSchema cloned = (LAAwardTypeSchema)super.clone();
	...
	/**
	* 使用另外一个 LAAwardTypeSchema 对象给 Schema 赋值
	* @param: aLAAwardTypeSchema LAAwardTypeSchema
	**/
	public void setSchema(LAAwardTypeSchema aLAAwardTypeSchema)
	{
		this.IDX = aLAAwardTypeSchema.getIDX();
		this.AwardType = aLAAwardTypeSchema.getAwardType();
		this.Operator = aLAAwardTypeSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAAwardTypeSchema.getMakeDate());
		this.MakeTime = aLAAwardTypeSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAAwardTypeSchema.getModifyDate());
		this.ModifyTime = aLAAwardTypeSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAAwardType表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAAwardTypeSchema";
	...
	public LAAwardTypeSchema getSchema()
	{
		LAAwardTypeSchema aLAAwardTypeSchema = new LAAwardTypeSchema();
		aLAAwardTypeSchema.setSchema(this);
		return aLAAwardTypeSchema;
	}

	public LAAwardTypeDB getDB()
	{
		LAAwardTypeDB aDBOper = new LAAwardTypeDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAwardType描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAwardType>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AwardType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAAwardTypeSchema other = (LAAwardTypeSchema)otherObject;
		return
