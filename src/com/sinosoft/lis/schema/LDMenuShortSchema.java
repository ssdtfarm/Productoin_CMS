...
/*
 * <p>ClassName: LDMenuShortSchema </p>
 ...
 */
public class LDMenuShortSchema implements Schema, Cloneable
{
	// @Field
	/** 菜单节点编码 */
	...
	public LDMenuShortSchema()
	{
		...
		PK = pk;
            ...
            public Object clone()
                    throws CloneNotSupportedException
            {
                LDMenuShortSchema cloned = (LDMenuShortSchema)super.clone();
	...
	{
		if (SysConst.CHANGECHARSET && NodeCode != null && !NodeCode.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && ParentNodeCode != null && !ParentNodeCode.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && NodeLevel != null && !NodeLevel.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && NodeName != null && !NodeName.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && ChildFlag != null && !ChildFlag.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && NodeKey != null && !NodeKey.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && RunScript != null && !RunScript.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && NodeDescription != null && !NodeDescription.equals(""))
		{
	...
	{
		if (SysConst.CHANGECHARSET && NodeSign != null && !NodeSign.equals(""))
		{
	...
	/**
	* 使用另外一个 LDMenuShortSchema 对象给 Schema 赋值
	* @param: aLDMenuShortSchema LDMenuShortSchema
	**/
	public void setSchema(LDMenuShortSchema aLDMenuShortSchema)
	{
		this.NodeCode = aLDMenuShortSchema.getNodeCode();
		this.ParentNodeCode = aLDMenuShortSchema.getParentNodeCode();
		this.NodeLevel = aLDMenuShortSchema.getNodeLevel();
		this.NodeName = aLDMenuShortSchema.getNodeName();
		this.ChildFlag = aLDMenuShortSchema.getChildFlag();
		this.NodeKey = aLDMenuShortSchema.getNodeKey();
		this.RunScript = aLDMenuShortSchema.getRunScript();
		this.NodeDescription = aLDMenuShortSchema.getNodeDescription();
		this.NodeSign = aLDMenuShortSchema.getNodeSign();
		this.NodeOrder = aLDMenuShortSchema.getNodeOrder();
		this.Operator = aLDMenuShortSchema.getOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		catch(SQLException sqle)
		{
			...
			tError.moduleName = "LDMenuShortSchema";
	...
	public LDMenuShortSchema getSchema()
	{
		LDMenuShortSchema aLDMenuShortSchema = new LDMenuShortSchema();
		aLDMenuShortSchema.setSchema(this);
		return aLDMenuShortSchema;
	}

	public LDMenuShortDB getDB()
	{
		LDMenuShortDB aDBOper = new LDMenuShortDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDMenuShort描述/A>表字段
	* @return: String 返回打包后字符串
	**/
	public String encode()
	{
		StringBuffer strReturn = new StringBuffer(256);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(NodeCode))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(ParentNodeCode))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(NodeLevel))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(NodeName))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(ChildFlag))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(NodeKey))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(RunScript))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(NodeDescription))); strReturn.append(SysConst.PACKAGESPILTER);
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(NodeSign))); strReturn.append(SysConst.PACKAGESPILTER);
...
strReturn.append(StrTool.cTrim( StrTool.unicodeToGBK(Operator)));
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDMenuShort>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDMenuShortSchema other = (LDMenuShortSchema)otherObject;
		return
