...
public class LABranchLevelSchema implements Schema, Cloneable
{
	...
	**/
	public void setSchema(LABranchLevelSchema aLABranchLevelSchema)
	{
		...
		this.BranchType2 = aLABranchLevelSchema.getBranchType2();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的LABranchLevel表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
