...
import com.sinosoft.lis.db.LACPDDB;

/*
 * <p>ClassName: LACPDSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LACPDSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LACPDSchema.class);
	// @Field
	/** Agentcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LACPDSchema cloned = (LACPDSchema)super.clone();
	...
	/**
	* 使用另外一个 LACPDSchema 对象给 Schema 赋值
	* @param: aLACPDSchema LACPDSchema
	**/
	public void setSchema(LACPDSchema aLACPDSchema)
	{
		this.AgentCode = aLACPDSchema.getAgentCode();
		this.CourseName = aLACPDSchema.getCourseName();
		this.HKCAAVQCode = aLACPDSchema.getHKCAAVQCode();
		this.CourseDate = fDate.getDate( aLACPDSchema.getCourseDate());
		this.RegulatoryType1 = aLACPDSchema.getRegulatoryType1();
		this.RegulatoryType2 = aLACPDSchema.getRegulatoryType2();
		this.RegulatoryType3 = aLACPDSchema.getRegulatoryType3();
		this.CPDHourType1 = aLACPDSchema.getCPDHourType1();
		this.CPDHourType2 = aLACPDSchema.getCPDHourType2();
		this.CPDHourType3 = aLACPDSchema.getCPDHourType3();
		this.CPDHour1 = aLACPDSchema.getCPDHour1();
		this.CPDHour2 = aLACPDSchema.getCPDHour2();
		this.CPDHour3 = aLACPDSchema.getCPDHour3();
		this.ReportingPeriod = fDate.getDate( aLACPDSchema.getReportingPeriod());
		this.Remark = aLACPDSchema.getRemark();
		this.EligibleAmounts = aLACPDSchema.getEligibleAmounts();
		this.ReimbursedAmount = aLACPDSchema.getReimbursedAmount();
		this.Operator = aLACPDSchema.getOperator();
		this.MakeDate = fDate.getDate( aLACPDSchema.getMakeDate());
		this.MakeTime = aLACPDSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLACPDSchema.getModifyDate());
		this.ModifyTime = aLACPDSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LACPD表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LACPDSchema";
	...
	public LACPDSchema getSchema()
	{
		LACPDSchema aLACPDSchema = new LACPDSchema();
		aLACPDSchema.setSchema(this);
		return aLACPDSchema;
	}

	public LACPDDB getDB()
	{
		LACPDDB aDBOper = new LACPDDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLACPD>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LACPDSchema other = (LACPDSchema)otherObject;
		return
