...
import com.sinosoft.lis.db.LALoanDB;

/*
 * <p>ClassName: LALoanSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LALoanSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LALoanSchema.class);
	// @Field
	/** Id */
	private String ID;
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LALoanSchema cloned = (LALoanSchema)super.clone();
	...
	/**
	* 使用另外一个 LALoanSchema 对象给 Schema 赋值
	* @param: aLALoanSchema LALoanSchema
	**/
	public void setSchema(LALoanSchema aLALoanSchema)
	{
		this.ID = aLALoanSchema.getID();
		this.LeaderLiabilityAgentDivisionCode = aLALoanSchema.getLeaderLiabilityAgentDivisionCode();
		this.LeaderLiabilityLoanAgentCode = aLALoanSchema.getLeaderLiabilityLoanAgentCode();
		this.LeaderLiabilityLoanAgentName = aLALoanSchema.getLeaderLiabilityLoanAgentName();
		this.LeaderLiabilityLoanAgentTitle = aLALoanSchema.getLeaderLiabilityLoanAgentTitle();
		this.LeaderLiabilityLoanAgentContractStatus = aLALoanSchema.getLeaderLiabilityLoanAgentContractStatus();
		this.AgentDivisionCode = aLALoanSchema.getAgentDivisionCode();
		this.AgentCode = aLALoanSchema.getAgentCode();
		this.AgentName = aLALoanSchema.getAgentName();
		this.AgentTitle = aLALoanSchema.getAgentTitle();
		this.AgentContractStatus = aLALoanSchema.getAgentContractStatus();
		this.LoanType = aLALoanSchema.getLoanType();
		this.LoanStatus = aLALoanSchema.getLoanStatus();
		this.LoanAmount = aLALoanSchema.getLoanAmount();
		this.InterestRate = aLALoanSchema.getInterestRate();
		this.Installment = aLALoanSchema.getInstallment();
		this.MonthlyRepaymentAmount = aLALoanSchema.getMonthlyRepaymentAmount();
		this.LoanFrom = aLALoanSchema.getLoanFrom();
		this.LoanTo = aLALoanSchema.getLoanTo();
		this.WithheldReason = aLALoanSchema.getWithheldReason();
		this.Operator = aLALoanSchema.getOperator();
		this.DeleteFlag = aLALoanSchema.getDeleteFlag();
		this.MakeDate = fDate.getDate( aLALoanSchema.getMakeDate());
		this.MakeTime = aLALoanSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLALoanSchema.getModifyDate());
		this.ModifyTime = aLALoanSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LALoan表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LALoanSchema";
	...
	public LALoanSchema getSchema()
	{
		LALoanSchema aLALoanSchema = new LALoanSchema();
		aLALoanSchema.setSchema(this);
		return aLALoanSchema;
	}

	public LALoanDB getDB()
	{
		LALoanDB aDBOper = new LALoanDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLALoan描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLALoan>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LALoanSchema other = (LALoanSchema)otherObject;
		return
