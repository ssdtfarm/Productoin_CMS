...
/*
 * <p>ClassName: LRBaseSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LRBaseSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LRBaseSchema.class);
	// @Field
	/** Basecode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LRBaseSchema cloned = (LRBaseSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LRBaseSchema 对象给 Schema 赋值
	* @param: aLRBaseSchema LRBaseSchema
	**/
	public void setSchema(LRBaseSchema aLRBaseSchema)
	{
		this.BaseCode = aLRBaseSchema.getBaseCode();
		this.Name = aLRBaseSchema.getName();
		this.Status = aLRBaseSchema.getStatus();
		this.Remark = aLRBaseSchema.getRemark();
		this.Reason = aLRBaseSchema.getReason();
		this.BranchType = aLRBaseSchema.getBranchType();
		this.BranchType2 = aLRBaseSchema.getBranchType2();
		this.Operator = aLRBaseSchema.getOperator();
		this.MakeDate = fDate.getDate( aLRBaseSchema.getMakeDate());
		this.MakeTime = aLRBaseSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLRBaseSchema.getModifyDate());
		this.ModifyTime = aLRBaseSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LRBase表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LRBaseSchema";
	...
	public LRBaseSchema getSchema()
	{
		LRBaseSchema aLRBaseSchema = new LRBaseSchema();
		aLRBaseSchema.setSchema(this);
		return aLRBaseSchema;
	}

	public LRBaseDB getDB()
	{
		LRBaseDB aDBOper = new LRBaseDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLRBase>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			BranchType2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LRBaseSchema other = (LRBaseSchema)otherObject;
		return
