...
private static Logger logger = Logger.getLogger(LAAgentBlackListSchema.class);
	...
	**/
	public void setSchema(LAAgentBlackListSchema aLAAgentBlackListSchema)
	{
		...
		this.AgentCode = aLAAgentBlackListSchema.getAgentCode();
		this.InsuranceCompany = aLAAgentBlackListSchema.getInsuranceCompany();
		this.Source = aLAAgentBlackListSchema.getSource();
		this.HandlingMethod = aLAAgentBlackListSchema.getHandlingMethod();
		this.Reason = aLAAgentBlackListSchema.getReason();
		this.EffectiveDate = fDate.getDate( aLAAgentBlackListSchema.getEffectiveDate());
		this.ExpiryDate = fDate.getDate( aLAAgentBlackListSchema.getExpiryDate());
