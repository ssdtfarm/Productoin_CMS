...
import com.sinosoft.lis.db.LAQualityAssessBDB;

/*
 * <p>ClassName: LAQualityAssessBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAQualityAssessBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAQualityAssessBSchema.class);
	// @Field
	/** Agentcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAQualityAssessBSchema cloned = (LAQualityAssessBSchema)super.clone();
	...
	/**
	* 使用另外一个 LAQualityAssessBSchema 对象给 Schema 赋值
	* @param: aLAQualityAssessBSchema LAQualityAssessBSchema
	**/
	public void setSchema(LAQualityAssessBSchema aLAQualityAssessBSchema)
	{
		this.AgentCode = aLAQualityAssessBSchema.getAgentCode();
		this.BranchType = aLAQualityAssessBSchema.getBranchType();
		this.AgentGroup = aLAQualityAssessBSchema.getAgentGroup();
		this.IDX = aLAQualityAssessBSchema.getIDX();
		this.ManageCom = aLAQualityAssessBSchema.getManageCom();
		this.NonComplianceType = aLAQualityAssessBSchema.getNonComplianceType();
		this.Source = aLAQualityAssessBSchema.getSource();
		this.Credit = aLAQualityAssessBSchema.getCredit();
		this.Remarks = aLAQualityAssessBSchema.getRemarks();
		this.RewardPunishType = aLAQualityAssessBSchema.getRewardPunishType();
		this.CaseDetails = aLAQualityAssessBSchema.getCaseDetails();
		this.Comment = aLAQualityAssessBSchema.getComment();
		this.DoneDate = fDate.getDate( aLAQualityAssessBSchema.getDoneDate());
		this.DoneFlag = aLAQualityAssessBSchema.getDoneFlag();
		this.Operator = aLAQualityAssessBSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAQualityAssessBSchema.getMakeDate());
		this.MakeTime = aLAQualityAssessBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAQualityAssessBSchema.getModifyDate());
		this.ModifyTime = aLAQualityAssessBSchema.getModifyTime();
		this.MakeDate1 = fDate.getDate( aLAQualityAssessBSchema.getMakeDate1());
		this.MakeTime1 = aLAQualityAssessBSchema.getMakeTime1();
		this.Operator1 = aLAQualityAssessBSchema.getOperator1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAQualityAssessB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAQualityAssessBSchema";
	...
	public LAQualityAssessBSchema getSchema()
	{
		LAQualityAssessBSchema aLAQualityAssessBSchema = new LAQualityAssessBSchema();
		aLAQualityAssessBSchema.setSchema(this);
		return aLAQualityAssessBSchema;
	}

	public LAQualityAssessBDB getDB()
	{
		LAQualityAssessBDB aDBOper = new LAQualityAssessBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAQualityAssessB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAQualityAssessBSchema other = (LAQualityAssessBSchema)otherObject;
		return
