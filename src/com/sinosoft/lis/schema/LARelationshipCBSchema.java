...
import com.sinosoft.lis.db.LARelationshipCBDB;

/*
 * <p>ClassName: LARelationshipCBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LARelationshipCBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LARelationshipCBSchema.class);
	// @Field
	/** Backupmonth */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LARelationshipCBSchema cloned = (LARelationshipCBSchema)super.clone();
	...
	/**
	* 使用另外一个 LARelationshipCBSchema 对象给 Schema 赋值
	* @param: aLARelationshipCBSchema LARelationshipCBSchema
	**/
	public void setSchema(LARelationshipCBSchema aLARelationshipCBSchema)
	{
		this.BackupMonth = aLARelationshipCBSchema.getBackupMonth();
		this.BackType = aLARelationshipCBSchema.getBackType();
		this.RelationID = aLARelationshipCBSchema.getRelationID();
		this.ManageCom = aLARelationshipCBSchema.getManageCom();
		this.AgentCode = aLARelationshipCBSchema.getAgentCode();
		this.Type = aLARelationshipCBSchema.getType();
		this.AgentGrade = aLARelationshipCBSchema.getAgentGrade();
		this.AgentGroup = aLARelationshipCBSchema.getAgentGroup();
		this.IAgentCode = aLARelationshipCBSchema.getIAgentCode();
		this.IAgentGroup = aLARelationshipCBSchema.getIAgentGroup();
		this.IAgentGrade = aLARelationshipCBSchema.getIAgentGrade();
		this.Deep = aLARelationshipCBSchema.getDeep();
		this.State = aLARelationshipCBSchema.getState();
		this.StartDate = fDate.getDate( aLARelationshipCBSchema.getStartDate());
		this.EndDate = fDate.getDate( aLARelationshipCBSchema.getEndDate());
		this.PBreakDate = fDate.getDate( aLARelationshipCBSchema.getPBreakDate());
		this.INo = aLARelationshipCBSchema.getINo();
		this.Operator = aLARelationshipCBSchema.getOperator();
		this.MakeDate = fDate.getDate( aLARelationshipCBSchema.getMakeDate());
		this.MakeTime = aLARelationshipCBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLARelationshipCBSchema.getModifyDate());
		this.ModifyTime = aLARelationshipCBSchema.getModifyTime();
		this.Operator1 = aLARelationshipCBSchema.getOperator1();
		this.BackupDate = fDate.getDate( aLARelationshipCBSchema.getBackupDate());
		this.BackupTime = aLARelationshipCBSchema.getBackupTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LARelationshipCB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LARelationshipCBSchema";
	...
	public LARelationshipCBSchema getSchema()
	{
		LARelationshipCBSchema aLARelationshipCBSchema = new LARelationshipCBSchema();
		aLARelationshipCBSchema.setSchema(this);
		return aLARelationshipCBSchema;
	}

	public LARelationshipCBDB getDB()
	{
		LARelationshipCBDB aDBOper = new LARelationshipCBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLARelationshipCB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLARelationshipCB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LARelationshipCBSchema other = (LARelationshipCBSchema)otherObject;
		return
