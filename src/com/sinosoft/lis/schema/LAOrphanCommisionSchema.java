...
import com.sinosoft.lis.db.LAOrphanCommisionDB;

/*
 * <p>ClassName: LAOrphanCommisionSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAOrphanCommisionSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAOrphanCommisionSchema.class);
	// @Field
	/** Commisionsn */
	...
	// @Constructor
	public LAOrphanCommisionSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAOrphanCommisionSchema cloned = (LAOrphanCommisionSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LAOrphanCommisionSchema 对象给 Schema 赋值
	* @param: aLAOrphanCommisionSchema LAOrphanCommisionSchema
	**/
	public void setSchema(LAOrphanCommisionSchema aLAOrphanCommisionSchema)
	{
		this.CommisionSN = aLAOrphanCommisionSchema.getCommisionSN();
		this.MainPolNo = aLAOrphanCommisionSchema.getMainPolNo();
		this.ServiceAgentCode = aLAOrphanCommisionSchema.getServiceAgentCode();
		this.LeaderAgentCode = aLAOrphanCommisionSchema.getLeaderAgentCode();
		this.ISLeader = aLAOrphanCommisionSchema.getISLeader();
		this.SAgentAccountAmt = aLAOrphanCommisionSchema.getSAgentAccountAmt();
		this.LeaderAccountAmt = aLAOrphanCommisionSchema.getLeaderAccountAmt();
		this.CompanyAccountAmt = aLAOrphanCommisionSchema.getCompanyAccountAmt();
		this.AssignDate = fDate.getDate( aLAOrphanCommisionSchema.getAssignDate());
		this.ASAReceivedDate = fDate.getDate( aLAOrphanCommisionSchema.getASAReceivedDate());
		this.Remark = aLAOrphanCommisionSchema.getRemark();
		this.Operator = aLAOrphanCommisionSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAOrphanCommisionSchema.getMakeDate());
		this.MakeTime = aLAOrphanCommisionSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAOrphanCommisionSchema.getModifyDate());
		this.ModifyTime = aLAOrphanCommisionSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAOrphanCommision表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAOrphanCommisionSchema";
	...
	public LAOrphanCommisionSchema getSchema()
	{
		LAOrphanCommisionSchema aLAOrphanCommisionSchema = new LAOrphanCommisionSchema();
		aLAOrphanCommisionSchema.setSchema(this);
		return aLAOrphanCommisionSchema;
	}

	public LAOrphanCommisionDB getDB()
	{
		LAOrphanCommisionDB aDBOper = new LAOrphanCommisionDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAOrphanCommision>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAOrphanCommisionSchema other = (LAOrphanCommisionSchema)otherObject;
		return
