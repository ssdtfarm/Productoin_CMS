...
/*
 * <p>ClassName: LAAgentBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAAgentBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAAgentBSchema.class);
	// @Field
	/** Agentcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAAgentBSchema cloned = (LAAgentBSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LAAgentBSchema 对象给 Schema 赋值
	* @param: aLAAgentBSchema LAAgentBSchema
	**/
	public void setSchema(LAAgentBSchema aLAAgentBSchema)
	{
		this.AgentCode = aLAAgentBSchema.getAgentCode();
		this.BranchType = aLAAgentBSchema.getBranchType();
		this.AgentGroup = aLAAgentBSchema.getAgentGroup();
		this.ManageCom = aLAAgentBSchema.getManageCom();
		this.Password = aLAAgentBSchema.getPassword();
		this.AgentState = aLAAgentBSchema.getAgentState();
		this.SurName = aLAAgentBSchema.getSurName();
		this.GivenName = aLAAgentBSchema.getGivenName();
		this.EnglishName = aLAAgentBSchema.getEnglishName();
		this.HKIDName = aLAAgentBSchema.getHKIDName();
		this.ChineseName = aLAAgentBSchema.getChineseName();
		this.IDType = aLAAgentBSchema.getIDType();
		this.IDNo = aLAAgentBSchema.getIDNo();
		this.WorkingVisa = aLAAgentBSchema.getWorkingVisa();
		this.WorkingVisaExpiryDate = fDate.getDate( aLAAgentBSchema.getWorkingVisaExpiryDate());
		this.WorkingVisaType = aLAAgentBSchema.getWorkingVisaType();
		this.Qualification = aLAAgentBSchema.getQualification();
		this.ContractType = aLAAgentBSchema.getContractType();
		this.ContractEffDate = fDate.getDate( aLAAgentBSchema.getContractEffDate());
		this.ContractStatus = aLAAgentBSchema.getContractStatus();
		this.RecruitmentProfile = aLAAgentBSchema.getRecruitmentProfile();
		this.RecruitingAgentCode = aLAAgentBSchema.getRecruitingAgentCode();
		this.ReferringAgentCode = aLAAgentBSchema.getReferringAgentCode();
		this.LastTerminationDate = fDate.getDate( aLAAgentBSchema.getLastTerminationDate());
		this.LastTerminationReason = aLAAgentBSchema.getLastTerminationReason();
		this.TerminationNo = aLAAgentBSchema.getTerminationNo();
		this.PaymentMethod = aLAAgentBSchema.getPaymentMethod();
		this.BankAccountName = aLAAgentBSchema.getBankAccountName();
		this.BankAccountNo = aLAAgentBSchema.getBankAccountNo();
		this.WithheldReason = aLAAgentBSchema.getWithheldReason();
		this.GuarantorAgentCode = aLAAgentBSchema.getGuarantorAgentCode();
		this.GuarantorAgentRelation = aLAAgentBSchema.getGuarantorAgentRelation();
		this.GuarantorType = aLAAgentBSchema.getGuarantorType();
		this.Sex = aLAAgentBSchema.getSex();
		this.Title = aLAAgentBSchema.getTitle();
		this.Nationality = aLAAgentBSchema.getNationality();
		this.Birthday = fDate.getDate( aLAAgentBSchema.getBirthday());
		this.WorkingExperience = aLAAgentBSchema.getWorkingExperience();
		this.LastJob = aLAAgentBSchema.getLastJob();
		this.LastJobServiceYears = aLAAgentBSchema.getLastJobServiceYears();
		this.InsuranceExperience = aLAAgentBSchema.getInsuranceExperience();
		this.InsuranceExperienceYears = aLAAgentBSchema.getInsuranceExperienceYears();
		this.EducationLevel = aLAAgentBSchema.getEducationLevel();
		this.AddressType = aLAAgentBSchema.getAddressType();
		this.AddressRoom = aLAAgentBSchema.getAddressRoom();
		this.AddressFloor = aLAAgentBSchema.getAddressFloor();
		this.AddressBlock = aLAAgentBSchema.getAddressBlock();
		this.AddressBuilding = aLAAgentBSchema.getAddressBuilding();
		this.AddressStreet = aLAAgentBSchema.getAddressStreet();
		this.AddressDistrict = aLAAgentBSchema.getAddressDistrict();
		this.FreeAddress = aLAAgentBSchema.getFreeAddress();
		this.Phone = aLAAgentBSchema.getPhone();
		this.Mobile = aLAAgentBSchema.getMobile();
		this.Email = aLAAgentBSchema.getEmail();
		this.CompanyEmail = aLAAgentBSchema.getCompanyEmail();
		this.OfficeAddress = aLAAgentBSchema.getOfficeAddress();
		this.OfficeTel = aLAAgentBSchema.getOfficeTel();
		this.OfficeFaxNo = aLAAgentBSchema.getOfficeFaxNo();
		this.Marriage = aLAAgentBSchema.getMarriage();
		this.SpouseName = aLAAgentBSchema.getSpouseName();
		this.SpouseIDNo = aLAAgentBSchema.getSpouseIDNo();
		this.Flag1 = aLAAgentBSchema.getFlag1();
		this.Flag2 = aLAAgentBSchema.getFlag2();
		this.Flag3 = aLAAgentBSchema.getFlag3();
		this.Operator = aLAAgentBSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAAgentBSchema.getMakeDate());
		this.MakeTime = aLAAgentBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAAgentBSchema.getModifyDate());
		this.ModifyTime = aLAAgentBSchema.getModifyTime();
		this.Operator1 = aLAAgentBSchema.getOperator1();
		this.MakeDate1 = fDate.getDate( aLAAgentBSchema.getMakeDate1());
		this.MakeTime1 = aLAAgentBSchema.getMakeTime1();
		this.LastJobNature = aLAAgentBSchema.getLastJobNature();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAAgentB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAAgentBSchema";
	...
	public LAAgentBSchema getSchema()
	{
		LAAgentBSchema aLAAgentBSchema = new LAAgentBSchema();
		aLAAgentBSchema.setSchema(this);
		return aLAAgentBSchema;
	}

	public LAAgentBDB getDB()
	{
		LAAgentBDB aDBOper = new LAAgentBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAgentB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAgentB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Operator1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70, SysConst.PACKAGESPILTER );
			MakeDate1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71,SysConst.PACKAGESPILTER));
			MakeTime1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 72, SysConst.PACKAGESPILTER );
			LastJobNature = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 73, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAAgentBSchema other = (LAAgentBSchema)otherObject;
		return
