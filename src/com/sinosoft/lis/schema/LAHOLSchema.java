...
import com.sinosoft.lis.db.LAHOLDB;

/*
 * <p>ClassName: LAHOLSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAHOLSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAHOLSchema.class);
	// @Field
	/** Agentcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAHOLSchema cloned = (LAHOLSchema)super.clone();
	...
	/**
	* 使用另外一个 LAHOLSchema 对象给 Schema 赋值
	* @param: aLAHOLSchema LAHOLSchema
	**/
	public void setSchema(LAHOLSchema aLAHOLSchema)
	{
		this.AgentCode = aLAHOLSchema.getAgentCode();
		this.AgentGroup = aLAHOLSchema.getAgentGroup();
		this.ManageCom = aLAHOLSchema.getManageCom();
		this.IDX = aLAHOLSchema.getIDX();
		this.LeaveStartDate = fDate.getDate( aLAHOLSchema.getLeaveStartDate());
		this.LeaveEndDate = fDate.getDate( aLAHOLSchema.getLeaveEndDate());
		this.Remarks = aLAHOLSchema.getRemarks();
		this.BranchType = aLAHOLSchema.getBranchType();
		this.DiagCertificate = aLAHOLSchema.getDiagCertificate();
		this.CancelLeave = aLAHOLSchema.getCancelLeave();
		this.LeaveType = aLAHOLSchema.getLeaveType();
		this.Operator = aLAHOLSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAHOLSchema.getMakeDate());
		this.MakeTime = aLAHOLSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAHOLSchema.getModifyDate());
		this.ModifyTime = aLAHOLSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAHOL表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAHOLSchema";
	...
	public LAHOLSchema getSchema()
	{
		LAHOLSchema aLAHOLSchema = new LAHOLSchema();
		aLAHOLSchema.setSchema(this);
		return aLAHOLSchema;
	}

	public LAHOLDB getDB()
	{
		LAHOLDB aDBOper = new LAHOLDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAHOL>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAHOLSchema other = (LAHOLSchema)otherObject;
		return
