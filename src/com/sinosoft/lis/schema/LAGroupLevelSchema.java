...
import com.sinosoft.lis.db.LAGroupLevelDB;

/*
 * <p>ClassName: LAGroupLevelSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAGroupLevelSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAGroupLevelSchema.class);
	// @Field
	/** Level */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAGroupLevelSchema cloned = (LAGroupLevelSchema)super.clone();
	...
	/**
	* 使用另外一个 LAGroupLevelSchema 对象给 Schema 赋值
	* @param: aLAGroupLevelSchema LAGroupLevelSchema
	**/
	public void setSchema(LAGroupLevelSchema aLAGroupLevelSchema)
	{
		this.Level = aLAGroupLevelSchema.getLevel();
		this.HierarchyName = aLAGroupLevelSchema.getHierarchyName();
		this.ChannelCode = aLAGroupLevelSchema.getChannelCode();
		this.ChannelCodeName = aLAGroupLevelSchema.getChannelCodeName();
		this.BranchTypeMaping = aLAGroupLevelSchema.getBranchTypeMaping();
		this.Operator = aLAGroupLevelSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAGroupLevelSchema.getMakeDate());
		this.MakeTime = aLAGroupLevelSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAGroupLevelSchema.getModifyDate());
		this.ModifyTime = aLAGroupLevelSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAGroupLevel表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAGroupLevelSchema";
	...
	public LAGroupLevelSchema getSchema()
	{
		LAGroupLevelSchema aLAGroupLevelSchema = new LAGroupLevelSchema();
		aLAGroupLevelSchema.setSchema(this);
		return aLAGroupLevelSchema;
	}

	public LAGroupLevelDB getDB()
	{
		LAGroupLevelDB aDBOper = new LAGroupLevelDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAGroupLevel描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAGroupLevel>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAGroupLevelSchema other = (LAGroupLevelSchema)otherObject;
		return
