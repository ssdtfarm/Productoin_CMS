...
import com.sinosoft.lis.db.LCContBDB;

/*
 * <p>ClassName: LCContBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LCContBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContBSchema.class);
	// @Field
	/** Companycode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCContBSchema cloned = (LCContBSchema)super.clone();
	...
	/**
	* 使用另外一个 LCContBSchema 对象给 Schema 赋值
	* @param: aLCContBSchema LCContBSchema
	**/
	public void setSchema(LCContBSchema aLCContBSchema)
	{
		this.CompanyCode = aLCContBSchema.getCompanyCode();
		this.MainPolNo = aLCContBSchema.getMainPolNo();
		this.ProductCode = aLCContBSchema.getProductCode();
		this.ProductType = aLCContBSchema.getProductType();
		this.AgentCode1 = aLCContBSchema.getAgentCode1();
		this.AgentCode2 = aLCContBSchema.getAgentCode2();
		this.SplitRate1 = aLCContBSchema.getSplitRate1();
		this.SplitRate2 = aLCContBSchema.getSplitRate2();
		this.SAgentCode = aLCContBSchema.getSAgentCode();
		this.PolState = aLCContBSchema.getPolState();
		this.CValiDate = fDate.getDate( aLCContBSchema.getCValiDate());
		this.SignDate = fDate.getDate( aLCContBSchema.getSignDate());
		this.ReSignDate = fDate.getDate( aLCContBSchema.getReSignDate());
		this.ReinDate = fDate.getDate( aLCContBSchema.getReinDate());
		this.AppntNo = aLCContBSchema.getAppntNo();
		this.AppntName = aLCContBSchema.getAppntName();
		this.AppntID = aLCContBSchema.getAppntID();
		this.InsuredName = aLCContBSchema.getInsuredName();
		this.InsuredID = aLCContBSchema.getInsuredID();
		this.OldPolicyNo = aLCContBSchema.getOldPolicyNo();
		this.BusinessDate = fDate.getDate( aLCContBSchema.getBusinessDate());
		this.ASAReceivedDate = fDate.getDate( aLCContBSchema.getASAReceivedDate());
		this.Flag1 = aLCContBSchema.getFlag1();
		this.Flag2 = aLCContBSchema.getFlag2();
		this.Flag3 = aLCContBSchema.getFlag3();
		this.Flag4 = aLCContBSchema.getFlag4();
		this.Flag5 = aLCContBSchema.getFlag5();
		this.BatchNo = aLCContBSchema.getBatchNo();
		this.BatchDate = fDate.getDate( aLCContBSchema.getBatchDate());
		this.ManageCom = aLCContBSchema.getManageCom();
		this.BranchType = aLCContBSchema.getBranchType();
		this.Operator = aLCContBSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCContBSchema.getMakeDate());
		this.MakeTime = aLCContBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCContBSchema.getModifyDate());
		this.ModifyTime = aLCContBSchema.getModifyTime();
		this.Operator1 = aLCContBSchema.getOperator1();
		this.MakeDate1 = fDate.getDate( aLCContBSchema.getMakeDate1());
		this.MakeTime1 = aLCContBSchema.getMakeTime1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContBSchema";
	...
	public LCContBSchema getSchema()
	{
		LCContBSchema aLCContBSchema = new LCContBSchema();
		aLCContBSchema.setSchema(this);
		return aLCContBSchema;
	}

	public LCContBDB getDB()
	{
		LCContBDB aDBOper = new LCContBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Operator1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			MakeDate1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38,SysConst.PACKAGESPILTER));
			MakeTime1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContBSchema other = (LCContBSchema)otherObject;
		return
