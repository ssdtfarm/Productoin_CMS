...
import com.sinosoft.lis.db.LAAgentFPDetailUnApprovalDB;

/*
 * <p>ClassName: LAAgentFPDetailUnApprovalSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: LAAgentFP_Setting
 */
public class LAAgentFPDetailUnApprovalSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAAgentFPDetailUnApprovalSchema.class);
	// @Field
	/** Agentcode */
	...
	// @Constructor
	public LAAgentFPDetailUnApprovalSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAAgentFPDetailUnApprovalSchema cloned = (LAAgentFPDetailUnApprovalSchema)super.clone();
	...
	/**
	* 使用另外一个 LAAgentFPDetailUnApprovalSchema 对象给 Schema 赋值
	* @param: aLAAgentFPDetailUnApprovalSchema LAAgentFPDetailUnApprovalSchema
	**/
	public void setSchema(LAAgentFPDetailUnApprovalSchema aLAAgentFPDetailUnApprovalSchema)
	{
		this.AgentCode = aLAAgentFPDetailUnApprovalSchema.getAgentCode();
		this.YearMonth = aLAAgentFPDetailUnApprovalSchema.getYearMonth();
		this.MonthlyFinance = aLAAgentFPDetailUnApprovalSchema.getMonthlyFinance();
		this.ValidationReq = aLAAgentFPDetailUnApprovalSchema.getValidationReq();
		this.WelcomeIncentive = aLAAgentFPDetailUnApprovalSchema.getWelcomeIncentive();
		this.MonthlyFinanceAdvance = aLAAgentFPDetailUnApprovalSchema.getMonthlyFinanceAdvance();
		this.ApprovalDate = fDate.getDate( aLAAgentFPDetailUnApprovalSchema.getApprovalDate());
		this.ApprovalTime = aLAAgentFPDetailUnApprovalSchema.getApprovalTime();
		this.ApprovalOperator = aLAAgentFPDetailUnApprovalSchema.getApprovalOperator();
		this.ApprovalReason = aLAAgentFPDetailUnApprovalSchema.getApprovalReason();
		this.ApprovalFlag = aLAAgentFPDetailUnApprovalSchema.getApprovalFlag();
		this.Operator = aLAAgentFPDetailUnApprovalSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAAgentFPDetailUnApprovalSchema.getMakeDate());
		this.MakeTime = aLAAgentFPDetailUnApprovalSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAAgentFPDetailUnApprovalSchema.getModifyDate());
		this.ModifyTime = aLAAgentFPDetailUnApprovalSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAAgentFPDetailUnApproval表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAAgentFPDetailUnApprovalSchema";
	...
	public LAAgentFPDetailUnApprovalSchema getSchema()
	{
		LAAgentFPDetailUnApprovalSchema aLAAgentFPDetailUnApprovalSchema = new LAAgentFPDetailUnApprovalSchema();
		aLAAgentFPDetailUnApprovalSchema.setSchema(this);
		return aLAAgentFPDetailUnApprovalSchema;
	}

	public LAAgentFPDetailUnApprovalDB getDB()
	{
		LAAgentFPDetailUnApprovalDB aDBOper = new LAAgentFPDetailUnApprovalDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAgentFPDetailUnApproval>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAAgentFPDetailUnApprovalSchema other = (LAAgentFPDetailUnApprovalSchema)otherObject;
		return
