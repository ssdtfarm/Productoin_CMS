...
private static Logger logger = Logger.getLogger(LDMenuSchema.class);
	...
	*/
	...
	{
		if(aNodeCode!=null && aNodeCode.length()>5)
			throw new IllegalArgumentException("NodecodeNodeCode值"+aNodeCode+"的长度"+aNodeCode.length()+"大于最大值5");
		NodeCode = aNodeCode;
	}
	...
	{
		if(aParentNodeCode!=null && aParentNodeCode.length()>5)
			throw new IllegalArgumentException("ParentnodecodeParentNodeCode值"+aParentNodeCode+"的长度"+aParentNodeCode.length()+"大于最大值5");
	...
	{
		if(aNodeLevel!=null && aNodeLevel.length()>1)
			throw new IllegalArgumentException("NodelevelNodeLevel值"+aNodeLevel+"的长度"+aNodeLevel.length()+"大于最大值1");
	...
	{
		if(aNodeName!=null && aNodeName.length()>45)
			throw new IllegalArgumentException("NodenameNodeName值"+aNodeName+"的长度"+aNodeName.length()+"大于最大值45");
		NodeName = aNodeName;
	}
	...
	{
		if(aChildFlag!=null && aChildFlag.length()>10)
			throw new IllegalArgumentException("ChildflagChildFlag值"+aChildFlag+"的长度"+aChildFlag.length()+"大于最大值10");
	...
	{
		if(aNodeKey!=null && aNodeKey.length()>10)
			throw new IllegalArgumentException("NodekeyNodeKey值"+aNodeKey+"的长度"+aNodeKey.length()+"大于最大值10");
		NodeKey = aNodeKey;
	}
	...
	{
		if(aRunScript!=null && aRunScript.length()>150)
			throw new IllegalArgumentException("RunscriptRunScript值"+aRunScript+"的长度"+aRunScript.length()+"大于最大值150");
	...
	{
		if(aNodeDescription!=null && aNodeDescription.length()>100)
			throw new IllegalArgumentException("NodedescriptionNodeDescription值"+aNodeDescription+"的长度"+aNodeDescription.length()+"大于最大值100");
	...
	{
		if(aNodeSign!=null && aNodeSign.length()>5)
			throw new IllegalArgumentException("NodesignNodeSign值"+aNodeSign+"的长度"+aNodeSign.length()+"大于最大值5");
		NodeSign = aNodeSign;
	}
	...
	public void setNodeOrder(double aNodeOrder)
	{
	...
	public void setNodeOrder(String aNodeOrder)
	{
		...
		{
			Double tDouble = new Double(aNodeOrder);
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			this.NodeOrder = rs.getDouble("NodeOrder");
		}
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			NodeOrder = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,10,SysConst.PACKAGESPILTER))).doubleValue();
		}
