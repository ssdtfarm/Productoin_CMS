...
import com.sinosoft.lis.db.LRIndexVsCommDB;

/*
 * <p>ClassName: LRIndexVsCommSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LRIndexVsCommSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LRIndexVsCommSchema.class);
	// @Field
	/** Basecode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LRIndexVsCommSchema cloned = (LRIndexVsCommSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LRIndexVsCommSchema 对象给 Schema 赋值
	* @param: aLRIndexVsCommSchema LRIndexVsCommSchema
	**/
	public void setSchema(LRIndexVsCommSchema aLRIndexVsCommSchema)
	{
		this.BaseCode = aLRIndexVsCommSchema.getBaseCode();
		this.ManageCom = aLRIndexVsCommSchema.getManageCom();
		this.AgentGrade = aLRIndexVsCommSchema.getAgentGrade();
		this.IndexType = aLRIndexVsCommSchema.getIndexType();
		this.IndexSerise = aLRIndexVsCommSchema.getIndexSerise();
		this.WageCode = aLRIndexVsCommSchema.getWageCode();
		this.WageName = aLRIndexVsCommSchema.getWageName();
		this.IndexCode = aLRIndexVsCommSchema.getIndexCode();
		this.Description = aLRIndexVsCommSchema.getDescription();
		this.WageOrder = aLRIndexVsCommSchema.getWageOrder();
		this.BranchType = aLRIndexVsCommSchema.getBranchType();
		this.BranchType2 = aLRIndexVsCommSchema.getBranchType2();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LRIndexVsComm表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LRIndexVsCommSchema";
	...
	public LRIndexVsCommSchema getSchema()
	{
		LRIndexVsCommSchema aLRIndexVsCommSchema = new LRIndexVsCommSchema();
		aLRIndexVsCommSchema.setSchema(this);
		return aLRIndexVsCommSchema;
	}

	public LRIndexVsCommDB getDB()
	{
		LRIndexVsCommDB aDBOper = new LRIndexVsCommDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLRIndexVsComm描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLRIndexVsComm>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LRIndexVsCommSchema other = (LRIndexVsCommSchema)otherObject;
		return
