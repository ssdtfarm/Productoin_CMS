...
private static Logger logger = Logger.getLogger(LACommisionSchema.class);
	...
	**/
	public void setSchema(LACommisionSchema aLACommisionSchema)
	{
		...
		this.CompanyCode = aLACommisionSchema.getCompanyCode();
		this.MainPolNo = aLACommisionSchema.getMainPolNo();
		this.ProductCode = aLACommisionSchema.getProductCode();
		this.RiskCode = aLACommisionSchema.getRiskCode();
		this.CvaliDate = fDate.getDate( aLACommisionSchema.getCvaliDate());
		this.Currency = aLACommisionSchema.getCurrency();
		this.TransMoney = aLACommisionSchema.getTransMoney();
		this.Commision = aLACommisionSchema.getCommision();
		this.CommissionType = aLACommisionSchema.getCommissionType();
		this.Portion = aLACommisionSchema.getPortion();
		this.InstalmentNo = aLACommisionSchema.getInstalmentNo();
		this.PayIntv = aLACommisionSchema.getPayIntv();
		this.RiskMark = aLACommisionSchema.getRiskMark();
		this.TrxCode = aLACommisionSchema.getTrxCode();
		this.CalculationDate = fDate.getDate( aLACommisionSchema.getCalculationDate());
		this.BusinessDate = fDate.getDate( aLACommisionSchema.getBusinessDate());
		this.BatchNo = aLACommisionSchema.getBatchNo();
		this.BatchDate = fDate.getDate( aLACommisionSchema.getBatchDate());
		this.ASAReceivedDate = fDate.getDate( aLACommisionSchema.getASAReceivedDate());
		this.CommisionType = aLACommisionSchema.getCommisionType();
		this.TopUpSign = aLACommisionSchema.getTopUpSign();
		this.CalDate = fDate.getDate( aLACommisionSchema.getCalDate());
		this.SplitRate1 = aLACommisionSchema.getSplitRate1();
		this.Agentcode1 = aLACommisionSchema.getAgentcode1();
		this.UMCode1 = aLACommisionSchema.getUMCode1();
		this.UnitCode1 = aLACommisionSchema.getUnitCode1();
		this.DMCode1 = aLACommisionSchema.getDMCode1();
		this.DivisionCode1 = aLACommisionSchema.getDivisionCode1();
		this.RMCode1 = aLACommisionSchema.getRMCode1();
		this.RegionCode1 = aLACommisionSchema.getRegionCode1();
		this.DRCode1 = aLACommisionSchema.getDRCode1();
		this.IDRCode1 = aLACommisionSchema.getIDRCode1();
		this.RCCode1 = aLACommisionSchema.getRCCode1();
		this.RFCode1 = aLACommisionSchema.getRFCode1();
		this.AssessMonth1 = aLACommisionSchema.getAssessMonth1();
		this.WageMonth1 = aLACommisionSchema.getWageMonth1();
		this.SplitRate2 = aLACommisionSchema.getSplitRate2();
		this.Agentcode2 = aLACommisionSchema.getAgentcode2();
		this.UMCode2 = aLACommisionSchema.getUMCode2();
		this.UnitCode2 = aLACommisionSchema.getUnitCode2();
		this.DMCode2 = aLACommisionSchema.getDMCode2();
		this.DivisionCode2 = aLACommisionSchema.getDivisionCode2();
		this.RMCode2 = aLACommisionSchema.getRMCode2();
		this.RegionCode2 = aLACommisionSchema.getRegionCode2();
		this.DRCode2 = aLACommisionSchema.getDRCode2();
		this.IDRCode2 = aLACommisionSchema.getIDRCode2();
		this.RCCode2 = aLACommisionSchema.getRCCode2();
		this.RFCode2 = aLACommisionSchema.getRFCode2();
		this.AssessMonth2 = aLACommisionSchema.getAssessMonth2();
		this.WageMonth2 = aLACommisionSchema.getWageMonth2();
