...
import com.sinosoft.lis.db.LACourseDescBDB;

/*
 * <p>ClassName: LACourseDescBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LACourseDescBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LACourseDescBSchema.class);
	// @Field
	/** Courseid */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LACourseDescBSchema cloned = (LACourseDescBSchema)super.clone();
	...
	/**
	* 使用另外一个 LACourseDescBSchema 对象给 Schema 赋值
	* @param: aLACourseDescBSchema LACourseDescBSchema
	**/
	public void setSchema(LACourseDescBSchema aLACourseDescBSchema)
	{
		this.CourseID = aLACourseDescBSchema.getCourseID();
		this.Channelcode = aLACourseDescBSchema.getChannelcode();
		this.CourseType = aLACourseDescBSchema.getCourseType();
		this.CourseSeries = aLACourseDescBSchema.getCourseSeries();
		this.CourseGrade = aLACourseDescBSchema.getCourseGrade();
		this.CourseNo = aLACourseDescBSchema.getCourseNo();
		this.CourseProfit = aLACourseDescBSchema.getCourseProfit();
		this.CourseName = aLACourseDescBSchema.getCourseName();
		this.CourseHour = aLACourseDescBSchema.getCourseHour();
		this.TeacherGrade = aLACourseDescBSchema.getTeacherGrade();
		this.StopFlag = aLACourseDescBSchema.getStopFlag();
		this.Remarks = aLACourseDescBSchema.getRemarks();
		this.MakeDate = fDate.getDate( aLACourseDescBSchema.getMakeDate());
		this.MakeTime = aLACourseDescBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLACourseDescBSchema.getModifyDate());
		this.ModifyTime = aLACourseDescBSchema.getModifyTime();
		this.Operator = aLACourseDescBSchema.getOperator();
		this.MakeDate1 = fDate.getDate( aLACourseDescBSchema.getMakeDate1());
		this.MakeTime1 = aLACourseDescBSchema.getMakeTime1();
		this.Operator1 = aLACourseDescBSchema.getOperator1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LACourseDescB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LACourseDescBSchema";
	...
	public LACourseDescBSchema getSchema()
	{
		LACourseDescBSchema aLACourseDescBSchema = new LACourseDescBSchema();
		aLACourseDescBSchema.setSchema(this);
		return aLACourseDescBSchema;
	}

	public LACourseDescBDB getDB()
	{
		LACourseDescBDB aDBOper = new LACourseDescBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLACourseDescB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLACourseDescB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Operator1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LACourseDescBSchema other = (LACourseDescBSchema)otherObject;
		return
