...
import com.sinosoft.lis.db.LAAgentFPUnApprovalDB;

/*
 * <p>ClassName: LAAgentFPUnApprovalSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: LAAgentFP_Setting
 */
public class LAAgentFPUnApprovalSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAAgentFPUnApprovalSchema.class);
	// @Field
	/** Agentcode */
	...
	// @Constructor
	public LAAgentFPUnApprovalSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAAgentFPUnApprovalSchema cloned = (LAAgentFPUnApprovalSchema)super.clone();
	...
	/**
	* 使用另外一个 LAAgentFPUnApprovalSchema 对象给 Schema 赋值
	* @param: aLAAgentFPUnApprovalSchema LAAgentFPUnApprovalSchema
	**/
	public void setSchema(LAAgentFPUnApprovalSchema aLAAgentFPUnApprovalSchema)
	{
		this.AgentCode = aLAAgentFPUnApprovalSchema.getAgentCode();
		this.PlanType = aLAAgentFPUnApprovalSchema.getPlanType();
		this.FinancePackage = aLAAgentFPUnApprovalSchema.getFinancePackage();
		this.FinanceStartMonth = aLAAgentFPUnApprovalSchema.getFinanceStartMonth();
		this.MonthlyInstallment = aLAAgentFPUnApprovalSchema.getMonthlyInstallment();
		this.FinanceEndMonth = aLAAgentFPUnApprovalSchema.getFinanceEndMonth();
		this.FPAI = aLAAgentFPUnApprovalSchema.getFPAI();
		this.CBPaidMonth = aLAAgentFPUnApprovalSchema.getCBPaidMonth();
		this.CBInstallmentMonth = aLAAgentFPUnApprovalSchema.getCBInstallmentMonth();
		this.ChallengeBonusAmount = aLAAgentFPUnApprovalSchema.getChallengeBonusAmount();
		this.AchieveRewardRate = aLAAgentFPUnApprovalSchema.getAchieveRewardRate();
		this.AchieveRewardAmount = aLAAgentFPUnApprovalSchema.getAchieveRewardAmount();
		this.MegaFixedBonusReq = aLAAgentFPUnApprovalSchema.getMegaFixedBonusReq();
		this.MegaFixedBonus = aLAAgentFPUnApprovalSchema.getMegaFixedBonus();
		this.MegaExtraBonusReq = aLAAgentFPUnApprovalSchema.getMegaExtraBonusReq();
		this.MegaExtraBonusRate = aLAAgentFPUnApprovalSchema.getMegaExtraBonusRate();
		this.MegaAwardReq = aLAAgentFPUnApprovalSchema.getMegaAwardReq();
		this.MegaAward = aLAAgentFPUnApprovalSchema.getMegaAward();
		this.ApprovalDate = fDate.getDate( aLAAgentFPUnApprovalSchema.getApprovalDate());
		this.ApprovalTime = aLAAgentFPUnApprovalSchema.getApprovalTime();
		this.ApprovalOperator = aLAAgentFPUnApprovalSchema.getApprovalOperator();
		this.ApprovalReason = aLAAgentFPUnApprovalSchema.getApprovalReason();
		this.ApprovalFlag = aLAAgentFPUnApprovalSchema.getApprovalFlag();
		this.Operator = aLAAgentFPUnApprovalSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAAgentFPUnApprovalSchema.getMakeDate());
		this.MakeTime = aLAAgentFPUnApprovalSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAAgentFPUnApprovalSchema.getModifyDate());
		this.ModifyTime = aLAAgentFPUnApprovalSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAAgentFPUnApproval表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAAgentFPUnApprovalSchema";
	...
	public LAAgentFPUnApprovalSchema getSchema()
	{
		LAAgentFPUnApprovalSchema aLAAgentFPUnApprovalSchema = new LAAgentFPUnApprovalSchema();
		aLAAgentFPUnApprovalSchema.setSchema(this);
		return aLAAgentFPUnApprovalSchema;
	}

	public LAAgentFPUnApprovalDB getDB()
	{
		LAAgentFPUnApprovalDB aDBOper = new LAAgentFPUnApprovalDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAgentFPUnApproval描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAgentFPUnApproval>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAAgentFPUnApprovalSchema other = (LAAgentFPUnApprovalSchema)otherObject;
		return
