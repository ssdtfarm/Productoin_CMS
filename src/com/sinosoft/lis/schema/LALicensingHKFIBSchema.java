...
import com.sinosoft.lis.db.LALicensingHKFIBDB;

/*
 * <p>ClassName: LALicensingHKFIBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LALicensingHKFIBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LALicensingHKFIBSchema.class);
	// @Field
	/** Agentcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LALicensingHKFIBSchema cloned = (LALicensingHKFIBSchema)super.clone();
	...
	/**
	* 使用另外一个 LALicensingHKFIBSchema 对象给 Schema 赋值
	* @param: aLALicensingHKFIBSchema LALicensingHKFIBSchema
	**/
	public void setSchema(LALicensingHKFIBSchema aLALicensingHKFIBSchema)
	{
		this.AgentCode = aLALicensingHKFIBSchema.getAgentCode();
		this.HKFIRegNo = aLALicensingHKFIBSchema.getHKFIRegNo();
		this.HKFILineofBusiness = aLALicensingHKFIBSchema.getHKFILineofBusiness();
		this.HKHIRegDate = fDate.getDate( aLALicensingHKFIBSchema.getHKHIRegDate());
		this.HKFIRegStatus = aLALicensingHKFIBSchema.getHKFIRegStatus();
		this.HKFILLTRegDate = fDate.getDate( aLALicensingHKFIBSchema.getHKFILLTRegDate());
		this.HKFILLTRegDeregDate = fDate.getDate( aLALicensingHKFIBSchema.getHKFILLTRegDeregDate());
		this.HKFIGIRegDate = fDate.getDate( aLALicensingHKFIBSchema.getHKFIGIRegDate());
		this.HKFIGIRegDeregDate = fDate.getDate( aLALicensingHKFIBSchema.getHKFIGIRegDeregDate());
		this.HKFIRegExpDate = fDate.getDate( aLALicensingHKFIBSchema.getHKFIRegExpDate());
		this.HKFIDeregDate = fDate.getDate( aLALicensingHKFIBSchema.getHKFIDeregDate());
		this.Remarks = aLALicensingHKFIBSchema.getRemarks();
		this.Flag1 = aLALicensingHKFIBSchema.getFlag1();
		this.Flag2 = aLALicensingHKFIBSchema.getFlag2();
		this.Flag3 = aLALicensingHKFIBSchema.getFlag3();
		this.HKFIBak1 = aLALicensingHKFIBSchema.getHKFIBak1();
		this.HKFIBak2 = aLALicensingHKFIBSchema.getHKFIBak2();
		this.HKFIBak3 = aLALicensingHKFIBSchema.getHKFIBak3();
		this.Operator = aLALicensingHKFIBSchema.getOperator();
		this.MakeDate = fDate.getDate( aLALicensingHKFIBSchema.getMakeDate());
		this.MakeTime = aLALicensingHKFIBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLALicensingHKFIBSchema.getModifyDate());
		this.ModifyTime = aLALicensingHKFIBSchema.getModifyTime();
		this.Operator1 = aLALicensingHKFIBSchema.getOperator1();
		this.MakeDate1 = fDate.getDate( aLALicensingHKFIBSchema.getMakeDate1());
		this.MakeTime1 = aLALicensingHKFIBSchema.getMakeTime1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LALicensingHKFIB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LALicensingHKFIBSchema";
	...
	public LALicensingHKFIBSchema getSchema()
	{
		LALicensingHKFIBSchema aLALicensingHKFIBSchema = new LALicensingHKFIBSchema();
		aLALicensingHKFIBSchema.setSchema(this);
		return aLALicensingHKFIBSchema;
	}

	public LALicensingHKFIBDB getDB()
	{
		LALicensingHKFIBDB aDBOper = new LALicensingHKFIBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLALicensingHKFIB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Operator1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			MakeDate1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25,SysConst.PACKAGESPILTER));
			MakeTime1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LALicensingHKFIBSchema other = (LALicensingHKFIBSchema)otherObject;
		return
