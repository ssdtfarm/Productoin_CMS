...
import com.sinosoft.lis.db.LecturertDB;

/*
 * <p>ClassName: LecturertSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LecturertSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LecturertSchema.class);
	// @Field
	/** Lecturertcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LecturertSchema cloned = (LecturertSchema)super.clone();
	...
	/**
	* 使用另外一个 LecturertSchema 对象给 Schema 赋值
	* @param: aLecturertSchema LecturertSchema
	**/
	public void setSchema(LecturertSchema aLecturertSchema)
	{
		this.LecturertCode = aLecturertSchema.getLecturertCode();
		this.LecturertName = aLecturertSchema.getLecturertName();
		this.Sex = aLecturertSchema.getSex();
		this.BirthDay = fDate.getDate( aLecturertSchema.getBirthDay());
		this.IDNo = aLecturertSchema.getIDNo();
		this.Degree = aLecturertSchema.getDegree();
		this.AgentGrade = aLecturertSchema.getAgentGrade();
		this.Phone = aLecturertSchema.getPhone();
		this.Email = aLecturertSchema.getEmail();
		this.Employdate = fDate.getDate( aLecturertSchema.getEmploydate());
		this.ManageCom = aLecturertSchema.getManageCom();
		this.Lecturerttype = aLecturertSchema.getLecturerttype();
		this.ServingTime = aLecturertSchema.getServingTime();
		this.LecturertLevel = aLecturertSchema.getLecturertLevel();
		this.Remarks = aLecturertSchema.getRemarks();
		this.Flag1 = aLecturertSchema.getFlag1();
		this.Flag2 = aLecturertSchema.getFlag2();
		this.Flag3 = aLecturertSchema.getFlag3();
		this.MakeDate = fDate.getDate( aLecturertSchema.getMakeDate());
		this.MakeTime = aLecturertSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLecturertSchema.getModifyDate());
		this.ModifyTime = aLecturertSchema.getModifyTime();
		this.Operator = aLecturertSchema.getOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的Lecturert表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LecturertSchema";
	...
	public LecturertSchema getSchema()
	{
		LecturertSchema aLecturertSchema = new LecturertSchema();
		aLecturertSchema.setSchema(this);
		return aLecturertSchema;
	}

	public LecturertDB getDB()
	{
		LecturertDB aDBOper = new LecturertDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLecturert>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LecturertSchema other = (LecturertSchema)otherObject;
		return
