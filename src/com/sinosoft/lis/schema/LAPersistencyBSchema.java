...
import com.sinosoft.lis.db.LAPersistencyBDB;

/*
 * <p>ClassName: LAPersistencyBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAPersistencyBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAPersistencyBSchema.class);
	// @Field
	/** Persistencysn */
	private String PersistencySN;
	/** Companycode */
	...
	/** Lapseanp */
	private double LapseANP;
	/** Exposureanp */
	private double ExposureANP;
	/** Calculationdate */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAPersistencyBSchema cloned = (LAPersistencyBSchema)super.clone();
	...
	* PersistencySN
	*/
	public String getPersistencySN()
	{
		return PersistencySN;
	}
	public void setPersistencySN(String aPersistencySN)
	{
		if(aPersistencySN!=null && aPersistencySN.length()>20)
			throw new IllegalArgumentException("PersistencysnPersistencySN值"+aPersistencySN+"的长度"+aPersistencySN.length()+"大于最大值20");
		PersistencySN = aPersistencySN;
	}
	/**
	...
	*/
	...
	/**
	* 失效扣除ANP【同构表Lapse__ANP_At_Issue】
	*/
	public double getLapseANP()
	{
		return LapseANP;
	}
	public void setLapseANP(double aLapseANP)
	{
		LapseANP = aLapseANP;
	}
	public void setLapseANP(String aLapseANP)
	{
		if (aLapseANP != null && !aLapseANP.equals(""))
		{
			Double tDouble = new Double(aLapseANP);
	...
	/**
	* ？？【同构表Exposure__ANP_At_Issue】
	*/
	public double getExposureANP()
	{
		return ExposureANP;
	}
	public void setExposureANP(double aExposureANP)
	{
		ExposureANP = aExposureANP;
	}
	public void setExposureANP(String aExposureANP)
	{
		if (aExposureANP != null && !aExposureANP.equals(""))
		{
			Double tDouble = new Double(aExposureANP);
			double d = tDouble.doubleValue();
			ExposureANP = d;
		}
	}
	...
	*/
	...
	/**
	* 使用另外一个 LAPersistencyBSchema 对象给 Schema 赋值
	* @param: aLAPersistencyBSchema LAPersistencyBSchema
	**/
	public void setSchema(LAPersistencyBSchema aLAPersistencyBSchema)
	{
		this.PersistencySN = aLAPersistencyBSchema.getPersistencySN();
		this.CompanyCode = aLAPersistencyBSchema.getCompanyCode();
		this.MainPolNo = aLAPersistencyBSchema.getMainPolNo();
		this.ProductCode = aLAPersistencyBSchema.getProductCode();
		this.RiskCode = aLAPersistencyBSchema.getRiskCode();
		this.CvaliDate = fDate.getDate( aLAPersistencyBSchema.getCvaliDate());
		this.LapseANP = aLAPersistencyBSchema.getLapseANP();
		this.ExposureANP = aLAPersistencyBSchema.getExposureANP();
		this.CalculationDate = fDate.getDate( aLAPersistencyBSchema.getCalculationDate());
		this.BusinessDate = fDate.getDate( aLAPersistencyBSchema.getBusinessDate());
		this.BatchNo = aLAPersistencyBSchema.getBatchNo();
		this.BatchDate = fDate.getDate( aLAPersistencyBSchema.getBatchDate());
		this.CalDate = fDate.getDate( aLAPersistencyBSchema.getCalDate());
		this.SplitRate1 = aLAPersistencyBSchema.getSplitRate1();
		this.Agentcode1 = aLAPersistencyBSchema.getAgentcode1();
		this.UMCode1 = aLAPersistencyBSchema.getUMCode1();
		this.UnitCode1 = aLAPersistencyBSchema.getUnitCode1();
		this.DMCode1 = aLAPersistencyBSchema.getDMCode1();
		this.DivisionCode1 = aLAPersistencyBSchema.getDivisionCode1();
		this.RMCode1 = aLAPersistencyBSchema.getRMCode1();
		this.RegionCode1 = aLAPersistencyBSchema.getRegionCode1();
		this.DRCode1 = aLAPersistencyBSchema.getDRCode1();
		this.IDRCode1 = aLAPersistencyBSchema.getIDRCode1();
		this.RCCode1 = aLAPersistencyBSchema.getRCCode1();
		this.RFCode1 = aLAPersistencyBSchema.getRFCode1();
		this.AssessMonth1 = aLAPersistencyBSchema.getAssessMonth1();
		this.WageMonth1 = aLAPersistencyBSchema.getWageMonth1();
		this.SplitRate2 = aLAPersistencyBSchema.getSplitRate2();
		this.Agentcode2 = aLAPersistencyBSchema.getAgentcode2();
		this.UMCode2 = aLAPersistencyBSchema.getUMCode2();
		this.UnitCode2 = aLAPersistencyBSchema.getUnitCode2();
		this.DMCode2 = aLAPersistencyBSchema.getDMCode2();
		this.DivisionCode2 = aLAPersistencyBSchema.getDivisionCode2();
		this.RMCode2 = aLAPersistencyBSchema.getRMCode2();
		this.RegionCode2 = aLAPersistencyBSchema.getRegionCode2();
		this.DRCode2 = aLAPersistencyBSchema.getDRCode2();
		this.IDRCode2 = aLAPersistencyBSchema.getIDRCode2();
		this.RCCode2 = aLAPersistencyBSchema.getRCCode2();
		this.RFCode2 = aLAPersistencyBSchema.getRFCode2();
		this.AssessMonth2 = aLAPersistencyBSchema.getAssessMonth2();
		this.WageMonth2 = aLAPersistencyBSchema.getWageMonth2();
		this.Operator = aLAPersistencyBSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAPersistencyBSchema.getMakeDate());
		this.MakeTime = aLAPersistencyBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAPersistencyBSchema.getModifyDate());
		this.ModifyTime = aLAPersistencyBSchema.getModifyTime();
		this.Operator1 = aLAPersistencyBSchema.getOperator1();
		this.MakeDate1 = fDate.getDate( aLAPersistencyBSchema.getMakeDate1());
		this.MakeTime1 = aLAPersistencyBSchema.getMakeTime1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			//rs.absolute(i);		// 非滚动游标
			if( rs.getString("PersistencySN") == null )
				this.PersistencySN = null;
			else
				this.PersistencySN = rs.getString("PersistencySN").trim();
			...
			this.LapseANP = rs.getDouble("LapseANP");
			this.ExposureANP = rs.getDouble("ExposureANP");
		...
		{
			logger.debug("数据库中的LAPersistencyB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAPersistencyBSchema";
	...
	public LAPersistencyBSchema getSchema()
	{
		LAPersistencyBSchema aLAPersistencyBSchema = new LAPersistencyBSchema();
		aLAPersistencyBSchema.setSchema(this);
		return aLAPersistencyBSchema;
	}

	public LAPersistencyBDB getDB()
	{
		LAPersistencyBDB aDBOper = new LAPersistencyBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAPersistencyB描述/A>表字段
	* @return: String 返回打包后字符串
	**/
	public String encode()
	{
		StringBuffer strReturn = new StringBuffer(256);
		strReturn.append(StrTool.cTrim(PersistencySN)); strReturn.append(SysConst.PACKAGESPILTER);
		...
		strReturn.append( ChgData.chgData(LapseANP));strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append( ChgData.chgData(ExposureANP));strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAPersistencyB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			PersistencySN = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 1, SysConst.PACKAGESPILTER );
			...
			LapseANP = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,7,SysConst.PACKAGESPILTER))).doubleValue();
			ExposureANP = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).doubleValue();
			CalculationDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9,SysConst.PACKAGESPILTER));
			BusinessDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10,SysConst.PACKAGESPILTER));
			BatchNo = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,11,SysConst.PACKAGESPILTER))).doubleValue();
			BatchDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12,SysConst.PACKAGESPILTER));
			CalDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13,SysConst.PACKAGESPILTER));
			SplitRate1 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,14,SysConst.PACKAGESPILTER))).doubleValue();
			Agentcode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			UMCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			UnitCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			DMCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			DivisionCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			RMCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			RegionCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			DRCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			IDRCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			RCCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			RFCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			AssessMonth1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			WageMonth1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			SplitRate2 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,28,SysConst.PACKAGESPILTER))).doubleValue();
			Agentcode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			UMCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			UnitCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			DMCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			DivisionCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			RMCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			RegionCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			DRCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			IDRCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			RCCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			RFCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			AssessMonth2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			WageMonth2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			...
			Operator1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			MakeDate1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48,SysConst.PACKAGESPILTER));
			MakeTime1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	{
		String strReturn = "";
		if (FCode.equalsIgnoreCase("PersistencySN"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(PersistencySN));
		}
		...
		if (FCode.equalsIgnoreCase("LapseANP"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(LapseANP));
		}
		if (FCode.equalsIgnoreCase("ExposureANP"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(ExposureANP));
		}
	...
	**/
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			case 0:
				strFieldValue = StrTool.GBKToUnicode(PersistencySN);
				break;
			case 1:
			...
			case 5:
				...
				break;
			case 6:
				strFieldValue = String.valueOf(LapseANP);
				break;
			case 7:
				strFieldValue = String.valueOf(ExposureANP);
				break;
			case 8:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAPersistencyBSchema other = (LAPersistencyBSchema)otherObject;
		return
			PersistencySN.equals(other.getPersistencySN())
			...
			&& LapseANP == other.getLapseANP()
			&& ExposureANP == other.getExposureANP()
	...
	**/
	...
	{
		if( strFieldName.equals("PersistencySN") ) {
			return 0;
		}
		...
		if( strFieldName.equals("LapseANP") ) {
			return 6;
		}
		if( strFieldName.equals("ExposureANP") ) {
			return 7;
		}
	...
	public String getFieldName(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 5:
				...
				break;
			case 6:
				strFieldName = "LapseANP";
				break;
			case 7:
				strFieldName = "ExposureANP";
				break;
			case 8:
