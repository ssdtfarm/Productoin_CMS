...
import com.sinosoft.lis.db.LAAFYCDB;

/*
 * <p>ClassName: LAAFYCSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAAFYCSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAAFYCSchema.class);
	// @Field
	/** Afycsn */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAAFYCSchema cloned = (LAAFYCSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LAAFYCSchema 对象给 Schema 赋值
	* @param: aLAAFYCSchema LAAFYCSchema
	**/
	public void setSchema(LAAFYCSchema aLAAFYCSchema)
	{
		this.AFYCSN = aLAAFYCSchema.getAFYCSN();
		this.CompanyCode = aLAAFYCSchema.getCompanyCode();
		this.MainPolNo = aLAAFYCSchema.getMainPolNo();
		this.ProductCode = aLAAFYCSchema.getProductCode();
		this.RiskCode = aLAAFYCSchema.getRiskCode();
		this.CvaliDate = fDate.getDate( aLAAFYCSchema.getCvaliDate());
		this.AFYC = aLAAFYCSchema.getAFYC();
		this.AFYP = aLAAFYCSchema.getAFYP();
		this.TrxCode = aLAAFYCSchema.getTrxCode();
		this.CalculationDate = fDate.getDate( aLAAFYCSchema.getCalculationDate());
		this.BusinessDate = fDate.getDate( aLAAFYCSchema.getBusinessDate());
		this.BatchNo = aLAAFYCSchema.getBatchNo();
		this.BatchDate = fDate.getDate( aLAAFYCSchema.getBatchDate());
		this.CalDate = fDate.getDate( aLAAFYCSchema.getCalDate());
		this.SplitRate1 = aLAAFYCSchema.getSplitRate1();
		this.Agentcode1 = aLAAFYCSchema.getAgentcode1();
		this.UMCode1 = aLAAFYCSchema.getUMCode1();
		this.UnitCode1 = aLAAFYCSchema.getUnitCode1();
		this.DMCode1 = aLAAFYCSchema.getDMCode1();
		this.DivisionCode1 = aLAAFYCSchema.getDivisionCode1();
		this.RMCode1 = aLAAFYCSchema.getRMCode1();
		this.RegionCode1 = aLAAFYCSchema.getRegionCode1();
		this.DRCode1 = aLAAFYCSchema.getDRCode1();
		this.IDRCode1 = aLAAFYCSchema.getIDRCode1();
		this.RCCode1 = aLAAFYCSchema.getRCCode1();
		this.RFCode1 = aLAAFYCSchema.getRFCode1();
		this.AssessMonth1 = aLAAFYCSchema.getAssessMonth1();
		this.WageMonth1 = aLAAFYCSchema.getWageMonth1();
		this.SplitRate2 = aLAAFYCSchema.getSplitRate2();
		this.Agentcode2 = aLAAFYCSchema.getAgentcode2();
		this.UMCode2 = aLAAFYCSchema.getUMCode2();
		this.UnitCode2 = aLAAFYCSchema.getUnitCode2();
		this.DMCode2 = aLAAFYCSchema.getDMCode2();
		this.DivisionCode2 = aLAAFYCSchema.getDivisionCode2();
		this.RMCode2 = aLAAFYCSchema.getRMCode2();
		this.RegionCode2 = aLAAFYCSchema.getRegionCode2();
		this.DRCode2 = aLAAFYCSchema.getDRCode2();
		this.IDRCode2 = aLAAFYCSchema.getIDRCode2();
		this.RCCode2 = aLAAFYCSchema.getRCCode2();
		this.RFCode2 = aLAAFYCSchema.getRFCode2();
		this.AssessMonth2 = aLAAFYCSchema.getAssessMonth2();
		this.WageMonth2 = aLAAFYCSchema.getWageMonth2();
		this.Operator = aLAAFYCSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAAFYCSchema.getMakeDate());
		this.MakeTime = aLAAFYCSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAAFYCSchema.getModifyDate());
		this.ModifyTime = aLAAFYCSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAAFYC表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAAFYCSchema";
	...
	public LAAFYCSchema getSchema()
	{
		LAAFYCSchema aLAAFYCSchema = new LAAFYCSchema();
		aLAAFYCSchema.setSchema(this);
		return aLAAFYCSchema;
	}

	public LAAFYCDB getDB()
	{
		LAAFYCDB aDBOper = new LAAFYCDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAFYC描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAFYC>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAAFYCSchema other = (LAAFYCSchema)otherObject;
		return
