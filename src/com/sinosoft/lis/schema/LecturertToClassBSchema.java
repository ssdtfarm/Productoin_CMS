...
import com.sinosoft.lis.db.LecturertToClassBDB;

/*
 * <p>ClassName: LecturertToClassBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LecturertToClassBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LecturertToClassBSchema.class);
	// @Field
	/** Agentcode */
	...
	// @Constructor
	public LecturertToClassBSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LecturertToClassBSchema cloned = (LecturertToClassBSchema)super.clone();
	...
	/**
	* 使用另外一个 LecturertToClassBSchema 对象给 Schema 赋值
	* @param: aLecturertToClassBSchema LecturertToClassBSchema
	**/
	public void setSchema(LecturertToClassBSchema aLecturertToClassBSchema)
	{
		this.AgentCode = aLecturertToClassBSchema.getAgentCode();
		this.ClassNo = aLecturertToClassBSchema.getClassNo();
		this.Remarks = aLecturertToClassBSchema.getRemarks();
		this.MakeDate = fDate.getDate( aLecturertToClassBSchema.getMakeDate());
		this.MakeTime = aLecturertToClassBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLecturertToClassBSchema.getModifyDate());
		this.ModifyTime = aLecturertToClassBSchema.getModifyTime();
		this.Operator = aLecturertToClassBSchema.getOperator();
		this.MakeDate1 = fDate.getDate( aLecturertToClassBSchema.getMakeDate1());
		this.MakeTime1 = aLecturertToClassBSchema.getMakeTime1();
		this.Operator1 = aLecturertToClassBSchema.getOperator1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LecturertToClassB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LecturertToClassBSchema";
	...
	public LecturertToClassBSchema getSchema()
	{
		LecturertToClassBSchema aLecturertToClassBSchema = new LecturertToClassBSchema();
		aLecturertToClassBSchema.setSchema(this);
		return aLecturertToClassBSchema;
	}

	public LecturertToClassBDB getDB()
	{
		LecturertToClassBDB aDBOper = new LecturertToClassBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLecturertToClassB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Remarks = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			...
			MakeDate1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9,SysConst.PACKAGESPILTER));
			MakeTime1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LecturertToClassBSchema other = (LecturertToClassBSchema)otherObject;
		return
