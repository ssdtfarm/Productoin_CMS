...
import com.sinosoft.lis.db.LAAgentCBDB;

/*
 * <p>ClassName: LAAgentCBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: LAAgentCd
 */
public class LAAgentCBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAAgentCBSchema.class);
	// @Field
	/** Bakmonth */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAAgentCBSchema cloned = (LAAgentCBSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LAAgentCBSchema 对象给 Schema 赋值
	* @param: aLAAgentCBSchema LAAgentCBSchema
	**/
	public void setSchema(LAAgentCBSchema aLAAgentCBSchema)
	{
		this.BakMonth = aLAAgentCBSchema.getBakMonth();
		this.BakType = aLAAgentCBSchema.getBakType();
		this.AgentCode = aLAAgentCBSchema.getAgentCode();
		this.BranchType = aLAAgentCBSchema.getBranchType();
		this.AgentGroup = aLAAgentCBSchema.getAgentGroup();
		this.ManageCom = aLAAgentCBSchema.getManageCom();
		this.Password = aLAAgentCBSchema.getPassword();
		this.AgentState = aLAAgentCBSchema.getAgentState();
		this.SurName = aLAAgentCBSchema.getSurName();
		this.GivenName = aLAAgentCBSchema.getGivenName();
		this.EnglishName = aLAAgentCBSchema.getEnglishName();
		this.HKIDName = aLAAgentCBSchema.getHKIDName();
		this.ChineseName = aLAAgentCBSchema.getChineseName();
		this.IDType = aLAAgentCBSchema.getIDType();
		this.IDNo = aLAAgentCBSchema.getIDNo();
		this.WorkingVisa = aLAAgentCBSchema.getWorkingVisa();
		this.WorkingVisaExpiryDate = fDate.getDate( aLAAgentCBSchema.getWorkingVisaExpiryDate());
		this.WorkingVisaType = aLAAgentCBSchema.getWorkingVisaType();
		this.Qualification = aLAAgentCBSchema.getQualification();
		this.ContractType = aLAAgentCBSchema.getContractType();
		this.ContractEffDate = fDate.getDate( aLAAgentCBSchema.getContractEffDate());
		this.ContractStatus = aLAAgentCBSchema.getContractStatus();
		this.RecruitmentProfile = aLAAgentCBSchema.getRecruitmentProfile();
		this.LastTerminationDate = fDate.getDate( aLAAgentCBSchema.getLastTerminationDate());
		this.LastTerminationReason = aLAAgentCBSchema.getLastTerminationReason();
		this.TerminationNo = aLAAgentCBSchema.getTerminationNo();
		this.PaymentMethod = aLAAgentCBSchema.getPaymentMethod();
		this.BankAccountName = aLAAgentCBSchema.getBankAccountName();
		this.BankAccountNo = aLAAgentCBSchema.getBankAccountNo();
		this.WithheldReason = aLAAgentCBSchema.getWithheldReason();
		this.GuarantorAgentCode = aLAAgentCBSchema.getGuarantorAgentCode();
		this.GuarantorAgentRelation = aLAAgentCBSchema.getGuarantorAgentRelation();
		this.GuarantorType = aLAAgentCBSchema.getGuarantorType();
		this.Sex = aLAAgentCBSchema.getSex();
		this.Title = aLAAgentCBSchema.getTitle();
		this.Nationality = aLAAgentCBSchema.getNationality();
		this.Birthday = fDate.getDate( aLAAgentCBSchema.getBirthday());
		this.WorkingExperience = aLAAgentCBSchema.getWorkingExperience();
		this.LastJob = aLAAgentCBSchema.getLastJob();
		this.LastJobServiceYears = aLAAgentCBSchema.getLastJobServiceYears();
		this.InsuranceExperience = aLAAgentCBSchema.getInsuranceExperience();
		this.InsuranceExperienceYears = aLAAgentCBSchema.getInsuranceExperienceYears();
		this.EducationLevel = aLAAgentCBSchema.getEducationLevel();
		this.AddressType = aLAAgentCBSchema.getAddressType();
		this.AddressRoom = aLAAgentCBSchema.getAddressRoom();
		this.AddressFloor = aLAAgentCBSchema.getAddressFloor();
		this.AddressBlock = aLAAgentCBSchema.getAddressBlock();
		this.AddressBuilding = aLAAgentCBSchema.getAddressBuilding();
		this.AddressStreet = aLAAgentCBSchema.getAddressStreet();
		this.AddressDistrict = aLAAgentCBSchema.getAddressDistrict();
		this.FreeAddress = aLAAgentCBSchema.getFreeAddress();
		this.Phone = aLAAgentCBSchema.getPhone();
		this.Mobile = aLAAgentCBSchema.getMobile();
		this.Email = aLAAgentCBSchema.getEmail();
		this.CompanyEmail = aLAAgentCBSchema.getCompanyEmail();
		this.OfficeAddress = aLAAgentCBSchema.getOfficeAddress();
		this.OfficeTel = aLAAgentCBSchema.getOfficeTel();
		this.OfficeFaxNo = aLAAgentCBSchema.getOfficeFaxNo();
		this.Marriage = aLAAgentCBSchema.getMarriage();
		this.SpouseName = aLAAgentCBSchema.getSpouseName();
		this.SpouseIDNo = aLAAgentCBSchema.getSpouseIDNo();
		this.Flag1 = aLAAgentCBSchema.getFlag1();
		this.Flag2 = aLAAgentCBSchema.getFlag2();
		this.Flag3 = aLAAgentCBSchema.getFlag3();
		this.AgentGrade = aLAAgentCBSchema.getAgentGrade();
		this.GradeStartDate = fDate.getDate( aLAAgentCBSchema.getGradeStartDate());
		this.AgentSubGrade = aLAAgentCBSchema.getAgentSubGrade();
		this.SubGradeStartDate = fDate.getDate( aLAAgentCBSchema.getSubGradeStartDate());
		this.EffectiveDate = fDate.getDate( aLAAgentCBSchema.getEffectiveDate());
		this.TransferEffectiveDate = fDate.getDate( aLAAgentCBSchema.getTransferEffectiveDate());
		this.BranchAttr = aLAAgentCBSchema.getBranchAttr();
		this.BranchLevel = aLAAgentCBSchema.getBranchLevel();
		this.BranchName = aLAAgentCBSchema.getBranchName();
		this.BranchNameEng = aLAAgentCBSchema.getBranchNameEng();
		this.BranchNameChi = aLAAgentCBSchema.getBranchNameChi();
		this.BranchEffDate = fDate.getDate( aLAAgentCBSchema.getBranchEffDate());
		this.BranchAddress = aLAAgentCBSchema.getBranchAddress();
		this.BranchPhoneNo = aLAAgentCBSchema.getBranchPhoneNo();
		this.BranchFaxNo = aLAAgentCBSchema.getBranchFaxNo();
		this.BranchLocation = aLAAgentCBSchema.getBranchLocation();
		this.BranchStatus = aLAAgentCBSchema.getBranchStatus();
		this.BranchTerminateEffDate = fDate.getDate( aLAAgentCBSchema.getBranchTerminateEffDate());
		this.BranchTerminateReason = aLAAgentCBSchema.getBranchTerminateReason();
		this.DirectFlag = aLAAgentCBSchema.getDirectFlag();
		this.UpAgentGroup = aLAAgentCBSchema.getUpAgentGroup();
		this.BranchManager = aLAAgentCBSchema.getBranchManager();
		this.UnitManager = aLAAgentCBSchema.getUnitManager();
		this.DivisionManager = aLAAgentCBSchema.getDivisionManager();
		this.RegionManager = aLAAgentCBSchema.getRegionManager();
		this.RecruitingAgentCode = aLAAgentCBSchema.getRecruitingAgentCode();
		this.ReferringAgentCode = aLAAgentCBSchema.getReferringAgentCode();
		this.DirectReportingAgentCode = aLAAgentCBSchema.getDirectReportingAgentCode();
		this.InirectReportingAgentCode = aLAAgentCBSchema.getInirectReportingAgentCode();
		this.Operator = aLAAgentCBSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAAgentCBSchema.getMakeDate());
		this.MakeTime = aLAAgentCBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAAgentCBSchema.getModifyDate());
		this.ModifyTime = aLAAgentCBSchema.getModifyTime();
		this.Operator1 = aLAAgentCBSchema.getOperator1();
		this.MakeDate1 = fDate.getDate( aLAAgentCBSchema.getMakeDate1());
		this.MakeTime1 = aLAAgentCBSchema.getMakeTime1();
		this.LastJobNature = aLAAgentCBSchema.getLastJobNature();
		this.UnitBranchAttr = aLAAgentCBSchema.getUnitBranchAttr();
		this.DivisionBranchAttr = aLAAgentCBSchema.getDivisionBranchAttr();
		this.RegionBranchAttr = aLAAgentCBSchema.getRegionBranchAttr();
		this.OutWorkDate = fDate.getDate( aLAAgentCBSchema.getOutWorkDate());
		this.DummyGradeFlag = aLAAgentCBSchema.getDummyGradeFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAAgentCB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAAgentCBSchema";
	...
	public LAAgentCBSchema getSchema()
	{
		LAAgentCBSchema aLAAgentCBSchema = new LAAgentCBSchema();
		aLAAgentCBSchema.setSchema(this);
		return aLAAgentCBSchema;
	}

	public LAAgentCBDB getDB()
	{
		LAAgentCBDB aDBOper = new LAAgentCBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAgentCB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Operator1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 99, SysConst.PACKAGESPILTER );
			MakeDate1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 100,SysConst.PACKAGESPILTER));
			MakeTime1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 101, SysConst.PACKAGESPILTER );
			LastJobNature = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 102, SysConst.PACKAGESPILTER );
			UnitBranchAttr = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 103, SysConst.PACKAGESPILTER );
			DivisionBranchAttr = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 104, SysConst.PACKAGESPILTER );
			RegionBranchAttr = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 105, SysConst.PACKAGESPILTER );
			OutWorkDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 106,SysConst.PACKAGESPILTER));
			DummyGradeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 107, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAAgentCBSchema other = (LAAgentCBSchema)otherObject;
		return
