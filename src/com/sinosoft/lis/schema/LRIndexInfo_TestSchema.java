...
import com.sinosoft.lis.db.LRIndexInfo_TestDB;

/*
 * <p>ClassName: LRIndexInfo_TestSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LRIndexInfo_TestSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LRIndexInfo_TestSchema.class);
	// @Field
	/** Wageno */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LRIndexInfo_TestSchema cloned = (LRIndexInfo_TestSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LRIndexInfo_TestSchema 对象给 Schema 赋值
	* @param: aLRIndexInfo_TestSchema LRIndexInfo_TestSchema
	**/
	public void setSchema(LRIndexInfo_TestSchema aLRIndexInfo_TestSchema)
	{
		this.WageNo = aLRIndexInfo_TestSchema.getWageNo();
		this.ManageCom = aLRIndexInfo_TestSchema.getManageCom();
		this.AgentCode = aLRIndexInfo_TestSchema.getAgentCode();
		this.AgentGrade = aLRIndexInfo_TestSchema.getAgentGrade();
		this.AgentGroup = aLRIndexInfo_TestSchema.getAgentGroup();
		this.BranchAttr = aLRIndexInfo_TestSchema.getBranchAttr();
		this.BranchSeries = aLRIndexInfo_TestSchema.getBranchSeries();
		this.IndexType = aLRIndexInfo_TestSchema.getIndexType();
		this.BaseCode = aLRIndexInfo_TestSchema.getBaseCode();
		this.WageCode = aLRIndexInfo_TestSchema.getWageCode();
		this.WageName = aLRIndexInfo_TestSchema.getWageName();
		this.IndexCode = aLRIndexInfo_TestSchema.getIndexCode();
		this.MainIndexFlag = aLRIndexInfo_TestSchema.getMainIndexFlag();
		this.DataType = aLRIndexInfo_TestSchema.getDataType();
		this.D = fDate.getDate( aLRIndexInfo_TestSchema.getD());
		this.N0 = aLRIndexInfo_TestSchema.getN0();
		this.N2 = aLRIndexInfo_TestSchema.getN2();
		this.N4 = aLRIndexInfo_TestSchema.getN4();
		this.N6 = aLRIndexInfo_TestSchema.getN6();
		this.S = aLRIndexInfo_TestSchema.getS();
		this.BranchType = aLRIndexInfo_TestSchema.getBranchType();
		this.BranchType2 = aLRIndexInfo_TestSchema.getBranchType2();
		this.State = aLRIndexInfo_TestSchema.getState();
		this.Operator = aLRIndexInfo_TestSchema.getOperator();
		this.MakeDate = fDate.getDate( aLRIndexInfo_TestSchema.getMakeDate());
		this.MakeTime = aLRIndexInfo_TestSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLRIndexInfo_TestSchema.getModifyDate());
		this.ModifyTime = aLRIndexInfo_TestSchema.getModifyTime();
		this.CalType = aLRIndexInfo_TestSchema.getCalType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LRIndexInfo_Test表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LRIndexInfo_TestSchema";
	...
	public LRIndexInfo_TestSchema getSchema()
	{
		LRIndexInfo_TestSchema aLRIndexInfo_TestSchema = new LRIndexInfo_TestSchema();
		aLRIndexInfo_TestSchema.setSchema(this);
		return aLRIndexInfo_TestSchema;
	}

	public LRIndexInfo_TestDB getDB()
	{
		LRIndexInfo_TestDB aDBOper = new LRIndexInfo_TestDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLRIndexInfo_Test>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			BranchSeries = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			IndexType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			BaseCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			WageCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			WageName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			IndexCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			MainIndexFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			DataType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			D = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15,SysConst.PACKAGESPILTER));
			N0= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,16,SysConst.PACKAGESPILTER))).intValue();
			N2 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,17,SysConst.PACKAGESPILTER))).doubleValue();
			N4 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,18,SysConst.PACKAGESPILTER))).doubleValue();
			N6 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,19,SysConst.PACKAGESPILTER))).doubleValue();
			S = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LRIndexInfo_TestSchema other = (LRIndexInfo_TestSchema)otherObject;
		return
