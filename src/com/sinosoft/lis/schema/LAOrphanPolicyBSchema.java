...
private static Logger logger = Logger.getLogger(LAOrphanPolicyBSchema.class);
	...
	**/
	...
	{
		this.MainPolNo = aLAOrphanPolicyBSchema.getMainPolNo();
		this.PrimaryAgentCode = aLAOrphanPolicyBSchema.getPrimaryAgentCode();
		this.PrimaryOutWorkDate = fDate.getDate( aLAOrphanPolicyBSchema.getPrimaryOutWorkDate());
		this.PrimaryDebitAmt = aLAOrphanPolicyBSchema.getPrimaryDebitAmt();
		...
		this.Operator1 = aLAOrphanPolicyBSchema.getOperator1();
		this.MakeDate1 = fDate.getDate( aLAOrphanPolicyBSchema.getMakeDate1());
		this.MakeTime1 = aLAOrphanPolicyBSchema.getMakeTime1();
	}
