...
import com.sinosoft.lis.db.LAAgentGradeBDB;

/*
 * <p>ClassName: LAAgentGradeBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: LAAgentGrade_Setting
 */
public class LAAgentGradeBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAAgentGradeBSchema.class);
	// @Field
	/** Gradecode */
	...
	/** Dummygradeflagl */
	private String DummyGradeFlagl;
	/** Gradelevelorder */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAAgentGradeBSchema cloned = (LAAgentGradeBSchema)super.clone();
	...
	public String getDummyGradeFlagl()
	{
		return DummyGradeFlagl;
	}
	public void setDummyGradeFlagl(String aDummyGradeFlagl)
	{
		if(aDummyGradeFlagl!=null && aDummyGradeFlagl.length()>2)
			throw new IllegalArgumentException("DummygradeflaglDummyGradeFlagl值"+aDummyGradeFlagl+"的长度"+aDummyGradeFlagl.length()+"大于最大值2");
		DummyGradeFlagl = aDummyGradeFlagl;
	}
	...
	/**
	* 使用另外一个 LAAgentGradeBSchema 对象给 Schema 赋值
	* @param: aLAAgentGradeBSchema LAAgentGradeBSchema
	**/
	public void setSchema(LAAgentGradeBSchema aLAAgentGradeBSchema)
	{
		this.GradeCode = aLAAgentGradeBSchema.getGradeCode();
		this.GradeId = aLAAgentGradeBSchema.getGradeId();
		this.GradeName = aLAAgentGradeBSchema.getGradeName();
		this.GradeLevel = aLAAgentGradeBSchema.getGradeLevel();
		this.GradeAbbreviation = aLAAgentGradeBSchema.getGradeAbbreviation();
		this.DummyGradeFlagl = aLAAgentGradeBSchema.getDummyGradeFlagl();
		this.GradeLevelOrder = aLAAgentGradeBSchema.getGradeLevelOrder();
		this.Remarks = aLAAgentGradeBSchema.getRemarks();
		this.BranchType = aLAAgentGradeBSchema.getBranchType();
		this.BranchTypeMapping = aLAAgentGradeBSchema.getBranchTypeMapping();
		this.GradeReport1 = aLAAgentGradeBSchema.getGradeReport1();
		this.GradeReport2 = aLAAgentGradeBSchema.getGradeReport2();
		this.GradeReport3 = aLAAgentGradeBSchema.getGradeReport3();
		this.Flag1 = aLAAgentGradeBSchema.getFlag1();
		this.Flag2 = aLAAgentGradeBSchema.getFlag2();
		this.Flag3 = aLAAgentGradeBSchema.getFlag3();
		this.Operator = aLAAgentGradeBSchema.getOperator();
		this.MakeDate = fDate.getDate( aLAAgentGradeBSchema.getMakeDate());
		this.MakeTime = aLAAgentGradeBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAAgentGradeBSchema.getModifyDate());
		this.ModifyTime = aLAAgentGradeBSchema.getModifyTime();
		this.Operator1 = aLAAgentGradeBSchema.getOperator1();
		this.MakeDate1 = fDate.getDate( aLAAgentGradeBSchema.getMakeDate1());
		this.MakeTime1 = aLAAgentGradeBSchema.getMakeTime1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("DummyGradeFlagl") == null )
				this.DummyGradeFlagl = null;
			else
				this.DummyGradeFlagl = rs.getString("DummyGradeFlagl").trim();
		...
		{
			logger.debug("数据库中的LAAgentGradeB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAAgentGradeBSchema";
	...
	public LAAgentGradeBSchema getSchema()
	{
		LAAgentGradeBSchema aLAAgentGradeBSchema = new LAAgentGradeBSchema();
		aLAAgentGradeBSchema.setSchema(this);
		return aLAAgentGradeBSchema;
	}

	public LAAgentGradeBDB getDB()
	{
		LAAgentGradeBDB aDBOper = new LAAgentGradeBDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(DummyGradeFlagl)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAAgentGradeB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			DummyGradeFlagl = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("DummyGradeFlagl"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(DummyGradeFlagl));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 4:
				...
				break;
			case 5:
				strFieldValue = StrTool.GBKToUnicode(DummyGradeFlagl);
				break;
			case 6:
	...
	**/
	public boolean setV(String FCode ,String FValue)
	{
		...
		if (FCode.equalsIgnoreCase("DummyGradeFlagl"))
		{
			if( FValue != null && !FValue.equals(""))
			{
				DummyGradeFlagl = FValue.trim();
			}
			else
				DummyGradeFlagl = null;
		}
		if (FCode.equalsIgnoreCase("GradeLevelOrder"))
		{
			if( FValue != null && !FValue.equals(""))
	...
	public boolean equals(Object otherObject)
	{
		...
		LAAgentGradeBSchema other = (LAAgentGradeBSchema)otherObject;
		return
			...
			&& DummyGradeFlagl.equals(other.getDummyGradeFlagl())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("DummyGradeFlagl") ) {
			return 5;
		}
