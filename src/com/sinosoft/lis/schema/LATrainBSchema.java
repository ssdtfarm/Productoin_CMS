...
import com.sinosoft.lis.db.LATrainBDB;

/*
 * <p>ClassName: LATrainBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LATrainBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LATrainBSchema.class);
	// @Field
	/** Agentcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LATrainBSchema cloned = (LATrainBSchema)super.clone();
	...
	/**
	* 使用另外一个 LATrainBSchema 对象给 Schema 赋值
	* @param: aLATrainBSchema LATrainBSchema
	**/
	public void setSchema(LATrainBSchema aLATrainBSchema)
	{
		this.AgentCode = aLATrainBSchema.getAgentCode();
		this.BranchType = aLATrainBSchema.getBranchType();
		this.OpenClassID = aLATrainBSchema.getOpenClassID();
		this.Managecom = aLATrainBSchema.getManagecom();
		this.ResultLevel = aLATrainBSchema.getResultLevel();
		this.Result = aLATrainBSchema.getResult();
		this.TrainPassFlag = aLATrainBSchema.getTrainPassFlag();
		this.Remarks = aLATrainBSchema.getRemarks();
		this.MakeDate = fDate.getDate( aLATrainBSchema.getMakeDate());
		this.MakeTime = aLATrainBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLATrainBSchema.getModifyDate());
		this.ModifyTime = aLATrainBSchema.getModifyTime();
		this.Operator = aLATrainBSchema.getOperator();
		this.MakeDate1 = fDate.getDate( aLATrainBSchema.getMakeDate1());
		this.MakeTime1 = aLATrainBSchema.getMakeTime1();
		this.Operator1 = aLATrainBSchema.getOperator1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LATrainB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LATrainBSchema";
	...
	public LATrainBSchema getSchema()
	{
		LATrainBSchema aLATrainBSchema = new LATrainBSchema();
		aLATrainBSchema.setSchema(this);
		return aLATrainBSchema;
	}

	public LATrainBDB getDB()
	{
		LATrainBDB aDBOper = new LATrainBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLATrainB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLATrainB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LATrainBSchema other = (LATrainBSchema)otherObject;
		return
