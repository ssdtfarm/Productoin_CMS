...
public class LMCalModeSchema implements Schema
{
    ...
    {
        if (RiskCode != null && !RiskCode.equals("") && SysConst.CHANGECHARSET)
        {
    ...
    {
        if (Type != null && !Type.equals("") && SysConst.CHANGECHARSET)
        {
    ...
    {
        if (CalSQL != null && !CalSQL.equals("") && SysConst.CHANGECHARSET)
        {
    ...
    {
        if (Remark != null && !Remark.equals("") && SysConst.CHANGECHARSET)
        {
