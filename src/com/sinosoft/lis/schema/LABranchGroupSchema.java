...
private static Logger logger = Logger.getLogger(LABranchGroupSchema.class);
	...
	**/
	public void setSchema(LABranchGroupSchema aLABranchGroupSchema)
	{
		...
		this.BranchName = aLABranchGroupSchema.getBranchName();
		this.BranchNameEng = aLABranchGroupSchema.getBranchNameEng();
		this.BranchNameChi = aLABranchGroupSchema.getBranchNameChi();
		this.BranchEffDate = fDate.getDate( aLABranchGroupSchema.getBranchEffDate());
		this.BranchAddress = aLABranchGroupSchema.getBranchAddress();
		this.BranchPhoneNo = aLABranchGroupSchema.getBranchPhoneNo();
		this.BranchFaxNo = aLABranchGroupSchema.getBranchFaxNo();
		this.BranchLocation = aLABranchGroupSchema.getBranchLocation();
		this.BranchStatus = aLABranchGroupSchema.getBranchStatus();
		this.BranchTerminateEffDate = fDate.getDate( aLABranchGroupSchema.getBranchTerminateEffDate());
		this.BranchTerminateReason = aLABranchGroupSchema.getBranchTerminateReason();
		this.DirectFlag = aLABranchGroupSchema.getDirectFlag();
		this.UpAgentGroup = aLABranchGroupSchema.getUpAgentGroup();
		this.BranchManager = aLABranchGroupSchema.getBranchManager();
		this.ReportingManager = aLABranchGroupSchema.getReportingManager();
