...
import com.sinosoft.lis.db.LCDorRateDB;

/*
 * <p>ClassName: LCDorRateSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LCDorRateSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCDorRateSchema.class);
	// @Field
	/** Productcode */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCDorRateSchema cloned = (LCDorRateSchema)super.clone();
	...
	/**
	* 使用另外一个 LCDorRateSchema 对象给 Schema 赋值
	* @param: aLCDorRateSchema LCDorRateSchema
	**/
	public void setSchema(LCDorRateSchema aLCDorRateSchema)
	{
		this.ProductCode = aLCDorRateSchema.getProductCode();
		this.DorRate = aLCDorRateSchema.getDorRate();
		this.EffectiveYM = aLCDorRateSchema.getEffectiveYM();
		this.EffectiveEndYM = aLCDorRateSchema.getEffectiveEndYM();
		this.DeleteFlag = aLCDorRateSchema.getDeleteFlag();
		this.OperationDate = fDate.getDate( aLCDorRateSchema.getOperationDate());
		this.OPERATOR = aLCDorRateSchema.getOPERATOR();
		this.MAKEDATE = fDate.getDate( aLCDorRateSchema.getMAKEDATE());
		this.MAKETIME = aLCDorRateSchema.getMAKETIME();
		this.MODIFYDATE = fDate.getDate( aLCDorRateSchema.getMODIFYDATE());
		this.MODIFYTIME = aLCDorRateSchema.getMODIFYTIME();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCDorRate表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCDorRateSchema";
	...
	public LCDorRateSchema getSchema()
	{
		LCDorRateSchema aLCDorRateSchema = new LCDorRateSchema();
		aLCDorRateSchema.setSchema(this);
		return aLCDorRateSchema;
	}

	public LCDorRateDB getDB()
	{
		LCDorRateDB aDBOper = new LCDorRateDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCDorRate描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCDorRate>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCDorRateSchema other = (LCDorRateSchema)otherObject;
		return
