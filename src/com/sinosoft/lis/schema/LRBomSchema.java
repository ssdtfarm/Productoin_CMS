...
private static Logger logger = Logger.getLogger(LRBomSchema.class);
	...
	**/
	...
	{
		this.Id = aLRBomSchema.getId();
		this.Name = aLRBomSchema.getName();
		this.Remark = aLRBomSchema.getRemark();
		this.DisPlayOrder = aLRBomSchema.getDisPlayOrder();
		this.State = aLRBomSchema.getState();
		this.BranchType = aLRBomSchema.getBranchType();
		this.Operator = aLRBomSchema.getOperator();
		this.MakeDate = fDate.getDate( aLRBomSchema.getMakeDate());
		this.MakeTime = aLRBomSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLRBomSchema.getModifyDate());
		this.ModifyTime = aLRBomSchema.getModifyTime();
	}
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			DisPlayOrder= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,4,SysConst.PACKAGESPILTER))).intValue();
