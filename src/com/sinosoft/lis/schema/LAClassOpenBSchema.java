...
import com.sinosoft.lis.db.LAClassOpenBDB;

/*
 * <p>ClassName: LAClassOpenBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LAClassOpenBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LAClassOpenBSchema.class);
	// @Field
	/** Openclassid */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LAClassOpenBSchema cloned = (LAClassOpenBSchema)super.clone();
	...
	/**
	* 使用另外一个 LAClassOpenBSchema 对象给 Schema 赋值
	* @param: aLAClassOpenBSchema LAClassOpenBSchema
	**/
	public void setSchema(LAClassOpenBSchema aLAClassOpenBSchema)
	{
		this.OpenClassID = aLAClassOpenBSchema.getOpenClassID();
		this.ChannelCode = aLAClassOpenBSchema.getChannelCode();
		this.ClassNo = aLAClassOpenBSchema.getClassNo();
		this.TrainStartDate = fDate.getDate( aLAClassOpenBSchema.getTrainStartDate());
		this.TrainEndDate = fDate.getDate( aLAClassOpenBSchema.getTrainEndDate());
		this.Managecom = aLAClassOpenBSchema.getManagecom();
		this.ManagecomName = aLAClassOpenBSchema.getManagecomName();
		this.Charger = aLAClassOpenBSchema.getCharger();
		this.Remarks = aLAClassOpenBSchema.getRemarks();
		this.MakeDate = fDate.getDate( aLAClassOpenBSchema.getMakeDate());
		this.MakeTime = aLAClassOpenBSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLAClassOpenBSchema.getModifyDate());
		this.ModifyTime = aLAClassOpenBSchema.getModifyTime();
		this.Operator = aLAClassOpenBSchema.getOperator();
		this.MakeDate1 = fDate.getDate( aLAClassOpenBSchema.getMakeDate1());
		this.MakeTime1 = aLAClassOpenBSchema.getMakeTime1();
		this.Operator1 = aLAClassOpenBSchema.getOperator1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LAClassOpenB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LAClassOpenBSchema";
	...
	public LAClassOpenBSchema getSchema()
	{
		LAClassOpenBSchema aLAClassOpenBSchema = new LAClassOpenBSchema();
		aLAClassOpenBSchema.setSchema(this);
		return aLAClassOpenBSchema;
	}

	public LAClassOpenBDB getDB()
	{
		LAClassOpenBDB aDBOper = new LAClassOpenBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAClassOpenB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLAClassOpenB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LAClassOpenBSchema other = (LAClassOpenBSchema)otherObject;
		return
