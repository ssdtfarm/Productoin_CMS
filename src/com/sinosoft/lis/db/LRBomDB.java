	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(4, this.getDisPlayOrder());
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LRBom WHERE  Id = ?", 
	...
	public LRBomSet query()
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			 ...
			 LRBomSchema aSchemaNew = this.getSchema();
			 ...
			 if (j == 0) {
			 	...
			 	throw new IllegalArgumentException("Table LRBom is querying for all data!");
			 }
			 mSql.append("select * from LRBom ");
	...
	public LRBomSet executeQuery(String sql, List bv)
	{
	...
	public LRBomSet executeQuery(String sql, List bv, int nStart, int nCount)
	{
		PreparedStatement stmt = null;
		ResultSet rs = null;
		LRBomSet aLRBomSet = new LRBomSet();
