...
/*
 * <p>ClassName: LAAgentFPDetailUnApprovalBDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: LAAgentFP_Setting
 */
public class LAAgentFPDetailUnApprovalBDB extends LAAgentFPDetailUnApprovalBSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LAAgentFPDetailUnApprovalBDB( Connection tConnection )
	{
		con = tConnection;
	...
	public LAAgentFPDetailUnApprovalBDB()
	{
		con = null;
	...
	{
		LAAgentFPDetailUnApprovalBSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LAAgentFPDetailUnApprovalBDB";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.getYearMonth() == null || this.getYearMonth().equals("null")) {
				...
				pstmt.setString(2, this.getYearMonth());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(3, this.getMonthlyFinance());
			pstmt.setDouble(4, this.getValidationReq());
			pstmt.setDouble(5, this.getWelcomeIncentive());
			pstmt.setDouble(6, this.getMonthlyFinanceAdvance());
			if(this.getApprovalDate() == null || this.getApprovalDate().equals("null")) {
				pstmt.setNull(7, 91);
			} else {
				pstmt.setDate(7, Date.valueOf(this.getApprovalDate()));
			}
			if(this.getApprovalTime() == null || this.getApprovalTime().equals("null")) {
				pstmt.setNull(8, 12);
			} else {
				pstmt.setString(8, this.getApprovalTime());
			}
			if(this.getApprovalOperator() == null || this.getApprovalOperator().equals("null")) {
				pstmt.setNull(9, 12);
			} else {
				pstmt.setString(9, this.getApprovalOperator());
			}
			if(this.getApprovalReason() == null || this.getApprovalReason().equals("null")) {
				pstmt.setNull(10, 12);
			} else {
				pstmt.setString(10, this.getApprovalReason());
			}
			if(this.getApprovalFlag() == null || this.getApprovalFlag().equals("null")) {
				pstmt.setNull(11, 12);
			} else {
				pstmt.setString(11, this.getApprovalFlag());
			}
			...
			if(this.getMakeDate1() == null || this.getMakeDate1().equals("null")) {
				...
				pstmt.setDate(17, Date.valueOf(this.getMakeDate1()));
			}
			if(this.getMakeTime1() == null || this.getMakeTime1().equals("null")) {
				pstmt.setNull(18, 12);
			} else {
				pstmt.setString(18, this.getMakeTime1());
			}
			if(this.getOperator1() == null || this.getOperator1().equals("null")) {
				pstmt.setNull(19, 12);
			} else {
			...
			if(this.getYearMonth() == null || this.getYearMonth().equals("null")) {
				...
				pstmt.setString(21, this.getYearMonth());
			}
			if(this.getMakeDate1() == null || this.getMakeDate1().equals("null")) {
				pstmt.setNull(22, 91);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LAAgentFPDetailUnApprovalB WHERE  AgentCode = ? AND YearMonth = ? AND MakeDate1 = ? AND MakeTime1 = ? AND Operator1 = ?", 
	...
	public LAAgentFPDetailUnApprovalBSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LAAgentFPDetailUnApprovalBSet aLAAgentFPDetailUnApprovalBSet = new LAAgentFPDetailUnApprovalBSet();
	  ...
	  if( !mflag ) {
		...
		try
		{
			 ...
			 LAAgentFPDetailUnApprovalBSchema aSchemaNew = this.getSchema();
			 ...
			 if (j == 0) {
			 	...
			 	throw new IllegalArgumentException("Table LAAgentFPDetailUnApprovalB is querying for all data!");
			 }
			 mSql.append("select * from LAAgentFPDetailUnApprovalB ");
			...
			{
				i++;
				LAAgentFPDetailUnApprovalBSchema s1 = new LAAgentFPDetailUnApprovalBSchema();
				s1.setSchema(rs,i);
				aLAAgentFPDetailUnApprovalBSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLAAgentFPDetailUnApprovalBSet;
	}

	public LAAgentFPDetailUnApprovalBSet executeQuery(String sql, List bv)
	{
	...
	public LAAgentFPDetailUnApprovalBSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LAAgentFPDetailUnApprovalBSet aLAAgentFPDetailUnApprovalBSet = new LAAgentFPDetailUnApprovalBSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LAAgentFPDetailUnApprovalB");
			LAAgentFPDetailUnApprovalBSchema aSchema = this.getSchema();
	...
	public LAAgentFPDetailUnApprovalBSet executeQuery(String sql, List bv, int nStart, int nCount)
	{
		PreparedStatement stmt = null;
		ResultSet rs = null;
		LAAgentFPDetailUnApprovalBSet aLAAgentFPDetailUnApprovalBSet = new LAAgentFPDetailUnApprovalBSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LAAgentFPDetailUnApprovalB " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LAAgentFPDetailUnApprovalBSet
 */
public LAAgentFPDetailUnApprovalBSet getData()
{
    int tCount = 0;
    LAAgentFPDetailUnApprovalBSet tLAAgentFPDetailUnApprovalBSet = new LAAgentFPDetailUnApprovalBSet();
    LAAgentFPDetailUnApprovalBSchema tLAAgentFPDetailUnApprovalBSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LAAgentFPDetailUnApprovalBDB";
    ...
    {
        tCount = 1;
        tLAAgentFPDetailUnApprovalBSchema = new LAAgentFPDetailUnApprovalBSchema();
        tLAAgentFPDetailUnApprovalBSchema.setSchema(mResultSet, 1);
        tLAAgentFPDetailUnApprovalBSet.add(tLAAgentFPDetailUnApprovalBSchema);
    ...
    return tLAAgentFPDetailUnApprovalBSet;
}
/**
 * 关闭数据集
 * @return boolean
