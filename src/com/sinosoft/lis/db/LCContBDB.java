...
/*
 * <p>ClassName: LCContBDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LCContBDB extends LCContBSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCContBDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LCContBSchema tSchema = this.getSchema();
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.getCompanyCode() == null || this.getCompanyCode().equals("null")) {
				...
				pstmt.setString(1, this.getCompanyCode());
			}
			...
			if(this.getOperator1() == null || this.getOperator1().equals("null")) {
				...
				pstmt.setString(3, this.getOperator1());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getProductCode() == null || this.getProductCode().equals("null")) {
				...
				pstmt.setString(3, this.getProductCode());
			}
			if(this.getProductType() == null || this.getProductType().equals("null")) {
				pstmt.setNull(4, 12);
			} else {
			...
			if(this.getAgentCode1() == null || this.getAgentCode1().equals("null")) {
				...
				pstmt.setString(5, this.getAgentCode1());
			}
			if(this.getAgentCode2() == null || this.getAgentCode2().equals("null")) {
				pstmt.setNull(6, 12);
			} else {
				pstmt.setString(6, this.getAgentCode2());
			}
			pstmt.setDouble(7, this.getSplitRate1());
			pstmt.setDouble(8, this.getSplitRate2());
			if(this.getSAgentCode() == null || this.getSAgentCode().equals("null")) {
				pstmt.setNull(9, 12);
			} else {
				pstmt.setString(9, this.getSAgentCode());
			}
			if(this.getPolState() == null || this.getPolState().equals("null")) {
				pstmt.setNull(10, 12);
			} else {
				pstmt.setString(10, this.getPolState());
			}
			if(this.getCValiDate() == null || this.getCValiDate().equals("null")) {
				pstmt.setNull(11, 91);
			} else {
				pstmt.setDate(11, Date.valueOf(this.getCValiDate()));
			}
			if(this.getSignDate() == null || this.getSignDate().equals("null")) {
				pstmt.setNull(12, 91);
			} else {
				pstmt.setDate(12, Date.valueOf(this.getSignDate()));
			}
			if(this.getReSignDate() == null || this.getReSignDate().equals("null")) {
				pstmt.setNull(13, 91);
			} else {
				pstmt.setDate(13, Date.valueOf(this.getReSignDate()));
			}
			if(this.getReinDate() == null || this.getReinDate().equals("null")) {
				pstmt.setNull(14, 91);
			} else {
				pstmt.setDate(14, Date.valueOf(this.getReinDate()));
			}
			...
			if(this.getAppntID() == null || this.getAppntID().equals("null")) {
				pstmt.setNull(17, 12);
			} else {
				pstmt.setString(17, this.getAppntID());
			}
			...
			if(this.getInsuredID() == null || this.getInsuredID().equals("null")) {
				...
				pstmt.setString(19, this.getInsuredID());
			}
			if(this.getOldPolicyNo() == null || this.getOldPolicyNo().equals("null")) {
				pstmt.setNull(20, 12);
			} else {
				pstmt.setString(20, this.getOldPolicyNo());
			}
			if(this.getBusinessDate() == null || this.getBusinessDate().equals("null")) {
				pstmt.setNull(21, 91);
			} else {
				pstmt.setDate(21, Date.valueOf(this.getBusinessDate()));
			}
			if(this.getASAReceivedDate() == null || this.getASAReceivedDate().equals("null")) {
				pstmt.setNull(22, 91);
			} else {
				pstmt.setDate(22, Date.valueOf(this.getASAReceivedDate()));
			}
			if(this.getFlag1() == null || this.getFlag1().equals("null")) {
				pstmt.setNull(23, 12);
			} else {
				pstmt.setString(23, this.getFlag1());
			}
			if(this.getFlag2() == null || this.getFlag2().equals("null")) {
				pstmt.setNull(24, 12);
			} else {
				pstmt.setString(24, this.getFlag2());
			}
			if(this.getFlag3() == null || this.getFlag3().equals("null")) {
				pstmt.setNull(25, 12);
			} else {
				pstmt.setString(25, this.getFlag3());
			}
			if(this.getFlag4() == null || this.getFlag4().equals("null")) {
				pstmt.setNull(26, 12);
			} else {
				pstmt.setString(26, this.getFlag4());
			}
			if(this.getFlag5() == null || this.getFlag5().equals("null")) {
				pstmt.setNull(27, 12);
			} else {
				pstmt.setString(27, this.getFlag5());
			}
			pstmt.setDouble(28, this.getBatchNo());
			if(this.getBatchDate() == null || this.getBatchDate().equals("null")) {
				pstmt.setNull(29, 91);
			} else {
				pstmt.setDate(29, Date.valueOf(this.getBatchDate()));
			}
			...
			if(this.getBranchType() == null || this.getBranchType().equals("null")) {
				...
				pstmt.setString(31, this.getBranchType());
			}
			...
			if(this.getOperator1() == null || this.getOperator1().equals("null")) {
				...
				pstmt.setString(37, this.getOperator1());
			}
			if(this.getMakeDate1() == null || this.getMakeDate1().equals("null")) {
				pstmt.setNull(38, 91);
			} else {
				pstmt.setDate(38, Date.valueOf(this.getMakeDate1()));
			}
			if(this.getMakeTime1() == null || this.getMakeTime1().equals("null")) {
				pstmt.setNull(39, 12);
			} else {
				pstmt.setString(39, this.getMakeTime1());
			}
			// set where condition
			if(this.getCompanyCode() == null || this.getCompanyCode().equals("null")) {
				pstmt.setNull(40, 12);
			} else {
				pstmt.setString(40, this.getCompanyCode());
			}
			if(this.getMainPolNo() == null || this.getMainPolNo().equals("null")) {
				pstmt.setNull(41, 12);
			} else {
				pstmt.setString(41, this.getMainPolNo());
			}
			if(this.getOperator1() == null || this.getOperator1().equals("null")) {
				pstmt.setNull(42, 12);
			} else {
				pstmt.setString(42, this.getOperator1());
			}
			if(this.getMakeDate1() == null || this.getMakeDate1().equals("null")) {
				pstmt.setNull(43, 91);
			} else {
				pstmt.setDate(43, Date.valueOf(this.getMakeDate1()));
			}
			if(this.getMakeTime1() == null || this.getMakeTime1().equals("null")) {
				pstmt.setNull(44, 12);
			} else {
				pstmt.setString(44, this.getMakeTime1());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCContB WHERE  CompanyCode = ? AND MainPolNo = ? AND Operator1 = ? AND MakeDate1 = ? AND MakeTime1 = ?", 
	...
	public LCContBSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LCContBSet aLCContBSet = new LCContBSet();
	  ...
	  if( !mflag ) {
		...
		try
		{
			 ...
			 LCContBSchema aSchemaNew = this.getSchema();
			 ...
			 if (j == 0) {
			 	...
			 	throw new IllegalArgumentException("Table LCContB is querying for all data!");
			 }
			 mSql.append("select * from LCContB ");
			...
			{
				i++;
				LCContBSchema s1 = new LCContBSchema();
				s1.setSchema(rs,i);
				aLCContBSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
	...
	public LCContBSet executeQuery(String sql, List bv)
	{
	...
	public LCContBSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LCContBSet aLCContBSet = new LCContBSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCContB");
			LCContBSchema aSchema = this.getSchema();
	...
	public LCContBSet executeQuery(String sql, List bv, int nStart, int nCount)
	{
		PreparedStatement stmt = null;
		ResultSet rs = null;
		LCContBSet aLCContBSet = new LCContBSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCContB " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 * @return LCContBSet
 */
public LCContBSet getData()
{
    int tCount = 0;
    LCContBSet tLCContBSet = new LCContBSet();
    LCContBSchema tLCContBSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCContBDB";
    ...
    {
        tCount = 1;
        tLCContBSchema = new LCContBSchema();
        tLCContBSchema.setSchema(mResultSet, 1);
        tLCContBSet.add(tLCContBSchema);
