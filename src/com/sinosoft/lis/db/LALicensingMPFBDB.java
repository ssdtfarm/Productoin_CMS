...
/*
 * <p>ClassName: LALicensingMPFBDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LALicensingMPFBDB extends LALicensingMPFBSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LALicensingMPFBDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LALicensingMPFBSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LALicensingMPFBDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getMakeDate1() == null || this.getMakeDate1().equals("null")) {
				...
				pstmt.setDate(19, Date.valueOf(this.getMakeDate1()));
			}
			if(this.getMakeTime1() == null || this.getMakeTime1().equals("null")) {
				pstmt.setNull(20, 12);
			} else {
				pstmt.setString(20, this.getMakeTime1());
			}
			// set where condition
			if(this.getAgentCode() == null || this.getAgentCode().equals("null")) {
				pstmt.setNull(21, 12);
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LALicensingMPFB WHERE  AgentCode = ? AND Operator1 = ? AND MakeDate1 = ? AND MakeTime1 = ?", 
	...
	public LALicensingMPFBSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LALicensingMPFBSet aLALicensingMPFBSet = new LALicensingMPFBSet();
	  ...
	  if( !mflag ) {
		...
		try
		{
			 ...
			 LALicensingMPFBSchema aSchemaNew = this.getSchema();
			 ...
			 if (j == 0) {
			 	...
			 	throw new IllegalArgumentException("Table LALicensingMPFB is querying for all data!");
			 }
			 mSql.append("select * from LALicensingMPFB ");
			...
			{
				i++;
				LALicensingMPFBSchema s1 = new LALicensingMPFBSchema();
				s1.setSchema(rs,i);
				aLALicensingMPFBSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLALicensingMPFBSet;
	}

	public LALicensingMPFBSet executeQuery(String sql, List bv)
	{
	...
	public LALicensingMPFBSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LALicensingMPFBSet aLALicensingMPFBSet = new LALicensingMPFBSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LALicensingMPFB");
			LALicensingMPFBSchema aSchema = this.getSchema();
	...
	public LALicensingMPFBSet executeQuery(String sql, List bv, int nStart, int nCount)
	{
		PreparedStatement stmt = null;
		ResultSet rs = null;
		LALicensingMPFBSet aLALicensingMPFBSet = new LALicensingMPFBSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LALicensingMPFB " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LALicensingMPFBSet
 */
public LALicensingMPFBSet getData()
{
    int tCount = 0;
    LALicensingMPFBSet tLALicensingMPFBSet = new LALicensingMPFBSet();
    LALicensingMPFBSchema tLALicensingMPFBSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LALicensingMPFBDB";
    ...
    {
        tCount = 1;
        tLALicensingMPFBSchema = new LALicensingMPFBSchema();
        tLALicensingMPFBSchema.setSchema(mResultSet, 1);
        tLALicensingMPFBSet.add(tLALicensingMPFBSchema);
