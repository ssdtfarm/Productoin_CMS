...
/*
 * <p>ClassName: LALicensingHKFIBDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: SqlServerSchemaMaker
 */
public class LALicensingHKFIBDB extends LALicensingHKFIBSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LALicensingHKFIBDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LALicensingHKFIBSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LALicensingHKFIBDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LALicensingHKFIB WHERE  AgentCode = ? AND Operator1 = ? AND MakeDate1 = ? AND MakeTime1 = ?", 
	...
	public LALicensingHKFIBSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LALicensingHKFIBSet aLALicensingHKFIBSet = new LALicensingHKFIBSet();
	  ...
	  if( !mflag ) {
		...
		try
		{
			 ...
			 LALicensingHKFIBSchema aSchemaNew = this.getSchema();
			 ...
			 if (j == 0) {
			 	...
			 	throw new IllegalArgumentException("Table LALicensingHKFIB is querying for all data!");
			 }
			 mSql.append("select * from LALicensingHKFIB ");
			...
			{
				i++;
				LALicensingHKFIBSchema s1 = new LALicensingHKFIBSchema();
				s1.setSchema(rs,i);
				aLALicensingHKFIBSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLALicensingHKFIBSet;
	}

	public LALicensingHKFIBSet executeQuery(String sql, List bv)
	{
	...
	public LALicensingHKFIBSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LALicensingHKFIBSet aLALicensingHKFIBSet = new LALicensingHKFIBSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LALicensingHKFIB");
			LALicensingHKFIBSchema aSchema = this.getSchema();
	...
	public LALicensingHKFIBSet executeQuery(String sql, List bv, int nStart, int nCount)
	{
		PreparedStatement stmt = null;
		ResultSet rs = null;
		LALicensingHKFIBSet aLALicensingHKFIBSet = new LALicensingHKFIBSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LALicensingHKFIB " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LALicensingHKFIBSet
 */
public LALicensingHKFIBSet getData()
{
    int tCount = 0;
    LALicensingHKFIBSet tLALicensingHKFIBSet = new LALicensingHKFIBSet();
    LALicensingHKFIBSchema tLALicensingHKFIBSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LALicensingHKFIBDB";
    ...
    {
        tCount = 1;
        tLALicensingHKFIBSchema = new LALicensingHKFIBSchema();
        tLALicensingHKFIBSchema.setSchema(mResultSet, 1);
        tLALicensingHKFIBSet.add(tLALicensingHKFIBSchema);
