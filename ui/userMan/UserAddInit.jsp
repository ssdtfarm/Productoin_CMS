...
String tOperator=ESAPI.encoder().encodeForJavaScript(tG1.Operator);
%>
...
function initInpBox()
{
	try
	{
		...
		fm.all('UserState').readOnly=true;
		if(fm.all('UserState').value.toString()=='0'){
			fm.all('UserStateName').value = 'Valid';
		}else{
			fm.all('UserStateName').value = 'Invalid';
		}
		//fm.all('UserStateName').value = 'Valid';
...
function initUserGrid()
{
	...
	try
	{
		...
		iArray[1]=new Array();
		iArray[1][0]="<%=bundle.getString("Username")%> ";
		iArray[1][1]="50px";
		iArray[1][2]=10;
		iArray[1][3]=0;

		iArray[2]=new Array();
		iArray[2][0]="<%=bundle.getString("UserCode")%> ";
		iArray[2][1]="50px";
		iArray[2][2]=100;
		iArray[2][3]=0;

		iArray[3]=new Array();
		iArray[3][0]="<%=bundle.getString("UserStatus")%>";
		iArray[3][1]="50px";
		iArray[3][2]=100;
		iArray[3][3]=0;

		iArray[4]=new Array();
		iArray[4][0]="<%=bundle.getString("Email")%>";
		iArray[4][1]="200px";
		iArray[4][2]=100;
		iArray[4][3]=0;
...
function  initHideMenuGrpGrid1()
{
	...
	try
	{
		...
		iArray[1]=new Array();
		iArray[1][0]="<%=bundle.getString("GroupName")%>";
		iArray[1][1]="140px";
		iArray[1][2]=10;
		iArray[1][3]=0;
...
function  initSelectMenuGrpGrid()
{
	...
	try
	{
		...
		iArray[1]=new Array();
		iArray[1][0]="<%=bundle.getString("RoleCode") %>";
		iArray[1][1]="40px";
		iArray[1][2]=10;
		iArray[1][3]=0;

		iArray[2]=new Array();
		iArray[2][0]="<%=bundle.getString("RoleName") %>";
		iArray[2][1]="45px";
		iArray[2][2]=100;
		iArray[2][3]=0;

		iArray[3]=new Array();
		iArray[3][0]="<%=bundle.getString("DetailMenu")%>";
		iArray[3][1]="50px";
		iArray[3][2]=100;
		iArray[3][3]=0;
