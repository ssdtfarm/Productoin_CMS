...
<body  onload="initForms();initElementtype();">
    <form action="./LAIndexRuleSave.jsp" method=post name=fm target="fraSubmit">    	 
		...
		<table class=common>
				<tr>
                    <td class=title><%=bundle.getString("Title")%></td>
               ...
               <tr>
                    ...
                    <td class=title><%=bundle.getString("C_RuleDescription")%></td>
                    <td class=input><input name='Description' class='common'  readonly/></td>
              </tr>		
		</table>
		<input class="cssButton" buttonname='saveClick' value="<%=bundle.getString("CustomiseParameter")%>" type="button" onclick="return queryPara();"/>
		</div><br/>
        <table>
            <tr class=common>
        ...
        <div id='div4' style='width:100%'>
            <div id="divRuleGrid">
                ...
                &nbsp;&nbsp;
                 ...
                 <input class="cssButton" buttonname='saveClick' value="<%=bundle.getString("C_Back")%>" type="button" onclick="return returnParent();"/>
            </div>
        </div>
        </div>     		
