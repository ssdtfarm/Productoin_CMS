...
<head>
  ...
  <script src="./LRTermUpdateInput.js" charset="UTF-8"></script>
  <style>
  	.att{display:none;}
  	.sql{display:none;}
  </style>
  <%@include file="./LRTermUpdateInit.jsp"%>
</head>
<body  onload="initForms();initElementtype();">
    <form action="./LRTermUpdateSave.jsp" method=post name=fm target="fraSubmit">
        <table>
            <tr class=common>
                <td class=common><img  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,div0);"></td>
                <td class=titleImg><%=bundle.getString("C_Entrymodify")%></td>
            </tr>
        </table>
        <div id='div0' style='display:'''>
            <table class=common name='table1' colNum='2'>
                <tr>
                    ...
                    <td class=input><input name='TermId' class='readonly'/></td>
