...
<%
    ...
    LARuleStatusUI tLARuleStatusUI = new LARuleStatusUI();
    ...
    try {
        tLARuleStatusUI.submitData(tVData,tOperate);
    } catch(Exception ex) {
        Content = bundle.getString("Savefailed,reason:") + ex.toString();
        FlagStr = "Fail";
    }
    if (!FlagStr.equals("Fail")) {
        tError = tLARuleStatusUI.mErrors;
        if (!tError.needDealError()) {
            mResult = tLARuleStatusUI.getResult(); //获取返回值
