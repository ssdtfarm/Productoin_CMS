...
<head>
  ...
  <script src="./LAIndexResultInput.js" charset="UTF-8"></script>
  <%@include file="./LAIndexResultInitR.jsp"%>
</head>
<title><%=bundle.getString("C_WageCustomisation")%></title>
<body  onload="initForms();initElementtype();">
    <form action="./LAIndexResultSave.jsp" method=post name=fm target="fraSubmit">     
        <table>
            <tr class=common>
