...
<head>
  ...
  <script src="./LABaseAddInput.js" charset="UTF-8"></script>
        ...
        <div id='div0' style=''>
            <table class=common name='table1' colNum='2'>
               <TR>
		        ...
		        <TD  class= input><Input name='RuleCode'  class=readonly  readonly></TD>       
		        ...
		        <TD class= title><%=bundle.getString("BOM_CompensationLawStatus")%> </TD>
		 		<TD class=input><Input class='codeno' name=Status verify="<%=bundle.getString("BOM_CompensationLawStatus")%>|notnull" ondblClick="return myShowCodeList(this,StatusName);" onkeyup="return myShowCodeListKey(this,StatusName);"/><Input class='codename' name=StatusName elementtype="nacessary" readonly></TD>
		      </TR>
            ...
            <INPUT class=cssButton name="addbutton" VALUE="<%=bundle.getString("C_Save")%>"  TYPE=button onclick="return submitForm();" style='margin-right:20px;'>
        </div>
