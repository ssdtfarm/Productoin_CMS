...
<head>
  ...
  <script src="./LAWageInput.js" charset="UTF-8"></script>
  <%@include file="./LAWageInit.jsp"%>
</head>
<body  onload="initForms();initElementtype();">
    <form action="./LAWageGradeSave.jsp" method=post name=fm target="fraSubmit">
        <table>
            <tr class=common>
