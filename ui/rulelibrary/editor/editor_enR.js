...
//	    	if(this.model.get('listType'))
    	...
    	}	else if(this.model.get('listType')=='conn'){         //连接词（Or/And）
...
var ifthenelsetable = $$({
	...
	view:{
		format:'<div>'+
							...
							'<button style="display:none" class="save">Save Rule</button>'+
							'</div>'+
							...
							'<button style="display:none" class="savepara" >Save Parameter</button>'+
							'</div>'+
					'</div>',
		style:'& a.addb {text-decoration:none;font-size:150%;font-weight:bold;font-family:arial;}'
		},
