...
<%
	...
	out.write("<frame name='rulelistR' src='rulelistR.jsp?IndexCode="+IndexCode+"&EditMode="+EditMode+"' scrolling='auto'/>");
	out.write("<frame name='editor' src='indexR.jsp?IndexCode="+IndexCode+"&EditMode="+EditMode+"' scrolling='auto'/>");
