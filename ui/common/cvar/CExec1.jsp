...
//    {
      out.println("try{"); 
      out.println("  parent.document.frames('"+ESAPI.encoder().encodeForJavaScript(framename)+"').showCodeByList('"+ESAPI.encoder().encodeForJavaScript(intElementIndex)+"','"+ESAPI.encoder().encodeForJavaScript(codename)+"','"+ESAPI.encoder().encodeForJavaScript(intFunctionIndex)+"','"+ESAPI.encoder().encodeForJavaScript(ex)+"','"+ESAPI.encoder().encodeForJavaScript(ey)+"');");
      out.println("}catch(exception){}"); 
//    }
    out.println("</script>");
  } 
