...
|  Demo:          http://www.meizz.com/Web/Demo/TreeView/MzTreeView10.htm     |
|                                                                             |
...
function MzTreeView(Tname)
{
  ...
  this.icons    = {
    ...
    config    : 'config.png', //XinYQ added on 2006-12-14 : config, pwd, exit
    pwd       : 'pwd.png',
    exit      : 'exit.png'
  };
...
MzTreeView.prototype.clickHandle = function(e)
{
  ...
  switch(e.tagName)
  {
    ...
    case "A" :
      ...
      {
        this.focusClientNode(e.id.substr(e.id.lastIndexOf("_") + 1));
        //XinYQ added on 2006-12-13 : 单击也可展开菜单
        this.expand(e.id.substr(e.id.lastIndexOf("_") + 1));
      }
      break;
    case "SPAN" :
...
MzTreeView.prototype.setIconPath  = function(path)
{
  ...
  for(var i in this.icons)
  {
    ...
    //XinYQ modified on 2006-12-14 : 强制显示图片
