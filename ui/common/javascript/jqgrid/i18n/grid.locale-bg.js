...
$.jgrid = {
	...
	search : {
		...
		Find: "袧邪屑械褉懈",
		Reset: "袠蟹褔懈褋褌懈",
		odata : ['褉邪胁薪芯', '褉邪蟹谢懈褔薪芯', '锌芯-屑邪谢泻芯', '锌芯-屑邪谢泻芯 懈谢懈=','锌芯-谐芯谢褟屑芯','锌芯-谐芯谢褟屑芯 懈谢懈 =', '蟹邪锌芯褔胁邪 褋','薪械 蟹邪锌芯褔胁邪 褋','褋械 薪邪屑懈褉邪 胁','薪械 褋械 薪邪屑懈褉邪 胁','蟹邪胁褗褉褕胁邪 褋','薪械 蟹邪胁褗褉褕邪胁邪 褋','褋褗写褗褉卸邪', '薪械 褋褗写褗褉卸邪' ],
