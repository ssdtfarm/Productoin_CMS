...
$.jgrid = {
	...
	search : {
		...
		Find: "H木ada钮",
		Reset: "Reset",
	    odata : ['rovn谩 sa', 'nerovn谩 sa', 'men拧ie', 'men拧ie alebo rovnaj煤ce sa','v盲膷拧ie', 'v盲膷拧ie alebo rovnaj煤ce sa', 'za膷铆na s', 'neza膷铆na s', 'je v', 'nie je v', 'kon膷铆 s', 'nekon膷铆 s', 'obahuje', 'neobsahuje'],
	    groupOps: [	{ op: "AND", text: "v拧etk媒ch" },	{ op: "OR",  text: "niektor茅ho z" }	],
		matchText: " h木ada钮 podla",
		rulesText: " pravidiel"
	},
	edit : {
