...
$.jgrid = {
	...
	search : {
		...
		Find: "Ie拧koti",
		Reset: "Atstatyti",
		odata : ['lygu', 'nelygu', 'ma啪iau', 'ma啪iau arba lygu','daugiau','daugiau arba lygu', 'prasideda','neprasideda','reik拧m臈 yra','reik拧m臈s n臈ra','baigiasi','nesibaigia','yra sudarytas','n臈ra sudarytas'],
