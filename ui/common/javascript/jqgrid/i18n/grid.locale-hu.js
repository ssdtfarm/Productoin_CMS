...
$.jgrid = {
	...
	search : {
		...
		odata : ['egyenl艖', 'nem egyenl艖', 'kevesebb', 'kevesebb vagy egyenl艖','nagyobb','nagyobb vagy egyenl艖', 'ezzel kezd艖dik','nem ezzel kezd艖dik','tartalmaz','nem tartalmaz','v茅gz艖dik','nem v茅gz艖dik','tartalmaz','nem tartalmaz'],
