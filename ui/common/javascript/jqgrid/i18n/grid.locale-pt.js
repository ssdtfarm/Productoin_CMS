...
* Tradu玢o da jqGrid em Portugues por Frederico Carvalho, http://www.eyeviewdesign.pt
...
$.jgrid = {
	...
	edit : {
	    ...
	    msg: {
	        ...
	        email: "N鉶 �um endere鏾 de email v醠ido",
	...
	errors : {
		errcap : "Erro",
		nourl : "N鉶 especificou um url",
		norecords: "N鉶 existem dados para processar",
	...
	formatter : {
		...
		date : {
			dayNames:   [
				...
				"Domingo", "Segunda-Feira", "Ter鏰-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "S醔ado"
			],
			monthNames: [
				"Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez",
				"Janeiro", "Fevereiro", "Mar鏾", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"
			],
			AmPm : ["am","pm","AM","PM"],
