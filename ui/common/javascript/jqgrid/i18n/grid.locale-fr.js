...
$.jgrid = {
	...
	search : {
		...
		Find: "Chercher",
		Reset: "Annuler",
		odata : ['茅gal', 'diff茅rent', 'inf茅rieur', 'inf茅rieur ou 茅gal','sup茅rieur','sup茅rieur ou 茅gal', 'commence par','ne commence pas par','est dans',"n'est pas dans",'finit par','ne finit pas par','contient','ne contient pas'],
