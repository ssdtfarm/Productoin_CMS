...
$.jgrid = {
	...
	search : {
		...
		Find: "Caut膬",
		Reset: "Resetare",
		odata : ['egal', 'diferit', 'mai mic', 'mai mic sau egal','mai mare','mai mare sau egal', '卯ncepe cu','nu 卯ncepe cu','se g膬se葯te 卯n','nu se g膬se葯te 卯n','se termin膬 cu','nu se termin膬 cu','con葲ine',''],
