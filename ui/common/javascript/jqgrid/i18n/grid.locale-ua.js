...
$.jgrid = {
    ...
    Find: "袟薪邪泄褌懈",
    Reset: "小泻懈写邪薪薪褟",
    odata : ['褉褨胁薪芯', '薪械 褉褨胁薪芯', '屑械薪褕械', '屑械薪褕械 邪斜芯 褉褨胁薪械','斜褨谢褜褕械','斜褨谢褜褕械 邪斜芯 褉褨胁薪械', '锌芯褔懈薪邪褦褌褜褋褟 蟹','薪械 锌芯褔懈薪邪褦褌褜褋褟 蟹','蟹薪邪褏芯写懈褌褜褋褟 胁','薪械 蟹薪邪褏芯写懈褌褜褋褟 胁','蟹邪泻褨薪褔褍褦褌褜褋褟 薪邪','薪械 蟹邪泻褨薪褔褍褦褌褜褋褟 薪邪','屑褨褋褌懈褌褜','薪械 屑褨褋褌懈褌褜'],
    groupOps: [	{ op: "AND", text: "胁褋械" },	{ op: "OR",  text: "斜褍写褜-褟泻懈泄" }	],
    matchText: " 蟹斜褨谐邪褦褌褜褋褟",
    rulesText: " 锌褉邪胁懈谢邪"
	},
	edit : {
