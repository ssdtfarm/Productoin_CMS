 ...
 * Traducci贸 jqGrid en Catat脿 per Faserline, S.L.
...
$.jgrid = {
	...
	edit : {
		...
		msg: {
		    ...
		    email: "no 茅s una direcci贸 de correu v脿lida",
		    integer: "Introdueixi un valor enter",
			date: "Introdueixi una data correcta ",
			url: "no 茅s una URL v脿lida. Prefix requerit ('http://' or 'https://')",
	...
	del : {
		caption: "Eliminar",
		msg: "驴Desitja eliminar els registres seleccionats?",
		bSubmit: "Eliminar",
		bCancel: "Cancelar"
	},
	nav : {
...
// setcolumns module
	...
	errors : {
		...
		model : "Les columnes de noms s贸n diferents de les columnes del model"
	},
	formatter : {
		...
		date : {
			...
			monthNames: [
				"Gen", "Febr", "Mar莽", "Abr", "Maig", "Juny", "Jul", "Ag", "Set", "Oct", "Nov", "Des",
