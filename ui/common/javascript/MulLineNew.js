...
//			text = text + "<td class=muline width='" + tempText1 + "'>";
			text = text + "<td class=muline>";
//			textTitle = textTitle + "<td class=mulinetitle width='" + tempText1 + "'>"
        ...
        tempText22= iArray[i][21];
				...
				else
				{
					...
					{
//						textTitle = textTitle + "<td class=mulinetitle width='" + tempText1 + "'>"
						textTitle = textTitle + "<td class=mulinetitle><input class=mulinetitle1 readonly value="
...
function _SetPageMark(cTurnPage)
{
	...
	tHTML += "<input type='button' class=cssbutton value='->' onclick='"+tStrPageName+".SortPage.gotoPage(document.all.GotoPage"+tStrPageName+".value);'>";
	tHTML += "</div>";
