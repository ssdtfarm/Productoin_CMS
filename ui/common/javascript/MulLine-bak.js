...
function _SetPageMark(cTurnPage)
{
    ...
    tHTML += "<div align=left id='divJumpPageComponet'>第&nbsp;" + tPageIndex + "/" + tTotalPageNum + "&nbsp;页&nbsp;&nbsp;转到&nbsp;<input type='common' style='{border: 1px #9999CC solid;height: 18px}' name='GotoPage" + tStrPageName + "' size='3'>&nbsp;页<input type='button' class=cssbutton value='->' onclick='" + tStrPageName + ".SortPage.gotoPage(document.all.GotoPage" + tStrPageName + ".value);'></div>";
