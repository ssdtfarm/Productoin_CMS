  ...
  <tr>
    <td class=button >
     ...
     <td class=button width="10%">
      <img class=button alt="上一步" src='../common/images/butPreviousStep.gif' 
...
<div id="inputQuest" style="display: ''">   
  <input type="button" name="Input" value="问题件录入" onClick="QuestInput()">
  <input type="button" name="Input" value="强制解除锁定" onClick="unLockTable();">
</div>
...
<table class="common" align=center>
  <tr>
    ...
    <td class=button width="10%">
      <img class=button alt="查询" src='../common/images/butQuery.gif' 
...
<table class="common" align=center>
  <tr>
    ...
    <td class=button width="10%">
      <img class=button alt="修改" src='../common/images/butUpdate.gif' 
...
<table class="common" align=center>
  <tr>
    ...
    <td class=button width="10%">
      <img class=button alt="删除" src='../common/images/butDelete.gif' 
...
<div id="autoMoveButton" style="display: none">
  <input type="button" name="autoMoveInput" value="随动定制确定" onclick="submitAutoMove();">
</div>
