...
<script src="./LAReportConInput.js" charset="UTF-8"></script>
<%@include file="./LAReportConInit.jsp"%>
</head>
<body onload="initForms();initElementtype();" style="width: 2000px;">
	<form action="./LAReportConSave.jsp" method=post name=fm target="fraSubmit">
		<table>
			<tr class=common>
		...
		<table class=common name='table1'>
			...
			<div style="float: left; padding-right: 10px;">
				<input class="cssButton" buttonname='printReport'	value="<%=bundle.getString("BOM_Pre-calenquiry")%>" type="button" onclick="  if(!verifyInput2())	return false;easyQueryBOMGird();" /><br>
			</div>
		</div><br/><br/>
