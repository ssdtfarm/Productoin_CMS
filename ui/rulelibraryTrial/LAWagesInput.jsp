    ...
    <form action="./LAWagesSave.jsp" method=post name=fm target="fraSubmit">
        ...
        <div id='div0' style='diaplay:'''>
            <table class=common name='table1' colNum='2'>
                <tr>
                    ...
                    <td class=input><Input class="codeno" name=ManageCom verify="<%=bundle.getString("CompanyHierachy")%>|notnull" ondblclick="initEdorType(this,ManageComName);" onkeyup="actionKeyUp(this,ManageComName);"><input class=codename name=ManageComName elementtype=nacessary readonly=true></td>
                ...
                <tr>
                    ...
                    <td class=title><%=bundle.getString("BOM_CompensationMonth/Year")%></td>
                    <td class=input><input class='common' name='WageNo' verify='<%=bundle.getString("BOM_CompensationMonth/Year")%>|notnull&len=6'  elementtype=nacessary/></td>
                </tr>
            </table>
        </div><br>
        <div id='div1' style='width:100%'>
            <div style="float:left;padding-right:10px;">
                ...
                <input class="cssButton"  value="<%=bundle.getString("BOM_CompensationMonth/Year")%>" type="button" onclick="return save();"/>                
                <!-- input class="cssButton"  value="维持考核试算" type="button" onclick="return save1();"/> -->
